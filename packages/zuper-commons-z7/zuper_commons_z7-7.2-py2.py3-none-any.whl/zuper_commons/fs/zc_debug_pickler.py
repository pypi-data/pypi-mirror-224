...
# from pickle import _tuplesize2code, EMPTY_TUPLE, MARK, Pickler, POP, POP_MARK, SETITEM, SETITEMS, TUPLE
#
...
#
# #
# # def find_pickling_error2(obj: object):
# #     pickle.dumps()
...
#
#
# def find_pickling_error(obj: object, protocol=pickle.HIGHEST_PROTOCOL):
#     sio = BytesIO()
#     try:
#         pickle.dumps(obj)
...
#         s = f"Pickling error occurred at context of len ({len(self.stack)}):\n"
