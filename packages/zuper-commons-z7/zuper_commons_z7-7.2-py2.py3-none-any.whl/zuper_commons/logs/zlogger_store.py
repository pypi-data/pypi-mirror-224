...
#         if self.up:
#             return self.up.info(_msg=_msg, *args, stacklevel=stacklevel + 1, **kwargs)
#             record["record"] = r
#         if self.record:
...
#             self.records.append(record)
#
#     def warn(self, _msg: str = None, *args, stacklevel: int = 0, **kwargs) -> Task:
#         from zuper_commons.timing import now_utc
#
#         record = {"msg": _msg, "args": list(args), "kwargs": kwargs, "t": now_utc()}
#         if self.up:
...
#             self.records.append(record)
#
#     def warning(self, _msg: str = None, *args, stacklevel: int = 0, **kwargs) -> Task:
#         from zuper_commons.timing import now_utc
#
#         record = {"msg": _msg, "args": list(args), "kwargs": kwargs, "t": now_utc()}
#         if self.up:
