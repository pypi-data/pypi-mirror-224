...
class Webcam:
    ...
    def _set_webcam_resolution(self, h: int, w: int) -> tuple[int, int]:
        ...
        """
        max_h = self.__max_h if hasattr(self, '__max_h') else float('inf')
        max_w = self.__max_w if hasattr(self, '__max_w') else float('inf')
    ...
    def _max_available_resolution(self) -> tuple[int, int]:
        ...
        self.__max_h, self.__max_w = self._set_webcam_resolution(h=1e6, w=1e6)
