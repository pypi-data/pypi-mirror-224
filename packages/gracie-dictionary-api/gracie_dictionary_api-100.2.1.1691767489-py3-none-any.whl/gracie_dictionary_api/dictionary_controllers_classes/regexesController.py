class regexesController:
    ...
    def edit(self, id, **kwargs):
        ...
        all_api_parameters = {'id': {'name': 'id', 'required': True, 'in': 'query'}, 'name': {'name': 'name', 'required': False, 'in': 'query'}, 'expression': {'name': 'expression', 'required': False, 'in': 'query'}, 'enabled': {'name': 'enabled', 'required': False, 'in': 'query'}, 'qualifier': {'name': 'qualifier', 'required': False, 'in': 'query'}}
        parameters_names_map = {}
        api = '/regex/edit'
        actions = ['post']
        consumes = ['[]']
    ...
    def add(self, name, expression, **kwargs):
        ...
        all_api_parameters = {'name': {'name': 'name', 'required': True, 'in': 'query'}, 'expression': {'name': 'expression', 'required': True, 'in': 'query'}, 'enabled': {'name': 'enabled', 'required': False, 'in': 'query'}, 'qualifier': {'name': 'qualifier', 'required': False, 'in': 'query'}}
        parameters_names_map = {}
        api = '/regex/add'
        actions = ['post']
        consumes = ['[]']
