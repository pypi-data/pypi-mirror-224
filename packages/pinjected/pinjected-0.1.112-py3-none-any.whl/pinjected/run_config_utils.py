...
from pinjected.helpers import inspect_and_make_configurations, load_variable_by_module_path, \
    get_design_path_from_var_path, get_runnables, find_default_design_paths, ModulePath
...
def run_anything(
    ...
    meta_cxt: MetaContext = MetaContext.gather_from_path(ModulePath(var_path).module_file_path)
    ...
    design = design + meta_cxt.accumulated.provide("overrides") + overrides
