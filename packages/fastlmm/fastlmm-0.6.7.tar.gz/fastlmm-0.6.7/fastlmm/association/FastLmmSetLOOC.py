...
if __name__ == "__main__":
    ...
    if "chrm" in sys.argv:
        ...
        raise Exception("please specify 'chrm' in the input file")
    ...
    for chr in chrmset:
        ...
        tt1 = time.time()
        logging.info(
            "Final elapsed time for all processing is %.2f seconds" % (tt1 - tt0)
        )
