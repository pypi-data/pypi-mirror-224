...
@LastEditTime: 2023-08-09 19:09:01
...
class UserAvatarHandler(ClientBaseHandler):
    ...
    def post_async(self):
        ...
        :last_editors: HuangJianYi
        """
        from seven_cloudapp_frame.libs.customize.cos2_helper import COS2Helper
        ...
        result = COS2Helper.upload(file_name=file_name, data=files_data["image"][0]['body'])
        if not result:
