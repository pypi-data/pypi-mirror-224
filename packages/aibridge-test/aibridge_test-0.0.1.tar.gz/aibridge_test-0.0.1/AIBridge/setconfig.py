from AIBridge.constant.constant import CUSTOM_CONFIG_PATH, DB_TYPES,LINUX_MACOS_PATH
import yaml
from AIBridge.constant.constant import PRIORITY, AI_SERVICES
...
def get_config_path():
    ...
    #     path=LINUX_MACOS_PATH
    # if os.name == "nt":  # Windows OS
    #     print("herer")
    #     path= os.path.expanduser("~\\aibridge\\config.yaml")
    return path
class SetConfig:
    @classmethod
    def read_yaml(self):
