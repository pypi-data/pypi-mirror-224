...
class Locker:
    ...
    def __init__(
        self,
        access_key: str = None,
        access_key_basic_auth: Tuple[str, str] | None = None,
        api_base: str = None,
    ...
    @property
    def access_key(self):
        return self._options.get("access_key")

    @access_key.setter
    def access_key(self, access_key_value):
        self._options.update({"access_key": access_key_value})
