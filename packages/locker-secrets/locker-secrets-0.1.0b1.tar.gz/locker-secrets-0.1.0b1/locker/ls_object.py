...
class LSObject(dict):
    ...
    def call(self, cli, asjson=True, shell=True, timeout=30, params=None):
    ...
    def _call(self, cli_, access_key=None, api_base=None, api_version=None, asjson=True, shell=True,
