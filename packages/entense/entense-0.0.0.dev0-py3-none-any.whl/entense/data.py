...
from .const import neuromaps_fetch_fn, template_dict
from conveyant import direct_compositor
from conveyant.compositors import _seq_to_dict


# TODO: remove this as soon as we figure out how to use the new
#       conveyant transforms (e.g., imap)
def replicate(
...
def shard_dataset(
    ...
    def transform(
        ...
        xfm: callable = direct_compositor,
