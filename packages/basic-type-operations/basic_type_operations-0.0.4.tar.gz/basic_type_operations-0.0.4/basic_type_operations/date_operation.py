...
class DateOperation(object):
    ...
    # print(string_year_second_f_string('2021-03-03 17:01:59.416260'))
    # </editor-fold>
    # </editor-fold>
    ...
    # <editor-fold desc="格林威治时间-转-北京时间">
    @staticmethod
    def UTC2BJS(UTC):
    ...
    # </editor-fold>
    # <editor-fold desc=" UTC 获取 2022-01-18T06:23:01+0000 2022-01-18 06:23:01.733507+00:00 格式">
    @staticmethod
    def UTCISOTime():
