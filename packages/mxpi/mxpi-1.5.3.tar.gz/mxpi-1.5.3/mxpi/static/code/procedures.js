...
Blockly.Python.procedures_callnoreturns = function() {
  // Call a procedure with no return value.
  var funcName = Blockly.Python.variableDB_.getName(this.getFieldValue('NAME'),
      Blockly.Procedures.NAME_TYPE);
  var args = [];
  ...
  if (this.arguments_.length>0){
      var code = 'lambda: self.'+funcName + '(' + args.join(', ') + ')';
  }
  else {
       var code = 'self.'+funcName;
  }
...
Blockly.Python.procedures_callnoreturnsu = function() {
  // Call a procedure with no return value.
  var funcName = Blockly.Python.variableDB_.getName(this.getFieldValue('NAME'),
      Blockly.Procedures.NAME_TYPE);
  var args = [];
