...
Blockly.Python.tuple_create_with_noreturn = function() {
  ...
  Blockly.Python.procedures_defreturnsu = function() {
    // Define a procedure with a return value.
    var funcName = Blockly.Python.variableDB_.getName(this.getFieldValue('NAME'),
        Blockly.Procedures.NAME_TYPE);
    var branch = Blockly.Python.statementToCode(this, 'STACK')|| '    pass\n';
  ...
  Blockly.Python.procedures_defnoreturnsu = Blockly.Python.procedures_defreturnsu;


  Blockly.Python.procedures_defnoreturnsuop = function() {
    // Define a procedure with a return value.
  ...
  Blockly.Python.procedures_defnoreturnsuop = Blockly.Python.procedures_defnoreturnsuop;