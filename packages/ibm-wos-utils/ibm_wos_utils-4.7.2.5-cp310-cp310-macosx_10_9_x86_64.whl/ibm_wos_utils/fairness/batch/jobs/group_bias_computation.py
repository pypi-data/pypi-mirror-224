...
class GroupBiasComputationJob(AIOSBaseJob):
    ...
    def run_job(self) -> None:
        ...
        try:
            ...
            df_spark, borrow_if_needed = self._read_data(
                subscription, monitor_instance, db_name, pl_table_name, schema_name=pl_schema_name, data_type=PAYLOAD)
            ...
            self.logger.info("Total time taken for payload dataset calculation was {} seconds.".format(payload_time_taken))
            ...
            if balanced_di_dict is not None:
                ...
                self.logger.info("Total time taken for balanced dataset calculation was {} seconds.".format(balanced_time_taken))
            ...
            try:
                ...
                if is_feedback_based_metrics_configured is True:
                    ...
                    feedback_distribution_info = self.compute_feedback_confusion_metric_distribution(subscription,monitor_instance, inputs)
                else:
    ...
    def _read_data(self, subscription: dict, monitor_instance: dict, db_name: str, table_name: str, schema_name: str=None, data_type = None): # (DataFrame, bool)
        """
    ...
    def compute_feedback_confusion_metric_distribution(self, subscription,monitor_instance, inputs):
        self.logger.info("Start computing feedback based metrics")
        ...
        if feedback_data_source is not None:
            ...
            spark_df, borrow_if_needed = self._read_data(subscription, monitor_instance, feedback_db_name, feedback_table_name, schema_name=feedback_schema_name, data_type = FEEDBACK)
            ...
            self.logger.info("Finish computing feedback based metrics. It took {} secs".format(feedback_time_taken))
