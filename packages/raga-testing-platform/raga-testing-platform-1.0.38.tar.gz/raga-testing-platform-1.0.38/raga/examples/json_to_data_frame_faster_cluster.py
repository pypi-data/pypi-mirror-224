...
# pd_data_frame = data_frame_extractor(pd.read_pickle("50_images_no_bbox.pkl")).to_csv("50_images_classification.csv", index=False)
# print(pd_data_frame)
...
test_session = TestSession(project_name="testingProject",run_name= "run-11-aug-classification-v4")

# # #create test_ds object of Dataset instance
test_ds = Dataset(test_session=test_session, name="dataset-50-images-aug-11-v2")
