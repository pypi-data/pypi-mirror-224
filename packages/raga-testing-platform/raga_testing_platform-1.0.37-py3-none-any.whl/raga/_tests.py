...
def clustering(method:str, num_of_clusters:int, embedding_col:str, level:str, args=dict):
    assert isinstance(method, str) and method, "method is required and must be str."
    assert isinstance(num_of_clusters, int) and num_of_clusters, "num_of_clusters is required and must be int."
