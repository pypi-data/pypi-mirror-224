...
class TestSession():
    ...
    def __init__(self, project_name: str, run_name: str, u_test=False, config_data=None):
        ...
        self.raga_access_key_id = get_config_value(config_data, 'default', self.ACCESS_KEY)
        self.raga_secret_access_key = get_config_value(config_data, 'default', self.SECRET_KEY)
    ...
    def add(self, payload):
        ...
        if payload.get("test_type") == "cluster":
            payload["api_end_point"] =  "api/experiment/test/cluster"
