...
class AuthIntegration(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AuthIntegration:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AuthIntegration:
        """Create an instance of AuthIntegration from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AuthIntegration.parse_obj(obj)

        _obj = AuthIntegration.parse_obj({
            "id": obj.get("id"),
