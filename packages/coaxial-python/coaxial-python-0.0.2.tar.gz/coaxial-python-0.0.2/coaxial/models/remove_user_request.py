...
class RemoveUserRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RemoveUserRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RemoveUserRequest:
        """Create an instance of RemoveUserRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RemoveUserRequest.parse_obj(obj)

        _obj = RemoveUserRequest.parse_obj({
