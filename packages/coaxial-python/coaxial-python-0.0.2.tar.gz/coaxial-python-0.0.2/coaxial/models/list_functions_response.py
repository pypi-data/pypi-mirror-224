...
class ListFunctionsResponse(BaseModel):
    ...
    """
    functions: Optional[Any] = Field(...)
    __properties = ["functions"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListFunctionsResponse:
    ...
    def to_dict(self):
        ...
        if self.functions is None and "functions" in self.__fields_set__:
            _dict['functions'] = None

        return _dict

    @classmethod
    def from_dict(cls, obj: dict) -> ListFunctionsResponse:
        """Create an instance of ListFunctionsResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListFunctionsResponse.parse_obj(obj)

        _obj = ListFunctionsResponse.parse_obj({
