...
class RemoveModelResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RemoveModelResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RemoveModelResponse:
        """Create an instance of RemoveModelResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RemoveModelResponse.parse_obj(obj)

        _obj = RemoveModelResponse.parse_obj({
