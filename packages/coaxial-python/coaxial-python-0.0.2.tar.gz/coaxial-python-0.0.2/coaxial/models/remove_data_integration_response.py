...
class RemoveDataIntegrationResponse(BaseModel):
    """
    RemoveDataIntegrationResponse
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RemoveDataIntegrationResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RemoveDataIntegrationResponse:
        """Create an instance of RemoveDataIntegrationResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RemoveDataIntegrationResponse.parse_obj(obj)

        _obj = RemoveDataIntegrationResponse.parse_obj({
