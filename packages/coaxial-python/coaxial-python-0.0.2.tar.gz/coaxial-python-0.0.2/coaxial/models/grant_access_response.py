...
class GrantAccessResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GrantAccessResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GrantAccessResponse:
        """Create an instance of GrantAccessResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GrantAccessResponse.parse_obj(obj)

        _obj = GrantAccessResponse.parse_obj({
