...
class RevokeAccessResponse(BaseModel):
    ...
    __properties = ["resources", "user_id"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RevokeAccessResponse:
    ...
    def to_dict(self):
        ...
        if self.resources is None and "resources" in self.__fields_set__:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RevokeAccessResponse:
        """Create an instance of RevokeAccessResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RevokeAccessResponse.parse_obj(obj)

        _obj = RevokeAccessResponse.parse_obj({
