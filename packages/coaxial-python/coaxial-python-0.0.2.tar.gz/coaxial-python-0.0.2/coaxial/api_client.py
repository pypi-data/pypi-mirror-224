...
import coaxial.models
from coaxial import rest
from coaxial.exceptions import ApiValueError, ApiException
...
class ApiClient(object):
    ...
    def __init__(
        ...
        self.default_headers = {'Coaxial-Version': '0.0.2'}
        if header_name is not None:
            self.default_headers[header_name] = header_value
        self.cookie = cookie
        # Set default User-Agent.
        self.user_agent = 'Coaxial Python v0.0.2'
    ...
    def __deserialize(self, data, klass):
        ...
        if type(klass) == str:
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(coaxial.models, klass)
