...
class base_int(int):
    ...
    def __repr__(self):
        if self.W == 1:
            self.repr = '0x{:02x}({:d})'.format(self, self)
        elif self.W == 2:
            self.repr = '0x{:04x}({:d})'.format(self, self)
        elif self.W == 3:
            self.repr = '0x{:06x}({:d})'.format(self, self)
        elif self.W == 4:
            self.repr = '0x{:08x}({:d})'.format(self, self)
        elif self.W == 8:
            self.repr = '0x{:016x}({:d})'.format(self, self)
        elif self.W == 16:
            self.repr = '0x{:032x}({:d})'.format(self, self)
        else:
            self.repr = '{:d}'.format(self)
        return self.repr
