...
class _bovalidation:
    ...
    def _generate_logon_token(self):
        ...
        payload = f'''
                    <attrs>
                        <attr name="clienttype" type="string">YourClientType</attr>
                        <attr name="password" type="string">{self.password}</attr>
                        <attr name="auth" type="string" possibilities="secEnterprise,secLDAP,secWinAD,secSAPR3">{self.auth_type}</attr>
