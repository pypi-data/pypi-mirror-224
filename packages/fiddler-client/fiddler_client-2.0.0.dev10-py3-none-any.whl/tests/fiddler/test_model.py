...
class TestModel(BaseTestCase):
    ...
    def test_get_models(self):
        ...
        models = self.client.get_models(self._project_name)
    ...
    def test_get_model(self):
        ...
        model = self.client.get_model(self._project_name, self._model_name)
    ...
    def test_get_model_404(self):
        ...
        with self.assertRaises(NotFound) as e:  # noqa
            _ = self.client.get_model(self._project_name, self._model_name)
    ...
    def test_delete_model(self):
        ...
        response = self.client.delete_model(
            model_name=self._model_name, project_name=self._project_name
        )
