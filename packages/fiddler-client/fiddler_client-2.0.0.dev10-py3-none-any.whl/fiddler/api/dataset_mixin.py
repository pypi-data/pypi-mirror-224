...
class DatasetMixin:
    ...
    def upload_dataset_from_file(
        ...
        :param wait:        A boolean value which determines if the upload method
    ...
    def upload_dataset(
        self,
        project_id: str = None,
        dataset: Dict[str, pd.DataFrame] = None,
        dataset_id: str = None,
        info: Optional[DatasetInfo] = None,
        ...
        datasets = dataset_compat(dataset=dataset, datasets=datasets)
        if not datasets:
