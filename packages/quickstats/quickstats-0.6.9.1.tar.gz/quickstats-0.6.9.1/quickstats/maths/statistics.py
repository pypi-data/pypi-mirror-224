...
def get_global_pvalue_significance(x:np.ndarray, pvalue_local:Optional[np.ndarray]=None,
    ...
    Z_global_errhi = pval_to_Z(p_global + delta_p_global) #Z_global - pval_to_Z(p_global + delta_p_global)
    Z_global_errlo = 0 #pval_to_Z(p_global - delta_p_global) - Z_global
    result = {
