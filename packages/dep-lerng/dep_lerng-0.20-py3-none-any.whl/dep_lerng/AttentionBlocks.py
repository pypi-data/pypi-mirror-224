...
#         global_x = self.GAP(x)
#         global_x = self.Global_Channel_Attention(global_x)

#         local_x = self.Local_Channel_Attention(x)

#         attention_x = global_x + local_x
#         attention_x = self.sigmoid(attention_x)
...
#             BatchNorm2d(1, momentum = moment),              
#             acti,
#             # Conv2d(in_channels = 2, out_channels = 1, kernel_size = 3, stride = 1, padding = 1, bias = False),
#             # BatchNorm2d(1, momentum = moment),
#             # acti,

#             # Conv2d(in_channels = 1, out_channels = 1, kernel_size = 3, stride = 1, padding = 1, bias = False),
#             # BatchNorm2d(1, momentum = moment),
#             # acti,   
