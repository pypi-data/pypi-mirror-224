...
def 可复制(目标=None, 源=None) -> bool:
    return isinstance(源, type(目标))
...
class 分隔线模板:
    ...
    def 复制自(self, 源=None):
        if 可复制(self, 源):
            self.__修饰符 = 源.__分隔线模板__修饰符
            self.__提示内容 = 源.__分隔线模板__提示内容
            self.__总长度 = 源.__分隔线模板__总长度
            self.__提示对齐 = 源.__分隔线模板__提示对齐
            self.__修饰方法 = 源.__分隔线模板__修饰方法
            self.__打印方法 = 源.__分隔线模板__打印方法
...
class 语义日期模板:
    ...
    def 复制自(self, 源=None):
        if 可复制(self, 源):
            self.__目标日期 = 源.语义日期模板__目标日期
            self.__打印方法 = 源.语义日期模板__打印方法
