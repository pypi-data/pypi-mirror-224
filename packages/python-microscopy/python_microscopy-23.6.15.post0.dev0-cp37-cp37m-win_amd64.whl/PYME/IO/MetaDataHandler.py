...
# automatically record pyme version for images generated by PYMEAcquire
def _record_version(mdh):
    mdh.record_pyme_version()

provideStartMetadata.append(_record_version)
