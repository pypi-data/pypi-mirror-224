...
def card_component(data=None, styles=None, typeExpand=None, showAdd=None, addHeroComponent=None, showHero=None, showChartSwitch=None, key=None):
  
    component_value = _card_component(data=data, styles=styles, typeExpand=typeExpand, showAdd=showAdd, addHeroComponent=addHeroComponent, showHero=showHero, showChartSwitch=showChartSwitch, key=key, default=0)
...
if not _RELEASE:
    ...
    num_clicks = card_component(data=data,showAdd=True, addHeroComponent=True, showHero=True, showChartSwitch=True, key="foo")
    # st.write(num_clicks)
