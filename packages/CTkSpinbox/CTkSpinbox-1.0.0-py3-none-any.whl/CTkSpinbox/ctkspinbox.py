...
class CTkSpinbox(ctk.CTkFrame):
    ...
    def configure(self, **kwargs):
        ...
        # conditions
        for value in ['font', 'text_color', 'button_color', 'hover_color', 'button_corner_radius']:
            if value in kwargs:
                new_value = kwargs.pop(value)
                if value not in ['font', 'button_corner_radius']:
                    if value not in ['hover_color', 'button_color', 'button_corner_radius']:
