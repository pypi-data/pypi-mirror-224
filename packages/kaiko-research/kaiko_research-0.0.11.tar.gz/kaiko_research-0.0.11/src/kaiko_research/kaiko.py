...
class KaikoAPIWrapper:
    ...
    def get_export_parameters(self, endpoint_name):
        ...
        print(msg)
        schemas = importlib.import_module("endpoint_schemas")
        schema_name = [
    ...
    def get_data(self, **kwargs):
        ...
        params_template = self.get_export_parameters(endpoint_name)
    ...
    def output_data(self, export_name, data, output_path):
        ...
        data.to_csv(
            f"{output_path}/{today} - {export_name}.csv", index=False)
