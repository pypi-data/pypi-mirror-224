...
class TestAIAssistantConfigHandler:
    ...
    def config_handler(self):
        return AIAssistantConfigHandler()
    ...
    def test_created_config(self, config_handler):
        ...
        assert (
            config_handler.ai_assistant_config.get("no category", "subcategories")
            is not None
        )
...
class TestPresetsHandler:
    ...
    def path_to_first_email_presets(self):
        return os.path.join("resource", "preset_inputs", "first_email.json")

    @pytest.fixture
    def path_to_followup_presets(self):
        return os.path.join("resource", "preset_inputs", "followup.json")
