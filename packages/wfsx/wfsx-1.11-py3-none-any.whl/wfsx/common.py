...
def get_results(xlcreate, roles, testcase, tendpoint, testdata, testparams, exResults, acResults, results, fontx,
    ...
    reportpath.write_cell_content_colored(2, 11, '=COUNTIF(I4:I10000, "❌")')
    reportpath.write_cell_content_colored(2, 13, '=COUNTIF(I4:I10000, "⚠️")')
    try:
