...
from exceptions import SevenDaysHoldException, LoginRequired, ApiException
...
class SteamClient:
    ...
    def login(self, username: str, password: str, steam_guard: str) -> None:
        ...
        self._password = password
        LoginExecutor(
            username, password, self.steam_guard["shared_secret"], self._session
        ).login()
    ...
    def accept_trade_offer(self, trade_offer_id: str) -> dict:
        ...
        if trade_offer_state is not TradeOfferState.Active:
            raise ApiException(
                "Invalid trade offer state: {} ({})".format(
        ...
        accept_url = (
            SteamUrl.COMMUNITY_URL + "/tradeoffer/" + trade_offer_id + "/accept"
        )
        params = {
    ...
    def get_wallet_balance(
        self, convert_to_decimal: bool = True
