...
class App(Flask):
    ...
    #++++++++++++++++++++++++++++++++++++++++++++++++++
    def add_route(self, type: str, route: str, action, name: str, **kwargs):
        ...
        self.route(route,  methods = [type])(function)
        
        
    #++++++++++++++++++++++++++++++++++++++++++++++++++
    def add_error_route(self, error_code:int, action, name:str, **kwargs):
