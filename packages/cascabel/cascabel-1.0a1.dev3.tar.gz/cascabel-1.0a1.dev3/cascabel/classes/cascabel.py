...
class Cascabel:
    ...
    def make_crud_controller(self):
        ...
        import_stat = f"\nfrom app.controllers.{controller_name}_controller import {controller_class_name}\n"
        add_route_stat =  f"app.add_route(app, 'GET', '/{controller_name}',  {controller_class_name}().index , '{controller_name}_index') \n"
        add_route_stat += f"app.add_route(app, 'GET', '/{controller_name}/view/<id>',  {controller_class_name}().view , '{controller_name}_view') \n"
        add_route_stat += f"app.add_route(app, 'GET', '/{controller_name}/store',  {controller_class_name}().get_store , 'get_{controller_name}_store') \n"
        add_route_stat += f"app.add_route(app, 'POST', '/{controller_name}/store',  {controller_class_name}().post_store , 'post_{controller_name}_store') \n"
        add_route_stat += f"app.add_route(app, 'GET', '/{controller_name}/update/<id>',  {controller_class_name}().get_update , 'get_{controller_name}_update') \n"
        add_route_stat += f"app.add_route(app, 'POST', '/{controller_name}/update/<id>',  {controller_class_name}().post_update , 'post_{controller_name}_update') \n"
        add_route_stat += f"app.add_route(app, 'POST', '/{controller_name}/delete/<id>',  {controller_class_name}().delete , '{controller_name}_delete') \n"
