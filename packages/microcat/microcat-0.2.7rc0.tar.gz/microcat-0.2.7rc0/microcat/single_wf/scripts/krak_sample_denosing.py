...
def main():
    ...
    keywords = ["k__Bacteria", "k__Fungi", "k__Viruses"]
    ...
    filter_desired_krak_report = final_desired_krak_report.copy()[
        ...
        (
            ...
            ((final_desired_krak_report['p_value_kmer_counts'] < float(0.05)) | (final_desired_krak_report['p_value_kmer_counts'].isna()))
            ) |
            (
                ...
                (final_desired_krak_report['max_contig'] > float(38))
            )
        )
    ]
