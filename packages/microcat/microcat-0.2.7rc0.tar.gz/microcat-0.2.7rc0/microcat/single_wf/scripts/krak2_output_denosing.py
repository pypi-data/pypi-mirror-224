...
krak_study_denosing['taxid_x'] = krak_study_denosing['taxid_x'].astype(str)
# Filter krak2_output_copy to keep only rows with taxid appearing in krak_study_denosing ncbi_taxa
krak2_output_filtered = krak2_output_copy[krak2_output_copy['taxid'].isin(krak_study_denosing['taxid_x'])]
