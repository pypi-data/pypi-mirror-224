...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    DESCRIPTOR._serialized_options = b'Z;github.com/osmosis-labs/osmosis/v16/x/pool_incentives/types'
    ...
    _QUERY.methods_by_name['GaugeIds']._serialized_options = b'\x82\xd3\xe4\x93\x026\x124/osmosis/pool_incentives/v1beta1/gauge-ids/{pool_id}'
    _QUERY.methods_by_name['DistrInfo']._options = None
    _QUERY.methods_by_name['DistrInfo']._serialized_options = b'\x82\xd3\xe4\x93\x02-\x12+/osmosis/pool_incentives/v1beta1/distr_info'
    _QUERY.methods_by_name['Params']._options = None
    _QUERY.methods_by_name['Params']._serialized_options = b"\x82\xd3\xe4\x93\x02)\x12'/osmosis/pool_incentives/v1beta1/params"
    _QUERY.methods_by_name['LockableDurations']._options = None
    _QUERY.methods_by_name['LockableDurations']._serialized_options = b'\x82\xd3\xe4\x93\x025\x123/osmosis/pool_incentives/v1beta1/lockable_durations'
    _QUERY.methods_by_name['IncentivizedPools']._options = None
    _QUERY.methods_by_name['IncentivizedPools']._serialized_options = b'\x82\xd3\xe4\x93\x025\x123/osmosis/pool_incentives/v1beta1/incentivized_pools'
    _QUERY.methods_by_name['ExternalIncentiveGauges']._options = None
    _QUERY.methods_by_name['ExternalIncentiveGauges']._serialized_options = b'\x82\xd3\xe4\x93\x02<\x12:/osmosis/pool_incentives/v1beta1/external_incentive_gauges'
