...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _QUERY.methods_by_name['SpotPrice']._serialized_options = b"\x88\x02\x01\x82\xd3\xe4\x93\x02)\x12'/osmosis/gamm/v2/pools/{pool_id}/prices"
