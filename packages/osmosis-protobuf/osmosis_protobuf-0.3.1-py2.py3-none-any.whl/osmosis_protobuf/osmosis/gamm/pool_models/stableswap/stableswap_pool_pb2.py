...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    DESCRIPTOR._serialized_options = b'ZAgithub.com/osmosis-labs/osmosis/v16/x/gamm/pool_models/stableswap'
