...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    DESCRIPTOR._serialized_options = b'ZJgithub.com/osmosis-labs/osmosis/v16/x/concentrated_liquidity/types/genesis'
