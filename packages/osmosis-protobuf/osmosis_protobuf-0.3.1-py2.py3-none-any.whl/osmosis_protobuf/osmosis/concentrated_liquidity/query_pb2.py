...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    DESCRIPTOR._serialized_options = b'ZNgithub.com/osmosis-labs/osmosis/v16/x/concentrated_liquidity/client/queryproto'
