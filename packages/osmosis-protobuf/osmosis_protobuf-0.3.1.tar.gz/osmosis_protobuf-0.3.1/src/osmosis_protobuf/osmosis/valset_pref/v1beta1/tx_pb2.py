...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _MSGSETVALIDATORSETPREFERENCE._serialized_options = b'\x8a\xe7\xb0*0osmosis/valset_pref/MsgSetValidatorSetPreference'
    ...
    _MSGDELEGATETOVALIDATORSET._serialized_options = b'\x8a\xe7\xb0*-osmosis/valset_pref/MsgDelegateToValidatorSet'
    ...
    _MSGUNDELEGATEFROMVALIDATORSET._serialized_options = b'\x8a\xe7\xb0*1osmosis/valset_pref/MsgUndelegateFromValidatorSet'
    ...
    _MSGWITHDRAWDELEGATIONREWARDS._serialized_options = b'\x8a\xe7\xb0*0osmosis/valset_pref/MsgWithdrawDelegationRewards'
