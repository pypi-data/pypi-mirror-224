...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _USERCONCENTRATEDSUPERFLUIDPOSITIONSDELEGATEDRESPONSE.fields_by_name['cl_pool_user_position_records']._options = None
    _USERCONCENTRATEDSUPERFLUIDPOSITIONSDELEGATEDRESPONSE.fields_by_name['cl_pool_user_position_records']._serialized_options = b'\xc8\xde\x1f\x00'
    _USERCONCENTRATEDSUPERFLUIDPOSITIONSUNDELEGATINGRESPONSE.fields_by_name['cl_pool_user_position_records']._options = None
    _USERCONCENTRATEDSUPERFLUIDPOSITIONSUNDELEGATINGRESPONSE.fields_by_name['cl_pool_user_position_records']._serialized_options = b'\xc8\xde\x1f\x00'
    ...
    _QUERY.methods_by_name['UserConcentratedSuperfluidPositionsDelegated']._options = None
    _QUERY.methods_by_name['UserConcentratedSuperfluidPositionsDelegated']._serialized_options = b'\x82\xd3\xe4\x93\x02P\x12N/osmosis/superfluid/v1beta1/account_delegated_cl_positions/{delegator_address}'
    _QUERY.methods_by_name['UserConcentratedSuperfluidPositionsUndelegating']._options = None
    _QUERY.methods_by_name['UserConcentratedSuperfluidPositionsUndelegating']._serialized_options = b'\x82\xd3\xe4\x93\x02S\x12Q/osmosis/superfluid/v1beta1/account_undelegating_cl_positions/{delegator_address}'
    ...
    _globals['_USERCONCENTRATEDSUPERFLUIDPOSITIONSDELEGATEDREQUEST']._serialized_start = 4142
    _globals['_USERCONCENTRATEDSUPERFLUIDPOSITIONSDELEGATEDREQUEST']._serialized_end = 4222
    _globals['_USERCONCENTRATEDSUPERFLUIDPOSITIONSDELEGATEDRESPONSE']._serialized_start = 4225
    _globals['_USERCONCENTRATEDSUPERFLUIDPOSITIONSDELEGATEDRESPONSE']._serialized_end = 4380
    _globals['_USERCONCENTRATEDSUPERFLUIDPOSITIONSUNDELEGATINGREQUEST']._serialized_start = 4382
    _globals['_USERCONCENTRATEDSUPERFLUIDPOSITIONSUNDELEGATINGREQUEST']._serialized_end = 4465
    _globals['_USERCONCENTRATEDSUPERFLUIDPOSITIONSUNDELEGATINGRESPONSE']._serialized_start = 4468
    _globals['_USERCONCENTRATEDSUPERFLUIDPOSITIONSUNDELEGATINGRESPONSE']._serialized_end = 4626
    _globals['_QUERY']._serialized_start = 4629
    _globals['_QUERY']._serialized_end = 8279