...
setuptools.setup(
     name='operational-hours-local-python-package-local',  
     version='0.0.1', # https://pypi.org/project/operational-hours-local-python-package/
     author="Circles",
     author_email="info@circles.life",
     description="PyPI Package for Circles operational-hours-local-python-package Local Python", 
