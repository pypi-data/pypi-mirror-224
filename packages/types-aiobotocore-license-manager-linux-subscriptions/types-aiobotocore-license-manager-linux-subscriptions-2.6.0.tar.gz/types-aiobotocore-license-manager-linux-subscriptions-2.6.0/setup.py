...
setup(
    ...
    description=(
        "Type annotations for aiobotocore.LicenseManagerLinuxSubscriptions 2.6.0 service generated"
    ...
    keywords=(
        "aiobotocore license-manager-linux-subscriptions type-annotations botocore mypy typeshed"
        " autocomplete"
    ),
