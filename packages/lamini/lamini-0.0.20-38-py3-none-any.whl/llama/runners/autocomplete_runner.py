...
class AutocompleteRunner:
    ...
    def evaluate_autocomplete(self, data: Union[str, List[str]]) -> Union[str, List[str]]:
        ...
        return [{
            ...
            "predicted_output": predictions[i] if isinstance(predictions, list) else predictions
    ...
    def print_verbose(self, data_strings, verbose: bool = False):
        if verbose:
            print("Sample data: %s" % str(str(data_strings[0][0].input) + str(data_strings[0][1].output)))
    ...
    def load_data(self, data, verbose: bool = False):
        ...
        for data_object in data:
            ...
            for field in fields:
                ...
                data_strings.append([Input(input=input_string), Output(output=output_string)])
    ...
    def load_data_from_jsonlines(self, file_path: str, keys = None, verbose: bool = False):
        """
    ...
    def load_data_from_dataframe(self, df: pd.DataFrame, columns = None, verbose: bool = False):
        """
