...
class WhatsAppCloudApi:
    ...
    def send_catalog(
            ...
            body: str,
            footer: str | None = None,
            thumbnail_prod_retailer_id: str | None = None,
    ):
        """
        Send a catalog to a WhatsApp user.
        ...
        Args:
            ...
            body: The body of the message.
            footer: The footer of the message.
            thumbnail_prod_retailer_id: The ID of the product thumbnail.
        Returns:
            The sent message.
        """
        data = {
        ...
        if thumbnail_prod_retailer_id is not None:
            data["interactive"]["action"]["parameters"] = {"thumbnail_product_retailer_id": thumbnail_prod_retailer_id}
    ...
    def change_commerce_settings(self, cart_enabled: bool = True, catalog_visible: bool = True) -> dict[str, bool]:
        """
        ...
        return self._make_request(
            method="POST",
            endpoint=f"/{self.phone_id}/whatsapp_commerce_settings",
            params={'is_cart_enabled': cart_enabled, 'is_catalog_visible': catalog_visible}
        )
