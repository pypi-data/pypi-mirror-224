...
def combat(attack_potency: int,
    ...
    * `breakthrough`: Whether or not the attacker rolls exploding dice.
    ...
    """
    outcome = _combat(attack_potency, enemy_potency,
...
def team_combat(
    ...
    * `n_faces`: The number of faces on the dice.
    ...
    outcome = _team_combat(leader_potency, helper_potency, enemy_potency,
                           damage_policy, inappropriate, n_faces=n_faces)
...
def single_action_conflict(
    ...
    * `n_faces`: The number of faces on the dice.
    * `breakthrough`: Whether the attacker has exploding dice.
    ...
    0.0
    """
    attack_die = d(n_faces).explode() if breakthrough else d(n_faces)
    enemy_die = d(n_faces)
    
    attack_pool = attack_potency @ attack_die
...
def target_number(
    ...
    # Arguments:
    * `potency`: The potency of the cliché being rolled against.
    ...
    * `breakthrough`: Whether to roll exploding dice.
    ...
    """
    die = d(n_faces).explode() if breakthrough else d(n_faces)
