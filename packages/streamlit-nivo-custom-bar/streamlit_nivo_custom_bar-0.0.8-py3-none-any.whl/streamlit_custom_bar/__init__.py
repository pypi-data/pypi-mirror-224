...
def custom_bar_chart(chartData=None, imgData=None, mainContainerStyles=None, barText=None,normalChart=None, style=None, chartLayout=None, showLegend=False, key=None):
