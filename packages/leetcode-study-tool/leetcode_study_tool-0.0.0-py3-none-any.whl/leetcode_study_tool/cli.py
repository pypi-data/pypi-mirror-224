...
def generate_problem(
    ...
    """
    Generates an Anki problem strings for the given URL in the requested format

    Arguments
    ---------
    url : str
        The URL of the question to generate an Anki problem for.
    language : str
        The coding language to generate an Anki problem for.

    Returns
    -------
    str
        The Anki problem for the given URL.
    """
    url = url.strip()
    if not url:
        return None
...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        description="Generate an Anki problem from a LeetCode question.",
    ...
    input.add_argument(
        ...
        type=str,
        help=(
            "The URL(s) or slug(s) of the LeetCode question(s) to generate Anki"
            " problem(s) for."
        ),
    )
    ...
    input.add_argument(
        ...
        help=(
            ...
            " question(s) to generate Anki problem(s) for."
        ),
    )
    ...
    parser.add_argument(
        ...
        type=str,
        default="output.txt",
        help="The output file to write the Anki problem(s) to.",
    )
    ...
    parser.add_argument(
        ...
        "-l",
        type=str,
        help="The language to generate Anki problem(s) for.",
    )
...
def cli(args: argparse.Namespace):
    """
    Handles the multi-processing of the Anki problem generation.
    """
    if args.url:
        urls = args.url.split(",")
    elif args.file:
