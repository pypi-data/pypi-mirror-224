...
class Electron:
    ...
    def _default_data_dir(self):
        if platform.system() == 'Windows':
            return os.path.expanduser("~\\.electron")
        else:
            return os.path.expanduser("~/.electron")
...
class Recovery:
    ...
    def _extract_zip_restore(self, backup_path):
        ...
        target_path = os.path.join(os.path.expanduser("~"), '.electron', restored_folder)
    ...
    def find_one(self, query):
        try:
            ...
            if matching_items:
                ...
                error_msg = f"No matching documents found for query: {query}"
