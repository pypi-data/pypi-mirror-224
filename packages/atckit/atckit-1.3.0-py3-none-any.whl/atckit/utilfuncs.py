...
class UtilFuncs:
    ...
    def dump_sstr(self,content:dict[typing.Any,typing.Any],output_type:str,**kwargs:typing.Any) -> str:
        ...
        kwargs:
            See the related kwargs for:
                ...
                tomlkit.dumps
        """
        if output_type not in self.OUTPUT_TYPE_MAP.keys():
            raise LookupError("Output Type is not valid",output_type)
        dumper:typing.Callable = self.OUTPUT_TYPE_MAP[output_type]
        try:
