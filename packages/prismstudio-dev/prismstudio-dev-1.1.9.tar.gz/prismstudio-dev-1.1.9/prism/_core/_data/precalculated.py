from ..._common.const import PrecalculatedDataComponentType as _PrecalculatedDataComponentType
from .._req_builder._list import _list_dataitem_precalculated
from ..._prismcomponent.datacomponent import _AFL
...
@_validate_args
def alpha_factor_library(dataitemid: int):
    """
    ...
    Examples
    --------
        >>> di = prism.precalculated.afl_dataitems('Turnover')
        ...
        >>> turnover = prism.precalculated.alpha_factor_library(dataitemid=900306)
    ...
    """
    return _AFL(dataitemid=dataitemid)
...
def dataitems(search: str = None):
    ...
    Examples
    --------
        >>> di = prism.precalculated.dataitems("Debt")
        >>> di[['dataitemid', 'dataitemname']]
           dataitemid                                       dataitemname
    ...
    """
    return _list_dataitem_precalculated(None, search)

def afl_dataitems(search: str = None):
    """
    ...
    Examples
    --------
        >>> di = prism.precalculated.afl_dataitems("Debt")
        >>> di[['dataitemid', 'dataitemname']]
           dataitemid                                       dataitemname
        0      900033  1-Year Change in Long Term Debt to Avg Total A...
        1      900059                           1Y Chg in Debt to Assets
    ...
    return _list_dataitem_precalculated(_PrecalculatedDataComponentType.AFL, search)
