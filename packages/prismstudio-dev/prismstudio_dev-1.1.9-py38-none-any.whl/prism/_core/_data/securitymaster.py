...
from ..._prismcomponent.datacomponent import _SecurityMasterAttribute
from ..._utils.validate_utils import _validate_args, get_sm_attributevalue
...
@_validate_args
def attribute(attribute: str, offset: int = 0):
    """
    ...
    Examples
    --------
        >>> gics = prism.securitymaster.attribute(attribute="Trade Currency")
    ...
    """
    attributevalue = get_sm_attributevalue(attribute)
    return _SecurityMasterAttribute(attribute=attributevalue, offset=offset)
