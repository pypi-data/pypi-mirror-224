...
from ..._common.const import (
    FinancialDataComponentType as _FinancialDataComponentType,
    PeriodType,
)
from .._req_builder._list import _list_dataitem_financial
...
__all__ = [
    ...
    "option",
    "dataitems",
    "balance_sheet_dataitems",
    "income_statement_dataitems",
    "cash_flow_dataitems",
    "segment_dataitems",
    "ratio_dataitems",
    "commitment_dataitems",
    "pension_dataitems",
    "option_dataitems",
    "other_dataitems",
]
...
def _build_financial(
    ...
    if periodtype in ["NTM", "Non-Periodic", "Q-SA"]:
        raise PrismValueError(
            f"Financial components cannot take {periodtype} as periodtype.",
            valid_list=PeriodType,
            invalids=["NTM", "Non-Periodic", "Q-SA"],
        )
...
def balance_sheet(
    ...
    Examples
    --------
        >>> di = prism.financial.balance_sheet_dataitems('asset')
    ...
    if periodtype in ["YTD", "LTM"]:
        raise PrismValueError(
            ...
            valid_list=PeriodType,
            invalids=["YTD", "LTM", "NTM", "Non-Periodic"],
        )
    return _build_financial(
        _BalanceSheet,
        dataitemid=dataitemid,
        periodtype=periodtype,
        preliminary=preliminary,
...
def cash_flow(
    ...
    Examples
    --------
        >>> di = prism.financial.cash_flow_dataitems('free cash')
...
def dps(
    ...
    Examples
    --------
        >>> di = prism.financial.dps_dataitems()
        >>> di[['dataitemid', 'dataitemname']]
            dataitemid                                       dataitemname
...
def eps(
    ...
    Examples
    --------
        >>> di = prism.financial.eps_dataitems()
        >>> di[['dataitemid', 'dataitemname']]
            dataitemid                                       dataitemname
...
def income_statement(
    ...
    Examples
    --------
        >>> di = prism.financial.income_statement_dataitems('net income')
            dataitemid                             dataitemname
...
def segment(
    ...
    Examples
    --------
        >>> segment = prism.financial.segment_dataitems()
...
def ratio(
    ...
    Examples
    --------
        >>> ratdi = prism.financial.ratio_dataitems()
...
def commitment(
    ...
    Examples
    --------
        >>> comdi = prism.financial.commitment_dataitems()
        ...
        0       20216251  2010-01-01    2009-09-30       KRW                                                      NaN     None                                         None
...
def pension(
    ...
    Examples
    --------
        >>> pendi = prism.financial.pension_dataitems()
...
def option(
    ...
    Examples
    --------
        >>> optdi = prism.financial.option_dataitems()
...
def dataitems(search: str = None, package: str = None):
    ...
    """
    return _list_dataitem_financial(None, search, package)


@_validate_args
def balance_sheet_dataitems(search : str = None, package : str = None):
    """
    ...
    Examples
    --------
        >>> prism.financial.balance_sheet_dataitems('asset')
            dataitemid  ...                                dataitemdescription
    ...
    """
    return _list_dataitem_financial(_FinancialDataComponentType.BALANCE_SHEET, search, package)


@_validate_args
def income_statement_dataitems(search : str = None, package : str = None):
    """
    ...
    Examples
    --------
        >>> prism.financial.income_statement_dataitems('income')
            dataitemid  ...                                dataitemdescription
    ...
    """
    return _list_dataitem_financial(_FinancialDataComponentType.INCOME_STATEMENT, search, package)


@_validate_args
def cash_flow_dataitems(search : str = None, package : str = None):
    """
    ...
    Examples
    --------
        >>> prism.financial.cash_flow_dataitems('free cash')
           dataitemid  ...       dataitemdescription
        0      100506  ...                      None
        1      100513  ...    Levered Free Cash Flow
        2      100544  ...  Unlevered Free Cash Flow
    """
    return _list_dataitem_financial(_FinancialDataComponentType.CASH_FLOW, search, package)


@_validate_args
def eps_dataitems(search : str = None, package : str = None):
    """
    ...
    Examples
    --------
        >>> epsdi = prism.financial.eps_dataitems()
        ...
        18      100579                                 Revenues Per Share
    """
    return _list_dataitem_financial(_FinancialDataComponentType.EPS, search, package)


@_validate_args
def dps_dataitems(search : str = None, package : str = None):
    """
    ...
    Examples
    --------
        >>> dpsdi = prism.financial.dps_dataitems()
        ...
        13      100560     Special Dividend Per Share Class B - Recurring
    """
    return _list_dataitem_financial(_FinancialDataComponentType.DPS, search, package)
...
@_validate_args
def segment_dataitems(search: str = None, package: str = None):
    """
    ...
    Examples
    --------
        >>> segdi = prism.financial.segment_dataitems()
        ...
        8      104737                   Business Segments - Net Income
    """
    return _list_dataitem_financial(_FinancialDataComponentType.SEGMENT, search, package)


@_validate_args
def ratio_dataitems(search: str = None, package: str = None):
    """
    ...
    Examples
    --------
        >>> ratdi = prism.financial.segment_dataitems()
        >>> ratdi[['dataitemid', 'dataitemname']]
             dataitemid                                       dataitemname
        0        104934                       Annualized Dividend Payout %
        1        104935                      Annualized Dividend Per Share
        ...
        307      114803  Altman Z Score Using the Average Stock Informa...
    """
    return _list_dataitem_financial(_FinancialDataComponentType.RATIO, search, package)


@_validate_args
def commitment_dataitems(search: str = None, package: str = None):
    """
    ...
    --------
        ...
        121      500286                     Year 5 - (Annual Only)
    """
    return _list_dataitem_financial(_FinancialDataComponentType.COMMITMENT, search, package)


@_validate_args
def pension_dataitems(search: str = None, package: str = None):
    """
    ...
    --------
        ...
        596      500350  Expected LT Return Rate on Plan Assets (%) - (...
    """
    return _list_dataitem_financial(_FinancialDataComponentType.PENSION, search, package)


@_validate_args
def option_dataitems(search: str = None, package: str = None):
    """
    ...
    --------
        ...
        113      107693                             Stock Option Plan Name
    """
    return _list_dataitem_financial(_FinancialDataComponentType.OPTION, search, package)
