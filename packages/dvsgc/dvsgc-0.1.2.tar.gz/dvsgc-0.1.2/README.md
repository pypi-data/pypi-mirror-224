# DVS Gesture Chain
Official implementation of the dataset defined in [Spiking Neural Networks for event-based action recognition: A new task to understand their advantage](https://arxiv.org/abs/2209.14915)
### Installation
From PyPI:
```
pip install dvsgc
