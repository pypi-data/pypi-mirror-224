from typing import Any, Union, List, TypedDict, Literal, Dict, Tuple
...
_EventType = Union[Literal["error"], Literal["csp"], Literal["hpkp"], Literal["expectct"], Literal["expectstaple"], Literal["transaction"], Literal["default"], Literal["generic"]]
"""
