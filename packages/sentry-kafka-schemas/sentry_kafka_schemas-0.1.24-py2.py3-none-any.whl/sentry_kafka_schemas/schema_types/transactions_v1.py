from typing import Literal, TypedDict, List, Any, Dict, Union, Tuple
...
TransactionStreamMessage = Tuple[Literal[2], Literal["insert"], "TransactionEvent"]
""" transaction_stream_message. """
...
class _Span(TypedDict, total=False):
    ...
    data: Required[Union["_SpanData", None]]
    """ Required property """

    hash: str


_SpanData = Union["_SpanDataAnyof0"]
""" Spans data bag """



_SpanDataAnyof0 = TypedDict('_SpanDataAnyof0', {
    'environment': Union[str, None],
    'http.method': Union[str, None],
    'span.action': Union[str, None],
    'span.domain': Union[str, None],
    'span.module': Union[str, None],
    'span.op': Union[str, None],
    # hex hash of the scrubbed span description
    'span.group': Union[str, None],
    'span.status': Union[str, None],
    'span.system': Union[str, None],
    'span.status_code': Union[int, None],
    'status_code': Union[int, None],
    'transaction': Union[str, None],
