...
Notes:
    ...
    cd ~/code/simple_dvc/docs
    sphinx-apidoc --private -f -o ~/code/simple_dvc/docs/source ~/code/simple_dvc/simple_dvc --separate
    make html
    ...
    Also:
        ...
        https://readthedocs.org/dashboard/simple-dvc/advanced/
        ...
        Click import project: (for github you can select, but gitlab you need to import manually)
            Set the Repository NAME: simple_dvc
            Set the Repository URL: https://gitlab.kitware.com/computer-vision/simple_dvc

        For gitlab you also need to setup an integrations and add gitlab
        incoming webhook

            https://readthedocs.org/dashboard/simple-dvc/integrations/create/

        Then go to

            https://gitlab.kitware.com/computer-vision/simple_dvc/hooks
        ...
        Will also need to activate the main branch:
            https://readthedocs.org/projects/simple-dvc/versions/
"""
#
...
modpath = join(dirname(dirname(dirname(__file__))), 'simple_dvc', '__init__.py')
...
# html_logo = '.static/simple_dvc.svg'
# html_favicon = '.static/simple_dvc.ico'
...
latex_documents = [
    (master_doc, 'simple_dvc.tex', 'simple_dvc Documentation',
     'Jon Crall', 'manual'),
]
...
man_pages = [
    (master_doc, 'simple_dvc', 'simple_dvc Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'simple_dvc', 'simple_dvc Documentation',
     author, 'simple_dvc', 'One line description of project.',
     'Miscellaneous'),
]
