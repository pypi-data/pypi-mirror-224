...
NAME = "simple_dvc"
INIT_PATH = "simple_dvc/__init__.py"
...
if __name__ == "__main__":
    ...
    setupkw["url"] = None
    setupkw["description"] = "The simple_dvc module"
    ...
    setupkw["package_data"] = {"simple_dvc": ["py.typed", "*.pyi"]}
    setupkw["entry_points"] = {
        "console_scripts": [
            "simple_dvc = simple_dvc.__main__:main",
            "sdvc = simple_dvc.__main__:main",
        ],
    }
    setup(**setupkw)
