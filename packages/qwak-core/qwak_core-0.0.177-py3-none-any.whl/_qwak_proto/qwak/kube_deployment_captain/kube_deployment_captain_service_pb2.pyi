...
class RevertModelDeploymentRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["kube_deployment_type", b"kube_deployment_type", "model_id", b"model_id", "variation_name", b"variation_name"]) -> None: ...
