...
class JobRecord(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["creation_time", b"creation_time", "end_time", b"end_time", "exec_id", b"exec_id", "execution_id", b"execution_id", "job_metadata", b"job_metadata", "legacy_run_id", b"legacy_run_id", "start_time", b"start_time"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["account_id", b"account_id", "creation_time", b"creation_time", "end_time", b"end_time", "environment_id", b"environment_id", "exec_id", b"exec_id", "execution_id", b"execution_id", "featureset_id", b"featureset_id", "featureset_name", b"featureset_name", "job_id", b"job_id", "job_labels", b"job_labels", "job_metadata", b"job_metadata", "job_status", b"job_status", "legacy_run_id", b"legacy_run_id", "start_time", b"start_time"]) -> None: ...
...
class BatchBackfillMetadata(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["backfill_spec", b"backfill_spec", "offline_processing_end_time", b"offline_processing_end_time", "offline_processing_start_time", b"offline_processing_start_time", "online_processing_end_time", b"online_processing_end_time", "online_processing_start_time", b"online_processing_start_time"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["backfill_spec", b"backfill_spec", "num_affected_rows", b"num_affected_rows", "num_interval_rows", b"num_interval_rows", "offline_processing_end_time", b"offline_processing_end_time", "offline_processing_start_time", b"offline_processing_start_time", "online_processing_end_time", b"online_processing_end_time", "online_processing_start_time", b"online_processing_start_time"]) -> None: ...
