...
class DeployBatchBackfillRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["backfill_spec", b"backfill_spec", "execution_identifier", b"execution_identifier", "feature_set_deployment", b"feature_set_deployment"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["backfill_spec", b"backfill_spec", "environment_id", b"environment_id", "execution_identifier", b"execution_identifier", "feature_set_deployment", b"feature_set_deployment"]) -> None: ...
