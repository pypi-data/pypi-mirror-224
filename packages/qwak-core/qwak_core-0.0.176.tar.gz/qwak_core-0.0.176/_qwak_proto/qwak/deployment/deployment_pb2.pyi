...
class DeploymentDetails(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["available_replicas", b"available_replicas", "build_id", b"build_id", "cpu_fraction", b"cpu_fraction", "custom_iam_role_arn", b"custom_iam_role_arn", "daemon_mode", b"daemon_mode", "deployment_process_timeout_limit", b"deployment_process_timeout_limit", "environment_id", b"environment_id", "environment_variables", b"environment_variables", "gpu_amount", b"gpu_amount", "gpu_type", b"gpu_type", "http_request_timeout_ms", b"http_request_timeout_ms", "kube_deployment_type", b"kube_deployment_type", "last_deployed", b"last_deployed", "max_batch_size", b"max_batch_size", "memory_amount", b"memory_amount", "memory_units", b"memory_units", "number_of_pods", b"number_of_pods", "number_of_workers", b"number_of_workers", "purchase_option", b"purchase_option", "serving_strategy", b"serving_strategy", "status", b"status", "undeployment_time", b"undeployment_time", "variation", b"variation"]) -> None: ...
