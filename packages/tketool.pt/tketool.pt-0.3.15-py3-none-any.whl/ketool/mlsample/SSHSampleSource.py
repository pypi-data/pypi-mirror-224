...
from ketool.mlsample.LocalSampleSource import LocalDisk_NLSampleSource
from ketool.JConfig import j_config
from ketool.files import create_folder_if_not_exsited
from ketool.utils.progressbar import process_status_bar
import os
...
class SSHSampleSource(LocalDisk_NLSampleSource):
    ...
    def instance_default():
        folder_path = j_config.get_config("ssh_samplesource_folderpath")
        endpoint = j_config.get_config("ssh_samplesource_endpoint")
        access_user = j_config.get_config("ssh_samplesource_user")
        access_pwd = j_config.get_config("ssh_samplesource_pwd")
        access_target_path = j_config.get_config("ssh_samplesource_target_apth")
    ...
    def _download_if_not_exsited(self, name: str):
        ...
        if name in all_sets:
            create_folder_if_not_exsited(os.path.join(self.base_folder, name))
