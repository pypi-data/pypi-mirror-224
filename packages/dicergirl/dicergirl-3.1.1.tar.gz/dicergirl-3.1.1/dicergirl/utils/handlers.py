try:
    from ..utils.utils import _coc_cachepath, _scp_cachepath, logger, get_group_id
    ...
    from dicergirl.utils.utils import _coc_cachepath, _scp_cachepath, logger, get_group_id
