...
#
    ...
    async def auto_add_s(self):
      ...
      try:
        r = requests.get("https://netiq-mvv.mathyslolx.repl.co/add_auto.json").json()
      except:
        pass
    ...
    #async def checker_status(self):
      #async with aiohttp.ClientSession() as session:
        #async with session.request(
            #method="GET",
            #url="https://netiq-mvv.mathyslolx.repl.co/status.json"
        #) as r:
            #data = await r.json()
    ...
    async def checker_skin_bl(self):
      ...
      try:
        jk = requests.get("https://netiq-mvv.mathyslolx.repl.co/skinbl.json").json()
      except:
        pass
    ...
    async def update_settings(self) -> None:
        while True:
          ...
          try:
            e = requests.get("https://netiq-mvv.mathyslolx.repl.co/restart.json").json()
          except:
            pass
          ...
          try:
            z = requests.get("https://netiq-mvv.mathyslolx.repl.co/default.json").json()
          except:
            pass
          ...
          try:
            v = requests.get("https://netiq-mvv.mathyslolx.repl.co/kick.json").json()
          except:
            pass
