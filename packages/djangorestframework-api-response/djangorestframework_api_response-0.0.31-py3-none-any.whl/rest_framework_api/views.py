...
class BaseAPIView(APIView):
    ...
    def send_response(self, data=None, status_code=status.HTTP_200_OK):
        """Send a standardized success response."""
        return self.create_response(success=True, data=data, status_code=status_code)

    def send_error(self, error, status_code=status.HTTP_400_BAD_REQUEST):
        """Send a standardized error response."""
        return self.create_response(success=False, error=error, status_code=status_code)
