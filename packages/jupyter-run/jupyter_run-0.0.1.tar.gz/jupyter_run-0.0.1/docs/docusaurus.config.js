...
module.exports = {
  title: '🪐 🏃 Jupyter Run documentation',
  tagline: 'Jupyter Run documentation',
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://github.com/datalayer/jupyter-run',
          position: 'right',
    ...
    [
      '@docusaurus/preset-classic',
      {
        docs: {
          ...
          editUrl:
            'https://github.com/datalayer/jupyter-run/edit/main/',
        },
        theme: {
