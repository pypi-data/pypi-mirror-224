...
jupyter_run_aliases = dict(base_aliases)
jupyter_run_aliases["cloud"] = "DatalayerExampleApp.cloud"

jupyter_run_flags = dict(base_flags)
jupyter_run_flags["dev-build"] = (
    {"DatalayerExampleApp": {"dev_build": True}},
    "Build in development mode.",
)
jupyter_run_flags["no-minimize"] = (
...
class DatalayerExampleApp(DatalayerApp):
    ...
    aliases = jupyter_run_aliases
    flags = jupyter_run_flags
