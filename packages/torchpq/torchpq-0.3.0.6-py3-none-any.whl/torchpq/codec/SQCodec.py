...
class SQCodec(BaseCodec):
  ...
  Parameters:
    ...
    mode: str, default : minmax
      mode of uniform scalar quantization
      supported modes are "minmax" and "meanstd"
  ...
  def encode(self, input):
    """
    Quantize 32bit float to 16/8/4 bit scalar
      input:
        torch.Tensor
  ...
  def decode(self, code):
    """
    Decode 16/8/4 bit scalar to 32bit float
      code:
        torch.Tensor
