...
catsoop.groups_buttons = [
  "cs_groups_addtogroup",
  "cs_groups_newpartners",
  "cs_groups_reassign",
];
catsoop.groups_selectors = [
  "cs_groups_name1",
  "cs_groups_name2",
  "cs_groups_nameadd",
];
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  document
    ...
    .addEventListener("change", catsoop.update_group_list);
  document
    .getElementById("cs_groups_reassign")
    .addEventListener("click", catsoop.groups_confirm_and_partner_all);
  document
    .getElementById("cs_groups_addtogroup")
    .addEventListener("click", catsoop.groups_add);
  document
    .getElementById("cs_groups_newpartners")
    .addEventListener("click", catsoop.groups_partner);
});
