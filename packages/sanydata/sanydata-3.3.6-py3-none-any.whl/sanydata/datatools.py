    ...
    def get_first_faultV2(self, stub, farm=None, turbine=None, fault_code=None,
        ...
        try:
            ...
            if result_dataframe != '':
                ...
                for ele in ["fault_start_time", "fault_end_time", "analy_time", "created_at", "updated_at"]:
                    df[ele] = df[ele].map(lambda x: datetime.datetime.fromtimestamp(x/1000) if pd.notna(x) else x)
