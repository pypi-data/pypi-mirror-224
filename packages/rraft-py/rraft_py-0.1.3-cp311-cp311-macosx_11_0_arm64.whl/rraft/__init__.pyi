...
class ThreadSafeLogger(__API_Logger):
    """ """
...
class InMemoryRawNode(__API_RawNode):
    ...
    def __init__(
        ...
        logger: "Logger" | "LoggerRef" | "ThreadSafeLogger",
    ) -> None: ...
...
class __API_Unstable:
    ...
    def get_logger(self) -> "LoggerRef":
        ...
        """
    def set_logger(self, logger: "Logger" | "LoggerRef" | "ThreadSafeLogger") -> None:
        """
        `logger`: The tag to use when logging.
        """
...
class Unstable(__API_Unstable):
    ...
    def __init__(
        self, offset: int, logger: "Logger" | "LoggerRef" | "ThreadSafeLogger"
    ) -> None: ...
...
class RaftLog(__API_RaftLog):
    ...
    def __init__(
        self, store: "StorageRef", logger: "Logger" | "LoggerRef" | "ThreadSafeLogger"
    ) -> None: ...
