...
class MyDocument(object):
    ...
    def __init__(self, url: str = '', drop: bool = True):
        if url == '':
            url = 'https://spark-1320043116.cos.ap-chongqing.myqcloud.com/word.docx'
...
class IP():
    ...
    def __init__(self):
        self.__ip_info = pd.read_table('https://spark-1320043116.cos.ap-chongqing.myqcloud.com/ip_info.txt', sep=',', keep_default_na='', dtype='str')
...
class BANK():
    ...
    def __init__(self):
        self.__df = pd.read_table('https://spark-1320043116.cos.ap-chongqing.myqcloud.com/bankBIN.txt', keep_default_na='')
    ...
    def parse_bankber(self, card: str):
        ...
        lins = self.__df[self.__df['长度']==len(card)]
        for i in lins.index:
