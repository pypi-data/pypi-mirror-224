...
def fake_repo_instance():
    ...
    fake_repo_instance = FakeRepo(TEST_REPO_ID, TEST_HIL_ROOT_PATH)
...
def test_run_command_upload_network_error(monkeypatch, fake_repo_instance):
...
def test_run_command_run_no_auth_token(mocker, fake_repo_instance):
