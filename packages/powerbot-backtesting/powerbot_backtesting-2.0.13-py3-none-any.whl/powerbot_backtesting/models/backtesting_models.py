...
class BacktestingAlgo(BacktestingBase):
    ...
    def __init__(self,
        ...
        # Load file input
        try:
            self.algo_params = pd.read_csv(cache_path.joinpath("analysis_input", input_file), sep=";")
        except FileNotFoundError:
            self.algo_params = pd.read_csv(input_file, sep=";")
    ...
    def run(self) -> Union[dict, bool]:
        ...
        for key, contract in self.orderbooks.groupby(["delivery_start", "delivery_end"]):
            ...
            contract = contract.sort_values("time_step").set_index("time_step")
