...
- [ ] 功能点
    ...
    if file:
        ...
        cb = ChatBase(llm=llm, embeddings=embeddings, vectorstore=FAISS)
        diskcache(cb.create_index)(docs)

        reply_func = lambda query: cb.llm_qa(query=query, k=3, threshold=0)
