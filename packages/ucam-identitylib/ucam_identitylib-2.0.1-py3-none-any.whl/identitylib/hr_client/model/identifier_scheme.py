...
class IdentifierScheme(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """IdentifierScheme - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (str): An enumeration.., must be one of ["person.v1.human-resources.university.identifiers.cam.ac.uk", "v1.person.identifiers.cam.ac.uk", ]  # noqa: E501

        Keyword Args:
            value (str): An enumeration.., must be one of ["person.v1.human-resources.university.identifiers.cam.ac.uk", "v1.person.identifiers.cam.ac.uk", ]  # noqa: E501
