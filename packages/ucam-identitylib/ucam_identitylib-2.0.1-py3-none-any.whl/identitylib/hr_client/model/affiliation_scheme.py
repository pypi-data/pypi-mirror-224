...
class AffiliationScheme(ModelSimple):
    ...
    allowed_values = {
        ('value',): {
            'INSTITUTION.V1.HUMAN-RESOURCES.UNIVERSITY.IDENTIFIERS.CAM.AC.UK': "institution.v1.human-resources.university.identifiers.cam.ac.uk",
            'INSTITUTION.V1.STUDENT-RECORDS.UNIVERSITY.IDENTIFIERS.CAM.AC.UK': "institution.v1.student-records.university.identifiers.cam.ac.uk",
    ...
    def __init__(self, *args, **kwargs):
        """AffiliationScheme - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (str): An enumeration.., must be one of ["institution.v1.human-resources.university.identifiers.cam.ac.uk", "institution.v1.student-records.university.identifiers.cam.ac.uk", "person.v1.human-resources.university.identifiers.cam.ac.uk", ]  # noqa: E501

        Keyword Args:
            value (str): An enumeration.., must be one of ["institution.v1.human-resources.university.identifiers.cam.ac.uk", "institution.v1.student-records.university.identifiers.cam.ac.uk", "person.v1.human-resources.university.identifiers.cam.ac.uk", ]  # noqa: E501
