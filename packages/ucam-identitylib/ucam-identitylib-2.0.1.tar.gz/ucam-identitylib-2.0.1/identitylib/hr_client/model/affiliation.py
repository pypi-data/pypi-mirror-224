...
def lazy_import():
    ...
    globals()['AffiliationScheme'] = AffiliationScheme


class Affiliation(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'scheme': (AffiliationScheme,),  # noqa: E501
            'status': (str,),  # noqa: E501
            'value': (str,),  # noqa: E501
            'end': (date, none_type,),  # noqa: E501
            'start': (date, none_type,),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, scheme, status, value, *args, **kwargs):  # noqa: E501
        """Affiliation - a model defined in OpenAPI

        Args:
            scheme (AffiliationScheme):
            status (str): A staff member's status in relation to an affiliated entity. Currently this will be their job title or `report`, indicating that this person reports to the affiliated entity.
            value (str): The value of this affiliation. This will be specific to the human resources system, indicating an entity that this staff member is affiliated with.
        ...
        Keyword Args:
            ...
            end (date, none_type): The end date of this affiliation. May not be populated if the affiliation is open-ended.. [optional]  # noqa: E501
            start (date, none_type): The start date of this affiliation. May not be populated if not known.. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, scheme, status, value, *args, **kwargs):  # noqa: E501
        """Affiliation - a model defined in OpenAPI
