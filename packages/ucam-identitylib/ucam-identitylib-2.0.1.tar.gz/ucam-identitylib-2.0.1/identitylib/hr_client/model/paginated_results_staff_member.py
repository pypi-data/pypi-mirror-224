...
def lazy_import():
    ...
    globals()['StaffMember'] = StaffMember


class PaginatedResultsStaffMember(ModelNormal):
    ...
    def _from_openapi_data(cls, results, *args, **kwargs):  # noqa: E501
        """PaginatedResultsStaffMember - a model defined in OpenAPI

        Args:
            results ([StaffMember]): A list of the current page of results.
        ...
        Keyword Args:
            ...
            next (str): The url to use to retrieve the next page of results.. [optional]  # noqa: E501
            previous (str): The url to use to retrieve the previous page of results.. [optional]  # noqa: E501
        """
