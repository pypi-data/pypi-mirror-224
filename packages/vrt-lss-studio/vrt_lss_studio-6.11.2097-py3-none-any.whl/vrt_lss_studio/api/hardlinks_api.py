...
class HardlinksApi(object):
    ...
    @validate_arguments
    def enable_hardlinks(self, experiment_key : Annotated[constr(strict=True, max_length=256, min_length=2), Field(..., description="Key, unique identifier.")], request_body : Annotated[conlist(constr(strict=True, max_length=1024, min_length=1), max_items=15001, min_items=0), Field(..., description="Enable hardlinks request.")], **kwargs) -> None:  # noqa: E501
    ...
    @validate_arguments
    def enable_hardlinks_with_http_info(self, experiment_key : Annotated[constr(strict=True, max_length=256, min_length=2), Field(..., description="Key, unique identifier.")], request_body : Annotated[conlist(constr(strict=True, max_length=1024, min_length=1), max_items=15001, min_items=0), Field(..., description="Enable hardlinks request.")], **kwargs):  # noqa: E501
        """Enable hardlinks  # noqa: E501
