...
class TransportsApi(object):
    ...
    @validate_arguments
    def disable_transports_with_http_info(self, experiment_key : Annotated[constr(strict=True, max_length=256, min_length=2), Field(..., description="Key, unique identifier.")], request_body : Annotated[conlist(constr(strict=True, max_length=1024, min_length=1), max_items=15001, min_items=0), Field(..., description="Disable transports request.")], **kwargs):  # noqa: E501
        """Disable transports  # noqa: E501
    ...
    @validate_arguments
    def enable_transports(self, experiment_key : Annotated[constr(strict=True, max_length=256, min_length=2), Field(..., description="Key, unique identifier.")], request_body : Annotated[conlist(constr(strict=True, max_length=1024, min_length=1), max_items=15001, min_items=0), Field(..., description="Enable transports request.")], **kwargs) -> None:  # noqa: E501
    ...
    @validate_arguments
    def enable_transports_with_http_info(self, experiment_key : Annotated[constr(strict=True, max_length=256, min_length=2), Field(..., description="Key, unique identifier.")], request_body : Annotated[conlist(constr(strict=True, max_length=1024, min_length=1), max_items=15001, min_items=0), Field(..., description="Enable transports request.")], **kwargs):  # noqa: E501
        """Enable transports  # noqa: E501
