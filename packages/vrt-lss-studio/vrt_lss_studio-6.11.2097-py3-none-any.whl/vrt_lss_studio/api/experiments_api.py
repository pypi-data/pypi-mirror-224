...
class ExperimentsApi(object):
    ...
    @validate_arguments
    def create_experiment_with_http_info(self, experiment_specification : Annotated[ExperimentSpecification, Field(..., description="Experiment create request.")], **kwargs):  # noqa: E501
        """Create experiment  # noqa: E501
        ...
        _body_params = None
        if _params['experiment_specification']:
    ...
    @validate_arguments
    def create_experiment_share(self, experiment_key : Annotated[constr(strict=True, max_length=256, min_length=2), Field(..., description="Key, unique identifier.")], **kwargs) -> Experiment:  # noqa: E501
    ...
    @validate_arguments
    def create_experiment_share_with_http_info(self, experiment_key : Annotated[constr(strict=True, max_length=256, min_length=2), Field(..., description="Key, unique identifier.")], **kwargs):  # noqa: E501
        """Share experiment  # noqa: E501
    ...
    @validate_arguments
    def delete_experiment(self, experiment_key : Annotated[constr(strict=True, max_length=256, min_length=2), Field(..., description="Key, unique identifier.")], **kwargs) -> None:  # noqa: E501
    ...
    @validate_arguments
    def delete_experiment_with_http_info(self, experiment_key : Annotated[constr(strict=True, max_length=256, min_length=2), Field(..., description="Key, unique identifier.")], **kwargs):  # noqa: E501
        """Experiment removal  # noqa: E501
    ...
    @validate_arguments
    def delete_experiment_share(self, experiment_key : Annotated[constr(strict=True, max_length=256, min_length=2), Field(..., description="Key, unique identifier.")], **kwargs) -> Experiment:  # noqa: E501
    ...
    @validate_arguments
    def delete_experiment_share_with_http_info(self, experiment_key : Annotated[constr(strict=True, max_length=256, min_length=2), Field(..., description="Key, unique identifier.")], **kwargs):  # noqa: E501
        """Stop sharing  # noqa: E501
    ...
    @validate_arguments
    def duplicate_experiment(self, experiment_key : Annotated[constr(strict=True, max_length=256, min_length=2), Field(..., description="Key, unique identifier.")], experiment_specification : Annotated[ExperimentSpecification, Field(..., description="Experiment duplicate request.")], **kwargs) -> str:  # noqa: E501
    ...
    @validate_arguments
    def duplicate_experiment_with_http_info(self, experiment_key : Annotated[constr(strict=True, max_length=256, min_length=2), Field(..., description="Key, unique identifier.")], experiment_specification : Annotated[ExperimentSpecification, Field(..., description="Experiment duplicate request.")], **kwargs):  # noqa: E501
        """Experiment duplicate  # noqa: E501
    ...
    @validate_arguments
    def export_json(self, experiment_key : Annotated[constr(strict=True, max_length=256, min_length=2), Field(..., description="Key, unique identifier.")], **kwargs) -> UniversalData:  # noqa: E501
    ...
    @validate_arguments
    def export_json_with_http_info(self, experiment_key : Annotated[constr(strict=True, max_length=256, min_length=2), Field(..., description="Key, unique identifier.")], **kwargs):  # noqa: E501
        """Export (JSON)  # noqa: E501
    ...
    @validate_arguments
    def export_xlsx(self, experiment_key : Annotated[constr(strict=True, max_length=256, min_length=2), Field(..., description="Key, unique identifier.")], timezone : Annotated[Optional[conint(strict=True, le=12, ge=-12)], Field(description="Timezone.")] = None, **kwargs) -> bytearray:  # noqa: E501
    ...
    @validate_arguments
    def export_xlsx_with_http_info(self, experiment_key : Annotated[constr(strict=True, max_length=256, min_length=2), Field(..., description="Key, unique identifier.")], timezone : Annotated[Optional[conint(strict=True, le=12, ge=-12)], Field(description="Timezone.")] = None, **kwargs):  # noqa: E501
        """Export (XLSX)  # noqa: E501
    ...
    @validate_arguments
    def import_json(self, experiment_key : Annotated[constr(strict=True, max_length=256, min_length=2), Field(..., description="Key, unique identifier.")], universal_data : Annotated[UniversalData, Field(..., description="Data (JSON).")], **kwargs) -> Experiment:  # noqa: E501
    ...
    @validate_arguments
    def import_json_with_http_info(self, experiment_key : Annotated[constr(strict=True, max_length=256, min_length=2), Field(..., description="Key, unique identifier.")], universal_data : Annotated[UniversalData, Field(..., description="Data (JSON).")], **kwargs):  # noqa: E501
        """Import (JSON)  # noqa: E501
    ...
    @validate_arguments
    def import_json_url(self, experiment_key : Annotated[constr(strict=True, max_length=256, min_length=2), Field(..., description="Key, unique identifier.")], url : Annotated[constr(strict=True, max_length=512, min_length=10), Field(..., description="Url to json file.")], **kwargs) -> Experiment:  # noqa: E501
    ...
    @validate_arguments
    def import_json_url_with_http_info(self, experiment_key : Annotated[constr(strict=True, max_length=256, min_length=2), Field(..., description="Key, unique identifier.")], url : Annotated[constr(strict=True, max_length=512, min_length=10), Field(..., description="Url to json file.")], **kwargs):  # noqa: E501
        """Import (JSON) from URL  # noqa: E501
    ...
    @validate_arguments
    def import_xlsx(self, experiment_key : Annotated[constr(strict=True, max_length=256, min_length=2), Field(..., description="Key, unique identifier.")], body : Annotated[Union[StrictBytes, StrictStr], Field(..., description="Data (XLSX).")], timezone : Annotated[Optional[conint(strict=True, le=12, ge=-12)], Field(description="Timezone.")] = None, **kwargs) -> Experiment:  # noqa: E501
    ...
    @validate_arguments
    def read_experiment(self, experiment_key : Annotated[constr(strict=True, max_length=256, min_length=2), Field(..., description="Key, unique identifier.")], **kwargs) -> Experiment:  # noqa: E501
    ...
    @validate_arguments
    def read_experiment_with_http_info(self, experiment_key : Annotated[constr(strict=True, max_length=256, min_length=2), Field(..., description="Key, unique identifier.")], **kwargs):  # noqa: E501
        """Reading experiment  # noqa: E501
    ...
    @validate_arguments
    def run_experiment_calculation_with_http_info(self, experiment_key : Annotated[constr(strict=True, max_length=256, min_length=2), Field(..., description="Key, unique identifier.")], process_name : Annotated[BasicProcess, Field(..., description="Process name:   * `PLAN` - планирование   * `REPLAN` - перепланирование   * `ACTUALIZE` - актуализация ")], **kwargs):  # noqa: E501
        """Run calculation  # noqa: E501
    ...
    @validate_arguments
    def run_experiment_validation_with_http_info(self, experiment_key : Annotated[constr(strict=True, max_length=256, min_length=2), Field(..., description="Key, unique identifier.")], process_name : Annotated[BasicProcess, Field(..., description="Process name:   * `PLAN` - планирование   * `REPLAN` - перепланирование   * `ACTUALIZE` - актуализация ")], **kwargs):  # noqa: E501
        """Run validation  # noqa: E501
    ...
    @validate_arguments
    def stop_experiment_calculation(self, experiment_key : Annotated[constr(strict=True, max_length=256, min_length=2), Field(..., description="Key, unique identifier.")], **kwargs) -> None:  # noqa: E501
    ...
    @validate_arguments
    def stop_experiment_calculation_with_http_info(self, experiment_key : Annotated[constr(strict=True, max_length=256, min_length=2), Field(..., description="Key, unique identifier.")], **kwargs):  # noqa: E501
        """Calculation stop  # noqa: E501
    ...
    @validate_arguments
    def update_experiment(self, experiment_key : Annotated[constr(strict=True, max_length=256, min_length=2), Field(..., description="Key, unique identifier.")], experiment_specification : Annotated[ExperimentSpecification, Field(..., description="Experiment specification update request.")], **kwargs) -> Experiment:  # noqa: E501
    ...
    @validate_arguments
    def update_experiment_with_http_info(self, experiment_key : Annotated[constr(strict=True, max_length=256, min_length=2), Field(..., description="Key, unique identifier.")], experiment_specification : Annotated[ExperimentSpecification, Field(..., description="Experiment specification update request.")], **kwargs):  # noqa: E501
        """Experiment update  # noqa: E501
    ...
    @validate_arguments
    def update_experiment_indicators(self, experiment_key : Annotated[constr(strict=True, max_length=256, min_length=2), Field(..., description="Key, unique identifier.")], request_body : Annotated[conlist(constr(strict=True, max_length=256, min_length=2), max_items=100, min_items=0), Field(..., description="Indicators update request.")], **kwargs) -> Experiment:  # noqa: E501
    ...
    @validate_arguments
    def update_experiment_indicators_with_http_info(self, experiment_key : Annotated[constr(strict=True, max_length=256, min_length=2), Field(..., description="Key, unique identifier.")], request_body : Annotated[conlist(constr(strict=True, max_length=256, min_length=2), max_items=100, min_items=0), Field(..., description="Indicators update request.")], **kwargs):  # noqa: E501
        """Indicators update  # noqa: E501
    ...
    @validate_arguments
    def update_experiment_settings(self, experiment_key : Annotated[constr(strict=True, max_length=256, min_length=2), Field(..., description="Key, unique identifier.")], experiment_settings : Annotated[ExperimentSettings, Field(..., description="Experiment settings update request.")], **kwargs) -> Experiment:  # noqa: E501
    ...
    @validate_arguments
    def update_experiment_settings_with_http_info(self, experiment_key : Annotated[constr(strict=True, max_length=256, min_length=2), Field(..., description="Key, unique identifier.")], experiment_settings : Annotated[ExperimentSettings, Field(..., description="Experiment settings update request.")], **kwargs):  # noqa: E501
        """Settings update  # noqa: E501
        ...
        # process the body parameter
        _body_params = None
        if _params['experiment_settings']:
