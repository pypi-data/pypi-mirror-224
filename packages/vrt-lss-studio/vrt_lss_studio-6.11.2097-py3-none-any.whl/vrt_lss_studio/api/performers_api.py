...
from pydantic import Field, StrictStr, conint, conlist, constr
...
class PerformersApi(object):
    ...
    @validate_arguments
    def disable_performers_with_http_info(self, experiment_key : Annotated[constr(strict=True, max_length=256, min_length=2), Field(..., description="Key, unique identifier.")], request_body : Annotated[conlist(constr(strict=True, max_length=1024, min_length=1), max_items=15001, min_items=0), Field(..., description="Disable performers request.")], **kwargs):  # noqa: E501
        """Disable performers  # noqa: E501
    ...
    @validate_arguments
    def enable_performers(self, experiment_key : Annotated[constr(strict=True, max_length=256, min_length=2), Field(..., description="Key, unique identifier.")], request_body : Annotated[conlist(constr(strict=True, max_length=1024, min_length=1), max_items=15001, min_items=0), Field(..., description="Enable performers request.")], **kwargs) -> None:  # noqa: E501
    ...
    @validate_arguments
    def enable_performers_with_http_info(self, experiment_key : Annotated[constr(strict=True, max_length=256, min_length=2), Field(..., description="Key, unique identifier.")], request_body : Annotated[conlist(constr(strict=True, max_length=1024, min_length=1), max_items=15001, min_items=0), Field(..., description="Enable performers request.")], **kwargs):  # noqa: E501
        """Enable performers  # noqa: E501
    ...
    @validate_arguments
    def read_performers_geopoints_with_http_info(self, experiment_key : Annotated[constr(strict=True, max_length=256, min_length=2), Field(..., description="Key, unique identifier.")], offset : Annotated[Optional[conint(strict=True, le=10000000, ge=0)], Field(description="The number of items to skip before starting to collect the result set.")] = None, limit : Annotated[Optional[conint(strict=True, le=10000000, ge=1)], Field(description="The number of items to return.")] = None, table_performer_filter_list : Annotated[Optional[TablePerformerFilterList], Field(description="Performers filter.")] = None, **kwargs):  # noqa: E501
        """Performer geopoints  # noqa: E501
