...
class TableTripFields(BaseModel):
    ...
    cost: Optional[Union[confloat(ge=0, strict=True), conint(ge=0, strict=True)]] = Field(0, description="Total costs calculated based on the performer's and transport tariffs. The total cost is equal to the difference between the total reward (`reward`) and expenses (`cost`). ")
    reward: Optional[Union[confloat(ge=0, strict=True), conint(ge=0, strict=True)]] = Field(0, description="The total reward for orders fulfillment.")
    distance: Optional[conint(strict=True, le=4000000000, ge=0)] = Field(0, description="Distance in meters.")
    time_window: Optional[BasicTimeWindow] = None
    orders_count: Optional[conint(strict=True, le=15001, ge=0)] = Field(0, description="The total number of planned and assigned orders.")
    plan_orders_count: Optional[conint(strict=True, le=15001, ge=0)] = Field(0, description="The total number of planned orders.")
    waitlist_orders_count: Optional[conint(strict=True, le=15001, ge=0)] = Field(0, description="The total number of assigned orders.")
    stops_count: Optional[conint(strict=True, le=15001, ge=0)] = Field(0, description="The total number of stops (non-unique locations).")
    locations_count: Optional[conint(strict=True, le=15001, ge=0)] = Field(0, description="The total number of unique locations within one trip.")
    cargo_capacity_ratio_mass: Optional[Union[confloat(le=1000000, ge=0, strict=True), conint(le=1000000, ge=0, strict=True)]] = Field(0, description="The ratio of the total additive measures of the transported cargo to the total capacity of the boxes.")
    cargo_capacity_ratio_volume: Optional[Union[confloat(le=1000000, ge=0, strict=True), conint(le=1000000, ge=0, strict=True)]] = Field(0, description="The ratio of the total additive measures of the transported cargo to the total capacity of the boxes.")
    cargo_capacity_ratio_capacity_a: Optional[Union[confloat(le=1000000, ge=0, strict=True), conint(le=1000000, ge=0, strict=True)]] = Field(0, description="The ratio of the total additive measures of the transported cargo to the total capacity of the boxes.")
    cargo_capacity_ratio_capacity_b: Optional[Union[confloat(le=1000000, ge=0, strict=True), conint(le=1000000, ge=0, strict=True)]] = Field(0, description="The ratio of the total additive measures of the transported cargo to the total capacity of the boxes.")
    cargo_capacity_ratio_capacity_c: Optional[Union[confloat(le=1000000, ge=0, strict=True), conint(le=1000000, ge=0, strict=True)]] = Field(0, description="The ratio of the total additive measures of the transported cargo to the total capacity of the boxes.")
    max_transport_load_mass: Optional[Union[confloat(le=1, ge=0, strict=True), conint(le=1, ge=0, strict=True)]] = Field(0, description="The ratio of the maximum load of boxes to the total capacity of boxes.")
    max_transport_load_volume: Optional[Union[confloat(le=1, ge=0, strict=True), conint(le=1, ge=0, strict=True)]] = Field(0, description="The ratio of the maximum load of boxes to the total capacity of boxes.")
    max_transport_load_capacity_a: Optional[Union[confloat(le=1, ge=0, strict=True), conint(le=1, ge=0, strict=True)]] = Field(0, description="The ratio of the maximum load of boxes to the total capacity of boxes.")
    max_transport_load_capacity_b: Optional[Union[confloat(le=1, ge=0, strict=True), conint(le=1, ge=0, strict=True)]] = Field(0, description="The ratio of the maximum load of boxes to the total capacity of boxes.")
    max_transport_load_capacity_c: Optional[Union[confloat(le=1, ge=0, strict=True), conint(le=1, ge=0, strict=True)]] = Field(0, description="The ratio of the maximum load of boxes to the total capacity of boxes.")
    __properties = ["essence_key", "essence_type", "enabled", "pristine", "trip_name", "attributes", "cost", "reward", "distance", "time_window", "orders_count", "plan_orders_count", "waitlist_orders_count", "stops_count", "locations_count", "cargo_capacity_ratio_mass", "cargo_capacity_ratio_volume", "cargo_capacity_ratio_capacity_a", "cargo_capacity_ratio_capacity_b", "cargo_capacity_ratio_capacity_c", "max_transport_load_mass", "max_transport_load_volume", "max_transport_load_capacity_a", "max_transport_load_capacity_b", "max_transport_load_capacity_c"]
