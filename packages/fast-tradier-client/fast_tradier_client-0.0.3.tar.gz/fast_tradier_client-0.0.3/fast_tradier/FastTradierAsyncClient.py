...
class FastTradierAsyncClient(implements(IBrokerAsyncClient)):
    ...
    def __init__(self, access_token: str, account_id: str, is_prod: bool = True, real_time_quote_provider: IRealTimeQuoteProvider = None, http_client: httpx.AsyncClient = None):
