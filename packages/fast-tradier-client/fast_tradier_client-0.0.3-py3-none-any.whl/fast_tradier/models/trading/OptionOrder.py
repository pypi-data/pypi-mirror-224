...
class OptionLeg(ModelBase):
    def __init__(self, underlying_symbol: str, option_symbol: str, side: str, quantity: int, convert_tos_symbol: bool = True) -> None:
    ...
    def __str__(self) -> str:
        legs = f'symbol:{self.option_symbol} x {self.quantity}({self.side})'
        return legs
    
class OptionOrder(ModelBase):
    def __init__(self, ticker: str, price: float, price_type: str, duration: str, option_legs: List[OptionLeg]):
