...
class FieldDatabaseDataRow:
    '''Provides data for the :class:`FieldDatabase` field result. Please see System.Data.DataRow instance.
    To learn more, visit the `Working with Fields <https://docs.aspose.com/words/net/working-with-fields/>` documentation article.'''
...
class FieldDatabaseDataTable:
    '''Provides data for the :class:`FieldDatabase` field result. Please see System.Data.DataTable instance.
    To learn more, visit the `Working with Fields <https://docs.aspose.com/words/net/working-with-fields/>` documentation article.'''
...
class IBibliographyStylesProvider:
    ...
    def get_style(self, style_file_name: str) -> io.BytesIO:
        ...
        :returns: The System.IO.Stream with bibliography style XSLT stylesheet.
