...
class StructuredDocumentTag(aspose.words.CompositeNode):
    ...
    * Nested inside another :class:`StructuredDocumentTag`.'''
    ...
    def word_open_xml_minimal(self) -> str:
        ...
        Unlike the :attr:`StructuredDocumentTag.word_open_xml` property, this method generates a stripped-down document that excludes any non-content-related parts.'''
        ...
...
class StructuredDocumentTagRangeEnd(aspose.words.Node):
    ...
    @property
    def node_type(self) -> aspose.words.NodeType:
        '''Returns :attr:`aspose.words.NodeType.STRUCTURED_DOCUMENT_TAG_RANGE_END`.'''
        ...
...
class StructuredDocumentTagRangeStart(aspose.words.Node):
    ...
    @property
    def node_type(self) -> aspose.words.NodeType:
        '''Returns :attr:`aspose.words.NodeType.STRUCTURED_DOCUMENT_TAG_RANGE_START`.'''
        ...
