...
<h1 style="text-align: center;">Copernicus Marine Service client (CLI & Python)</h1>
...
username : johndoe
password :
INFO - root - Configuration files stored in /Users/foo/.copernicus-marine-client
```
...
See [Access points migration and evolution](#access-points-migration-and-evolution)
