...
class QualityApi(object):
    ...
    def list_conflicts(
        ...
        **kwargs,
        ...
        Keyword Args:
            ...
            filter (str): A filter term. Available filter_fields: ['id', 'frame', 'type', 'job_id', 'task_id', 'severity']. [optional]
    ...
    def list_reports(
        ...
        **kwargs,
        ...
        Keyword Args:
            x_organization (str): Organization unique slug. [optional]
            filter (str): A filter term. Available filter_fields: ['id', 'job_id', 'created_date', 'gt_last_updated', 'target_last_updated', 'parent_id']. [optional]
            job_id (int): A simple equality filter for the job_id field. [optional]
            org (str): Organization unique slug. [optional]
            org_id (int): Organization identifier. [optional]
            page (int): A page number within the paginated result set.. [optional]
    ...
    def list_settings(
        ...
        **kwargs,
        ...
        Keyword Args:
            x_organization (str): Organization unique slug. [optional]
            filter (str): A filter term. Available filter_fields: ['id', 'task_id']. [optional]
            org (str): Organization unique slug. [optional]
            org_id (int): Organization identifier. [optional]
            page (int): A page number within the paginated result set.. [optional]
            page_size (int): Number of results to return per page.. [optional]
