...
setuptools.setup(
     name='location-profile-local-python-package-local',  
     version='0.0.4', # https://pypi.org/project/location-profile-local-python-package-local/
     author="Circles",
     author_email="info@circles.life",
     description="PyPI Package for Circles location-profile-local-python-package Local Python",  
