...
void check_connector_template_generic(Connector_t& con)
{
	...
	CONTAINER_NEIGHBOURS_INT (Connector_t::*emptyNeighbour)() = &Connector_t::template emptyNeighbour<int>;
	CONTAINER_NEIGHBOURS_fT (Connector_t::*emptyNeighbour)() = &Connector_t::template emptyNeighbour<fT>;
