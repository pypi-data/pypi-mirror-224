...
import prism
from prism._utils.exceptions import PrismNotFoundError, PrismResponseError, PrismValueError
...
def load_taskquery(taskquery: Union[str, int]):
    ...
    component_name = query.pop("component_name")
    component = getattr(prism, component_name)
...
def save_taskquery(component, taskqueryname: str):
    ...
    --------
        ...
        >>> prism.save_taskquery(component=snp_200_screen,taskqueryname="mcap_200")
        {
        'status': 'Success',
...
def rename_taskquery(old: Union[str, int], new: str):
    ...
    --------
        ...
        >>> prism.rename_taskquery(old="screen", name="new_screen")
        {
        'status': 'Success',
...
def delete_taskquery(taskquery: Union[str, int]):
    ...
    --------
        ...
        >>> prism.delete_taskquery("ex_factor")
        Taskquery deleted
        {
        'status': 'Success',
        'message': 'Taskquery deleted',
...
def extract_taskquery(component, return_code=False):
    ...
    --------
        ...
        >>> prism.extract_dataquery(snp_200_screen)
        x0= prism.market.market_cap()
