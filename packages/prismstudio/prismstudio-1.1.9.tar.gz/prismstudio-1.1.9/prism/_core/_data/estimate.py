...
from ..._common.const import (
    AggregationType,
    EstimateDataComponentType as _EstimateDataComponentType,
    PeriodType,
)
from .._req_builder._list import _list_dataitem_estimate
...
def actual(
    ...
    Examples
    --------
        >>> di = prism.estimate.actual_dataitems('revenue')
...
def consensus(
    ...
    Examples
    --------
        >>> di = prism.estimate.consensus_dataitems('eps')
        >>> di[['dataitemid', 'dataitemname']]
            dataitemid                                       dataitemname
...
def growth(
    ...
    Examples
    --------
        >>> di = prism.estimate.growth_dataitems()
        >>> di[['dataitemid', 'dataitemname']]
            dataitemid                                       dataitemname
    ...
    if periodtype in ["LTM"]:
        raise PrismValueError(
            f"Growth cannot take {periodtype} as periodtype.",
            valid_list=PeriodType,
            invalids=["LTM"],
        )
    return _estimate_builder(
...
def guidance(
    ...
    Examples
    --------
        >>> di = prism.estimate.guidance_dataitems('eps')
        >>> di[['dataitemid', 'dataitemname']]
            dataitemid                                       dataitemname
    ...
    if periodtype in ["LTM"]:
        raise PrismValueError(
            f"Guidance cannot take {periodtype} as periodtype.",
            valid_list=PeriodType,
            invalids=["LTM"],
        )
    return _estimate_builder(
...
def revision(
    ...
    Examples
    --------
        >>> di = prism.estimate.revision_dataitems('eps')
        >>> di[['dataitemid', 'dataitemname']]
            dataitemid                                       dataitemname
    ...
    try:
        ...
        raise PrismValueError(f'{e}', valid_list=AggregationType)
    return _estimate_builder(
        _Revision,
        dataitemid=dataitemid,
        periodtype=periodtype,
...
def surprise(
    ...
    """
    if periodtype in ["YTD", "LTM", "NTM", "Non-Periodic"]:
        raise PrismValueError(
            f"Surprise cannot take {periodtype} as periodtype.",
            valid_list=PeriodType,
...
def dataitems(search: str = None, package: str = None):
    ...
    """
    return _list_dataitem_estimate(None, search, package)


@_validate_args
def actual_dataitems(search: str = None, package: str = None):
    """
    ...
    Examples
    --------
        >>> di = prism.estimate.actual_dataitems('net income')
        >>> di[['dataitemid', 'dataitemname']]
           dataitemid                                       dataitemname
        0      200027  Net Income (Excl. Extraordinary Items & Good W...
        1      200028                         Net Income (GAAP) - Actual
        2      200029                     Net Income Normalized - Actual
    """
    return _list_dataitem_estimate(_EstimateDataComponentType.ACTUAL, search, package)


@_validate_args
def consensus_dataitems(search: str = None, package: str = None):
    """
    ...
    Examples
    --------
        >>> di = prism.estimate.consensus_dataitems('net income')
        >>> di[['dataitemid', 'dataitemname']]
            dataitemid                                       dataitemname
    ...
    """
    return _list_dataitem_estimate(_EstimateDataComponentType.CONSENSUS, search, package)


@_validate_args
def growth_dataitems(search: str = None, package: str = None):
    """
    ...
    """
    return _list_dataitem_estimate(_EstimateDataComponentType.GROWTH, search, package)


@_validate_args
def guidance_dataitems(search: str = None, package: str = None):
    """
    ...
    Examples
    --------
        >>> di = prism.estimate.guidance_dataitems('net income')
        >>> di[['dataitemid', 'dataitemname']]
           dataitemid                                       dataitemname
    ...
    """
    return _list_dataitem_estimate(_EstimateDataComponentType.GUIDANCE, search, package)


@_validate_args
def revision_dataitems(search: str = None, package: str = None):
    """
    ...
    Examples
    --------
        >>> di = prism.estimate.revision_dataitems('net income')
        >>> di[['dataitemid', 'dataitemname']]
            dataitemid                                       dataitemname
    ...
    """
    return _list_dataitem_estimate(_EstimateDataComponentType.REVISION, search, package)


@_validate_args
def surprise_dataitems(search: str = None, package: str = None):
    """
    ...
    Examples
    --------
        >>> di = prism.estimate.surprise_dataitems('net income')
        >>> di[['dataitemid', 'dataitemname']]
           dataitemid                                       dataitemname
