...
class accdbtools:
        ...
        try:
            ...
            for row in connection.cursor().tables():
                if row.table_type == "TABLE":
                    ...
                    # export to .csv file
                    self.export_table_to_csv(connection, row.table_name, f"{row.table_name}.csv")
    ...
    def export_table_to_csv(self, connection, table_name, csv_file):
        try:
