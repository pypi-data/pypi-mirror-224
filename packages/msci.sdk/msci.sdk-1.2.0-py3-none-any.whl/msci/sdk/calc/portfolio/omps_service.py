...
class OMPSSession:
    ...
    def __init__(self, client_id=None, client_secret=None):
        ...
        token = get_token(self.omps_token_url, self.client_id, self.client_secret, env_dict["omps_audience"], 'omps')
        self._token = token
    ...
    def upload_portfolio(self, portfolio_id: str, data: json, **kwargs):
        ...
        parameter_str = generate_parameters(**kwargs)
        omps_url = f'{self.omps_base_url}/portfolios/{portfolio_id}{parameter_str}'
        upload_response = requests.post(url=omps_url, headers=self._headers, data=json.dumps(data), verify=self.ssl_verify)
