...
from pih.tools import ParameterList, BitMask as BM, nl, if_else, j
...
class MobileHelperService():
    ...
    def start(self) -> bool:
        ...
        service_desctiption: ServiceDescription | None = A.SRV_A.create_support_service_or_master_service_description(
            A.CT_SR.description(self.service_role))
