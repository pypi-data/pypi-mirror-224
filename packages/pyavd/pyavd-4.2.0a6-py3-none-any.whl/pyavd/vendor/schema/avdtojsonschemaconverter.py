...
from pyavd.vendor.schema.avdtodocumentationschemaconverter import get_deprecation
from pyavd.vendor.schema.key_to_display_name import key_to_display_name
