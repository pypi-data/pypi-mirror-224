        ...
        for l_1_profile in t_2(environment.getattr((undefined(name='mac_security') if l_0_mac_security is missing else l_0_mac_security), 'profiles'), 'name'):
            ...
            for l_2_connection_key in t_2(environment.getattr(l_1_profile, 'connection_keys'), 'id'):
                ...
                if t_3(environment.getattr(l_2_connection_key, 'encrypted_key')):
                    ...
                    if t_3(environment.getattr(l_2_connection_key, 'fallback')):
                        pass
            ...
            if t_3(environment.getattr(l_1_profile, 'sci'), True):
                pass
                yield '      sci\n'
            if t_3(environment.getattr(environment.getattr(l_1_profile, 'l2_protocols'), 'ethernet_flow_control')):
                pass
                ...
                yield '\n'
            if t_3(environment.getattr(environment.getattr(l_1_profile, 'l2_protocols'), 'lldp')):
                pass
...
blocks = {}
debug_info = '2=30&5=33&6=36&8=40&12=44&13=48&14=50&15=53&17=55&18=60&19=62&20=64&21=66&23=69&26=72&27=75&29=77&30=80&32=82&35=85&36=88&38=90&39=93'