...
name = 'documentation/ip-http-client-source-interfaces.j2'
...
def root(context, missing=missing):
    ...
    pass
    if t_3((undefined(name='ip_http_client_source_interfaces') if l_0_ip_http_client_source_interfaces is missing else l_0_ip_http_client_source_interfaces)):
        pass
        ...
        template = environment.get_template('eos/ip-http-client-source-interfaces.j2', 'documentation/ip-http-client-source-interfaces.j2')
