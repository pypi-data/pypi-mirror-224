...
def root(context, missing=missing):
    ...
    pass
    if t_2((undefined(name='daemons') if l_0_daemons is missing else l_0_daemons)):
        pass
        for l_1_daemon in t_1((undefined(name='daemons') if l_0_daemons is missing else l_0_daemons), 'name'):
            _loop_vars = {}
            pass
            yield '!\ndaemon '
...
blocks = {}
debug_info = '2=24&3=26&5=30&6=32&7=35&9=37'