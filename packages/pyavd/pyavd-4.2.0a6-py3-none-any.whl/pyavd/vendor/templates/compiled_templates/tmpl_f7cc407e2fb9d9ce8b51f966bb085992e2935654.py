...
name = 'documentation/ip-ssh-client-source-interfaces.j2'
...
def root(context, missing=missing):
    ...
    if t_4((undefined(name='ip_ssh_client_source_interfaces') if l_0_ip_ssh_client_source_interfaces is missing else l_0_ip_ssh_client_source_interfaces)):
        ...
        template = environment.get_template('eos/ip-ssh-client-source-interfaces.j2', 'documentation/ip-ssh-client-source-interfaces.j2')
        for event in template.root_render_func(template.new_context(context.get_all(), True, {})):
            yield event
        yield '```\n'

blocks = {}
debug_info = '2=36&10=39&11=42&12=45&19=51'