...
def root(context, missing=missing):
    ...
    pass
    if ((((((((((((t_1((undefined(name='local_users') if l_0_local_users is missing else l_0_local_users)) or t_1((undefined(name='roles') if l_0_roles is missing else l_0_roles))) or t_1((undefined(name='enable_password') if l_0_enable_password is missing else l_0_enable_password))) or t_1((undefined(name='management_defaults') if l_0_management_defaults is missing else l_0_management_defaults))) or t_1((undefined(name='tacacs_servers') if l_0_tacacs_servers is missing else l_0_tacacs_servers))) or t_1((undefined(name='ip_tacacs_source_interfaces') if l_0_ip_tacacs_source_interfaces is missing else l_0_ip_tacacs_source_interfaces))) or t_1((undefined(name='radius_server') if l_0_radius_server is missing else l_0_radius_server))) or t_1((undefined(name='radius_servers') if l_0_radius_servers is missing else l_0_radius_servers))) or t_1((undefined(name='ip_radius_source_interfaces') if l_0_ip_radius_source_interfaces is missing else l_0_ip_radius_source_interfaces))) or t_1((undefined(name='aaa_server_groups') if l_0_aaa_server_groups is missing else l_0_aaa_server_groups))) or t_1((undefined(name='aaa_authentication') if l_0_aaa_authentication is missing else l_0_aaa_authentication))) or t_1((undefined(name='aaa_authorization') if l_0_aaa_authorization is missing else l_0_aaa_authorization))) or t_1((undefined(name='aaa_accounting') if l_0_aaa_accounting is missing else l_0_aaa_accounting))):
        pass
        yield '\n## Authentication\n'
...
blocks = {}
debug_info = '1=30&17=33&19=36&21=39&23=42&25=45&27=48&29=51&31=54&33=57&35=60&37=63&39=66'