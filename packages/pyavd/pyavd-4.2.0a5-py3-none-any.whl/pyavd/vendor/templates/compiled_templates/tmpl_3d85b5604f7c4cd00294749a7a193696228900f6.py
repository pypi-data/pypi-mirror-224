...
def root(context, missing=missing):
    ...
    pass
    for l_1_ip_tacacs_source_interface in t_1((undefined(name='ip_tacacs_source_interfaces') if l_0_ip_tacacs_source_interfaces is missing else l_0_ip_tacacs_source_interfaces)):
