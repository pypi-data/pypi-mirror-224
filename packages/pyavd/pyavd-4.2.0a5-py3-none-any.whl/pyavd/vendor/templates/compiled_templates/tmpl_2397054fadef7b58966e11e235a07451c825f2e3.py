...
def root(context, missing=missing):
    ...
    pass
    if (not t_2((undefined(name='generate_default_config') if l_0_generate_default_config is missing else l_0_generate_default_config), False)):
        pass
        yield '!\nhostname '
