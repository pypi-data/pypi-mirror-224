...
from flywheel.models.stable_api_key_output import StableApiKeyOutput  # noqa: F401,E501
...
class CurrentUserOutput(object):
    ...
    swagger_types = {
        ...
        'api_keys': 'list[StableApiKeyOutput]',
        'avatar': 'str',
        'avatars': 'Avatars',
        'disabled': 'bool',
    ...
    def __init__(self, id=None, user_id=None, firstname=None, lastname=None, email=None, auth0sub=None, roles=None, root=False, api_key=None, api_keys=None, avatar=None, avatars=None, disabled=None, preferences=None, created=None, modified=None, multifactor=None, info=None, firstlogin=None, lastlogin=None, visited_projects=None):  # noqa: E501
