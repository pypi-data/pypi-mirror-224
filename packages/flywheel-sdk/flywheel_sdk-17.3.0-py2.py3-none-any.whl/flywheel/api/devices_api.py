...
class DevicesApi(object):
    ...
    def regenerate_key_with_http_info(self, device_id, **kwargs):  # noqa: E501
        ...
        body_params = None
        if 'body' in params:
            if 'BodyRegenerateKeyApiDevicesDeviceIdKeyPost'.startswith('union'):
                body_type = type(params['body'])
                if getattr(body_type, 'positional_to_model', None):
                    body_params = body_type.positional_to_model(params['body'])
                else:
                ...
                body_params = flywheel.models.BodyRegenerateKeyApiDevicesDeviceIdKeyPost.positional_to_model(params['body'])
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
