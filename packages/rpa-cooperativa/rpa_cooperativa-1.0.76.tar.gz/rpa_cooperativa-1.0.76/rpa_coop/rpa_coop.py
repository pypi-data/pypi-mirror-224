...
class Whatsapp:
    ...
    def verificar_opt_in(self, celular:str):   
        ...
        return self.response_whatsap.status_code
...
class Get_errors:
    ...
    def pegar_erro(self, cod_rpa='123', nome_img_erro: str| None = None) -> str:
        '''usar dentro do except do try, captura informações do erro'''
        hoje = datetime.now().strftime('%d_%m_%y')
        try:
            nome_img_erro = f'H:\\rpa\\ERROS_IMAGENS_CAPTURADAS\\erro_rpa_{cod_rpa}__{hoje}.png'
        except:
            pass
