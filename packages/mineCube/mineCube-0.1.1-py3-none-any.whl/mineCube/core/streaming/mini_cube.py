...
class MiniCube:
    def __init__(self,dimensions,date_column, activity_column, case_id_column,time_freq='Y',csms={},cslms={},models={},groups_activities={},cube=None,data=pd.DataFrame(),loaded=False):
        self.data = data
        ...
        self.cube = cube
        if not data.empty and not loaded:
            self.group_data()
