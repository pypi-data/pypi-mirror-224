...
from automateimageclassification.com_in_ineuron_ai_utils.utils import decodeImage
from flask_cors import CORS, cross_origin
from automateimageclassification.predict import dogcat
import json
import webbrowser
...
def train_func():
    if request.method == 'POST':
        try:
            ...
            from automateimageclassification import train_engine
