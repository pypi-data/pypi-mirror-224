...
class PyGridHandler:
    ...
    def __init__(self,
        ...
        self._draw_config: utils.GridDrawArgs = draw_config if draw_config else utils.GridDrawArgs(
    ...
    def _get_grid_overlay(self):
        ...
        hover = (self.mouse_grid_pos(), self._draw_config.hover_color)
        if hover[0] == None:
            hover = None
    ...
    def handle_hover_over(self,
        ...
        new_hover = utils.get_mouse_grid_pos(grid, area_rect, mouse_pos, draw_scale_matrix)
