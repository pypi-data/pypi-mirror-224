...
MIDDLEWARE_PATCH_MODULES = (
    ...
    CommonMiddlewarePatch(
        ...
        interface=AppInterfaceType.ASGI,
    ),
    aiohttp,
    CommonMiddlewarePatch(
        # this covers both WSGI and ASGI cases, since falcon's ASGI app class is a
        # subclass of falcon.App
        "falcon",
        application_class_name="App",
        framework_name="falcon",
        interface=AppInterfaceType.AUTO_DETECT,
    ),
    CommonMiddlewarePatch("quart", interface=AppInterfaceType.ASGI),
)
