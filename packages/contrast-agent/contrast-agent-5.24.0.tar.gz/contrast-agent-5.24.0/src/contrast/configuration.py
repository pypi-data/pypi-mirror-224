...
class Agent(ConfigBuilder):
    ...
    def __init__(self):
        ...
        self.default_options = [
            ...
            ConfigOption(
                name="security_logger.path",
                default_value=DEFAULT_SECURITY_LOG_PATH,
                type_cast=str,
            ),
            ConfigOption(
                name="security_logger.level",
            ...
            ConfigOption(
                name="python.enable_policy_rewrites",
                default_value=True,
                type_cast=utils.str_to_bool,
            ),
            ConfigOption(
                name="python.enable_automatic_middleware",
                default_value=True,
                type_cast=utils.str_to_bool,
            ),
            ConfigOption(
            ...
            ConfigOption(
                name="polling.server_settings_ms", default_value=30_000, type_cast=int
            ),
        ]
...
class Api(ConfigBuilder):
    ...
    def __init__(self):
        ...
        self.default_options = [
            ...
            ConfigOption(
                name="certificate.ignore_cert_errors",
                default_value=False,
                type_cast=bool,
            ),
