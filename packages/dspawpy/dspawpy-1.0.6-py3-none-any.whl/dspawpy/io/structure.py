...
def build_Structures_from_datafile(
    ...
    read(datafile, si=si, ele=ele, ai=ai, fmt=fmt, task=task)
...
def convert(
    ...
    >>> for readable in ['h5', 'json', 'pdb', 'as', 'hzw', 'POSCAR']:
    ...     for writable in ['pdb', 'xyz', 'dump', 'as', 'hzw', 'POSCAR']:
    ...         convert('/data/home/hzw1002/dspawpy_repo/test/supplement/stru.'+readable, outfile='../out/stru.'+writable)
    """
