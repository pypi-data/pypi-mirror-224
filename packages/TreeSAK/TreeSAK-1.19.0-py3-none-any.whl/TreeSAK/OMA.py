...
# very important!!! 
1. The fasta files need to have a ".fa " extension.
2. The fa files should NOT have dot in name, except the one before file extension.
...
python3 /Users/songweizhi/PycharmProjects/TreeSAK/TreeSAK/OMA.py -i d__Archaea_o_rs -x fna -og og_gnm.txt -o oma_wd_demo -f
