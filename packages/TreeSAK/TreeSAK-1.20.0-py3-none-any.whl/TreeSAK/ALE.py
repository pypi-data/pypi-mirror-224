...
def ALE1(args):
    ...
    # file in
    #combined_faa                    = '/Users/songweizhi/Desktop/combined_d__Archaea_o_rs.faa'
    #orthogroups_op_txt              = '/Users/songweizhi/Desktop/OrthologousGroups.txt'
    #og_program                      = 'oma'  # orthofinder or oma
    #min_og_genome_num               = 50     # filter OG groups
    #min_og_phylum_num               = 2      # filter OG groups
    #force_create_op_dir             = True
    #num_threads                     = 10
    #js_num_threads                  = 3
    #genome_taxon_txt                = '/Users/songweizhi/Desktop/genome_taxon.txt'
    #op_dir                          = '/Users/songweizhi/Desktop/ALE1_op_dir'

    # define output file name
    get_gene_tree_cmds_txt          = '%s_get_gene_tree_cmds.txt'   % op_dir
    ...
    for qualified_og in sorted(og_to_process_no_ignored):
        ...
        #get_gene_tree_cmds_txt_handle.write('%s; %s; %s; %s\n' % (mafft_cmd, iqtree_cmd, mv_file_cmd_1, mv_file_cmd_2))
...
def ALE2(args):
    ...
    # file in
    gene_tree_dir           = '/Users/songweizhi/Desktop/ALE1_op_dir/op_qualified_OGs'
    genome_tree_file        = '/Users/songweizhi/Desktop/Marker_set_1_PA_75_C60_PMSF_concatenated.treefile'
    outgroup                = '/Users/songweizhi/Desktop/outgroup_gnm.txt'
    ...
    # file out
    genome_tree_file_rooted = '/Users/songweizhi/Desktop/Marker_set_1_PA_75_C60_PMSF_concatenated_rooted.treefile'
    ale_wd                  = '/Users/songweizhi/Desktop/ALE2_op_dir'

    # After this step, upload the output folder to server and submit the job scripts within it

    ####################################################################################################################

    og_to_process_no_ignored = next(os.walk(gene_tree_dir))[1]
    ...
    print('root the species tree with outgroup')
    ...
    for qualified_og in og_to_process_no_ignored:
        ...
        if os.path.isfile(pwd_gene_tree_ufboot) is False:
            ...
            current_arg_list = [qualified_og, gene_tree_dir, ale_wd, genome_tree_file_rooted, gnm_pco_dict, ale_splitter_py]
    ...
    print(
        'Preparing files for running ALE with %s cores for %s OGs' % (num_threads, len(prepare_ale_ip_worker_arg_lol)))
    pool = mp.Pool(processes=num_threads)
...
def ALE3():
    ...
    hgt_freq_cutoff                 = 0.5                       # filter ALE predicted HGTs
    ...
    # file out
    ale_hgt_plot_dir                = '/Users/songweizhi/Desktop/ALE3_op_dir_ale_hgt_plot_dir_%s_%s_%s' % (donor_node_min_leaf_num, recipient_node_min_leaf_num, hgt_freq_cutoff)
