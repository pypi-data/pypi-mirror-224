...
from junoplatform.io.utils import algo_cfg, plant, module, instance_id, package_id
...
class EntryPoint:
    ...
    def __call__(self, func):
        def thread():
           logging.info(f"running algo with info (plant: {plant}, module: {module}, package_id: {package_id}, instance_id: {instance_id})")
           while True:
