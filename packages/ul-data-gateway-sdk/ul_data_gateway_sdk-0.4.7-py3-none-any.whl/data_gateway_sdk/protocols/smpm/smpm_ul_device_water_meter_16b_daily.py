...
from data_aggregator_sdk.integration_message import IntegrationV0MessageEvent, IntegrationV0MessageData, \
    IntegrationV0MessageConsumption, IntegrationV0MessageCurrentBatteryLevel, IntegrationV0MessageCurrentTemperature, \
    CounterType, ResourceType, IntegrationV0MessageClock, IntegrationV0MessageGeneration
...
# PACKET (128 bits)   smpm_ul_device_water_meter_16b_daily
#
...
# ------------------------------  ---------  ----  ----------  --------------------------------------------------------------------------------------------------------------------------------     # noqa: E501
# packet_type_id.0.VAL            u7            7           3                                                                                                                           0000011     # noqa: E501
...
class SmpmUlDeviceWaterMeter16BDailyData(Packet):
    days_ago: timedelta
    ...
    @classmethod
    def parse(cls, buf: BufRef) -> 'SmpmUlDeviceWaterMeter16BDailyData':
        ...
        result = SmpmUlDeviceWaterMeter16BDailyData(**result__el_tmp3)
        buf.shift(3)
        return result
        ...
        return [
            *messages,
            IntegrationV0MessageData(
                ...
                battery=[IntegrationV0MessageCurrentBatteryLevel(voltage=self.battery_volts)],
                consumption=[
                    IntegrationV0MessageConsumption(
                        counter_type=CounterType.COMMON,
                        resource_type=ResourceType.COMMON,
                ...
                temperature=[IntegrationV0MessageCurrentTemperature(value=self.temperature)],
