...
from data_aggregator_sdk.integration_message import IntegrationV0MessageData, ResourceType, \
    IntegrationV0MessageGeneration, CounterType
...
# PACKET (128 bits)   smpm_ul_device_energy_16b_tariff_generated
#
# RESULT int:        1636017705544601932779225793
# RESULT bin:  MSB   00000000000000000000000000000000000001010100100101001000001110011000011101100000000111100000111100110010010100000000001011000001   LSB                             # noqa: E501
# RESULT hex:  LE    c1 02 50 32 0f 1e 60 87 39 48 49 05 00 00 00 00
#
#
# name                  type       size  value(int)                                                                                                                        data(bits)   # noqa: E501
# --------------------  ---------  ----  ----------  --------------------------------------------------------------------------------------------------------------------------------   # noqa: E501
# packet_type_id.0.VAL  u7            7          65                                                                                                                           1000001   # noqa: E501
...
class SmpmUlDeviceEnergy16BTariffGeneratedData(Packet):
