...
# PACKET (64 bits)   water5_device_weekly_ch2_impulse_v2
#
...
class Water5DeviceWeeklyCh2ImpulseV2Data(Packet):
    value: int
    battery_int: int
    battery_fract: int
    ...
    @classmethod
    def parse(cls, buf: BufRef) -> 'Water5DeviceWeeklyCh2ImpulseV2Data':
        ...
        result = Water5DeviceWeeklyCh2ImpulseV2Data(**result__el_tmp3)
        return result
            ...
            IntegrationV0MessageData(
                ...
                consumption=[
                    IntegrationV0MessageConsumption(
                        ...
                        overloading_value=Decimal(16777215),
                    ),
                ],
            ),
        ]
