...
# PACKET (64 bits)   water5_device_weekly_ch2
#
# RESULT int:        14051230840548075643
# RESULT bin:  MSB   1100001100000000000000000000000010111011111000011010100001111011   LSB
# RESULT hex:  LE    7b a8 e1 bb 00 00 00 c3
#
#
...
class Water5DeviceWeeklyCh2Data(Packet):
    value: float
    battery_int: int
    battery_fract: int
    ...
    @classmethod
    def parse(cls, buf: BufRef) -> 'Water5DeviceWeeklyCh2Data':
        ...
        result = Water5DeviceWeeklyCh2Data(**result__el_tmp1)
        return result
