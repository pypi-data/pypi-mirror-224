...
from data_aggregator_sdk.integration_message import IntegrationV0MessageData, IntegrationV0MessageCurrentBatteryLevel, \
    IntegrationV0MessageConsumption, CounterType, ResourceType, IntegrationV0MessageCurrentTemperature, \
...
#
# RESULT int:        11231986831745975070660804707
# RESULT bin:  MSB   00100100 01001010 11100001 10111010 00110111 00100011 00000110 10110001 11101010 11100100 11000000 01100011   LSB
# RESULT hex:  LE    63 c0 e4 ea b1 06 23 37 ba e1 4a 24
#
...
class SmpmUlDeviceWaterMeter12BDailyData(Packet):
    ...
    def parse(cls, buf: BufRef) -> 'SmpmUlDeviceWaterMeter12BDailyData':
        ...
        result__el_tmp2["reverse_flow_volume"] = round(buf.shift(12) / 100.0, 2)
            ...
            messages.append(IntegrationV0MessageData(
                ...
                consumption=[
                    IntegrationV0MessageConsumption(
                        ...
                        channel=1,
                        value=Decimal(c),
                        overloading_value=Decimal(4294967.295),
                    ),
                ],
            ))
            ...
            IntegrationV0MessageData(
                ...
                consumption=[
                    IntegrationV0MessageConsumption(
                        ...
                        resource_type=ResourceType.COMMON,
                        channel=1,
                        value=Decimal(self.direct_flow_volume),
                        overloading_value=Decimal(4294967.295),
                    ),
                ],
                events=[
                ...
                generation=[
                    IntegrationV0MessageGeneration(
                        counter_type=CounterType.COMMON,
                        resource_type=ResourceType.COMMON,
                        value=Decimal(self.reverse_flow_volume),
                        overloading_value=Decimal(40.95),
                    ),
                ],
                temperature=[
