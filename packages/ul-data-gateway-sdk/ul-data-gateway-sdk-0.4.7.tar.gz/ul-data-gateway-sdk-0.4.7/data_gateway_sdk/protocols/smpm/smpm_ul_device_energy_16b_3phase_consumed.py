...
# PACKET (128 bits)   smpm_ul_device_energy_16b_3phase_consumed
#
# RESULT int:        6653256196879938732392428594653037260
# RESULT bin:  MSB   00000101000000010101111011011011010011000101011101100000000000010000110110010000000000000001111000001111001100000000001011001100   LSB                             # noqa: E501
# RESULT hex:  LE    cc 02 30 0f 1e 00 90 0d 01 60 57 4c db 5e 01 05
#
#
# name                  type       size  value(int)                                                                                                                        data(bits)   # noqa: E501
# --------------------  ---------  ----  ----------  --------------------------------------------------------------------------------------------------------------------------------   # noqa: E501
# packet_type_id.0.VAL  u7            7          76                                                                                                                           1001100   # noqa: E501
...
class SmpmUlDeviceEnergy16B3PhaseConsumedData(Packet):
    ...
    @classmethod
    def parse(cls, buf: BufRef) -> 'SmpmUlDeviceEnergy16B3PhaseConsumedData':
        ...
        result = SmpmUlDeviceEnergy16B3PhaseConsumedData(**result__el_tmp2)
        buf.shift(1)
        return result
    ...
    def to_integration_data(self, received_at: datetime, device_tz: tzinfo, **kwargs: Any) -> List[IntegrationV0MessageData]:
        ...
        if DeviceHack.electricity_phase_packet_consumed_total_enrg_overload_value in hacks:
            ...
            IntegrationV0MessageData(
                ...
                consumption=[
                    IntegrationV0MessageConsumption(
                        ...
                        value=Decimal(self.total),
                        resource_type=resource_type,
                        channel=1,
                        overloading_value=Decimal(total_energy_overload_value),
                    ),
                    IntegrationV0MessageConsumption(
                        counter_type=CounterType.ENERGY_PHASE_A,
                        value=Decimal(self.phase_a),
                        resource_type=resource_type,
                        channel=1,
                        overloading_value=Decimal(33554431.0),
                    ),
                    IntegrationV0MessageConsumption(
                        counter_type=CounterType.ENERGY_PHASE_B,
                        value=Decimal(self.phase_b),
                        resource_type=resource_type,
                        channel=1,
                        overloading_value=Decimal(33554431.0),
                    ),
