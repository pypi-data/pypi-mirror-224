...
from data_aggregator_sdk.integration_message import IntegrationV0MessageData, ResourceType, CounterType, IntegrationV0MessageConsumption, IntegrationV0MessageUptime
            ...
            IntegrationV0MessageData(
                ...
                consumption=[
                    IntegrationV0MessageConsumption(
                        ...
                        value=Decimal(self.value_ch1),
                        resource_type=ResourceType.COMMON,
                        channel=1,
                        overloading_value=Decimal(134217.727),
                    ),
                    IntegrationV0MessageConsumption(
                        counter_type=CounterType.COMMON,
                        value=Decimal(self.value_ch2),
                        resource_type=ResourceType.COMMON,
                        channel=2,
                        overloading_value=Decimal(134217.727),
                    ),
                ...
                uptime=[
                    IntegrationV0MessageUptime(
                        channel_id=1,
                        uptime_s=self.uptime_ch1.total_seconds(),
                    ),
                    IntegrationV0MessageUptime(
                        channel_id=2,
                        uptime_s=self.uptime_ch2.total_seconds(),
                    ),
                    IntegrationV0MessageUptime(
                        channel_id=3,
                        uptime_s=self.uptime_ch3.total_seconds(),
                    ),
                    IntegrationV0MessageUptime(
                        channel_id=4,
                        uptime_s=self.uptime_ch4.total_seconds(),
                    ),
                ],
            ),
        ]
