...
from data_aggregator_sdk.integration_message import IntegrationV0MessageData, IntegrationV0MessageProfile, ProfileGranulation, GRANULATION_TO_SECONDS_DELTA_MAP, ProfileKind
...
PROFILE_H8_AR_TYPE_MAP = {
    SmpmUlDeviceEnergy16bProfile8hARIds.UL_DATA_16B__PROFILE_H8_1_AP: ProfileKind.ENERGY_A_P,
    SmpmUlDeviceEnergy16bProfile8hARIds.UL_DATA_16B__PROFILE_H8_1_AP__PHASE_A: ProfileKind.ENERGY_A_P_A,
    SmpmUlDeviceEnergy16bProfile8hARIds.UL_DATA_16B__PROFILE_H8_1_AP__PHASE_B: ProfileKind.ENERGY_A_P_B,
    SmpmUlDeviceEnergy16bProfile8hARIds.UL_DATA_16B__PROFILE_H8_1_AP__PHASE_C: ProfileKind.ENERGY_A_P_C,
    SmpmUlDeviceEnergy16bProfile8hARIds.UL_DATA_16B__PROFILE_H8_1_AN: ProfileKind.ENERGY_A_N,
    SmpmUlDeviceEnergy16bProfile8hARIds.UL_DATA_16B__PROFILE_H8_1_AN__PHASE_A: ProfileKind.ENERGY_A_N_A,
    SmpmUlDeviceEnergy16bProfile8hARIds.UL_DATA_16B__PROFILE_H8_1_AN__PHASE_B: ProfileKind.ENERGY_A_N_B,
    SmpmUlDeviceEnergy16bProfile8hARIds.UL_DATA_16B__PROFILE_H8_1_AN__PHASE_C: ProfileKind.ENERGY_A_N_C,
    SmpmUlDeviceEnergy16bProfile8hARIds.UL_DATA_16B__PROFILE_H8_1_RP: ProfileKind.ENERGY_R_P,
    SmpmUlDeviceEnergy16bProfile8hARIds.UL_DATA_16B__PROFILE_H8_1_RP__PHASE_A: ProfileKind.ENERGY_R_P_A,
    SmpmUlDeviceEnergy16bProfile8hARIds.UL_DATA_16B__PROFILE_H8_1_RP__PHASE_B: ProfileKind.ENERGY_R_P_B,
    SmpmUlDeviceEnergy16bProfile8hARIds.UL_DATA_16B__PROFILE_H8_1_RP__PHASE_C: ProfileKind.ENERGY_R_P_C,
    SmpmUlDeviceEnergy16bProfile8hARIds.UL_DATA_16B__PROFILE_H8_1_RN: ProfileKind.ENERGY_R_N,
    SmpmUlDeviceEnergy16bProfile8hARIds.UL_DATA_16B__PROFILE_H8_1_RN__PHASE_A: ProfileKind.ENERGY_R_N_A,
    SmpmUlDeviceEnergy16bProfile8hARIds.UL_DATA_16B__PROFILE_H8_1_RN__PHASE_B: ProfileKind.ENERGY_R_N_B,
    SmpmUlDeviceEnergy16bProfile8hARIds.UL_DATA_16B__PROFILE_H8_1_RN__PHASE_C: ProfileKind.ENERGY_R_N_C,
    SmpmUlDeviceEnergy16bProfile8hARIds.UL_DATA_16B__PROFILE_H8_2_AP: ProfileKind.ENERGY_A_P,
    SmpmUlDeviceEnergy16bProfile8hARIds.UL_DATA_16B__PROFILE_H8_2_AP__PHASE_A: ProfileKind.ENERGY_A_P_A,
    SmpmUlDeviceEnergy16bProfile8hARIds.UL_DATA_16B__PROFILE_H8_2_AP__PHASE_B: ProfileKind.ENERGY_A_P_B,
    SmpmUlDeviceEnergy16bProfile8hARIds.UL_DATA_16B__PROFILE_H8_2_AP__PHASE_C: ProfileKind.ENERGY_A_P_C,
    SmpmUlDeviceEnergy16bProfile8hARIds.UL_DATA_16B__PROFILE_H8_2_AN: ProfileKind.ENERGY_A_N,
    SmpmUlDeviceEnergy16bProfile8hARIds.UL_DATA_16B__PROFILE_H8_2_AN__PHASE_A: ProfileKind.ENERGY_A_N_A,
    SmpmUlDeviceEnergy16bProfile8hARIds.UL_DATA_16B__PROFILE_H8_2_AN__PHASE_B: ProfileKind.ENERGY_A_N_B,
    SmpmUlDeviceEnergy16bProfile8hARIds.UL_DATA_16B__PROFILE_H8_2_AN__PHASE_C: ProfileKind.ENERGY_A_N_C,
    SmpmUlDeviceEnergy16bProfile8hARIds.UL_DATA_16B__PROFILE_H8_2_RP: ProfileKind.ENERGY_R_P,
    SmpmUlDeviceEnergy16bProfile8hARIds.UL_DATA_16B__PROFILE_H8_2_RP__PHASE_A: ProfileKind.ENERGY_R_P_A,
    SmpmUlDeviceEnergy16bProfile8hARIds.UL_DATA_16B__PROFILE_H8_2_RP__PHASE_B: ProfileKind.ENERGY_R_P_B,
    SmpmUlDeviceEnergy16bProfile8hARIds.UL_DATA_16B__PROFILE_H8_2_RP__PHASE_C: ProfileKind.ENERGY_R_P_C,
    SmpmUlDeviceEnergy16bProfile8hARIds.UL_DATA_16B__PROFILE_H8_2_RN: ProfileKind.ENERGY_R_N,
    SmpmUlDeviceEnergy16bProfile8hARIds.UL_DATA_16B__PROFILE_H8_2_RN__PHASE_A: ProfileKind.ENERGY_R_N_A,
    SmpmUlDeviceEnergy16bProfile8hARIds.UL_DATA_16B__PROFILE_H8_2_RN__PHASE_B: ProfileKind.ENERGY_R_N_B,
    SmpmUlDeviceEnergy16bProfile8hARIds.UL_DATA_16B__PROFILE_H8_2_RN__PHASE_C: ProfileKind.ENERGY_R_N_C,
    SmpmUlDeviceEnergy16bProfile8hARIds.UL_DATA_16B__PROFILE_H8_3_AP: ProfileKind.ENERGY_A_P,
    SmpmUlDeviceEnergy16bProfile8hARIds.UL_DATA_16B__PROFILE_H8_3_AP__PHASE_A: ProfileKind.ENERGY_A_P_A,
    SmpmUlDeviceEnergy16bProfile8hARIds.UL_DATA_16B__PROFILE_H8_3_AP__PHASE_B: ProfileKind.ENERGY_A_P_B,
    SmpmUlDeviceEnergy16bProfile8hARIds.UL_DATA_16B__PROFILE_H8_3_AP__PHASE_C: ProfileKind.ENERGY_A_P_C,
    SmpmUlDeviceEnergy16bProfile8hARIds.UL_DATA_16B__PROFILE_H8_3_AN: ProfileKind.ENERGY_A_N,
    SmpmUlDeviceEnergy16bProfile8hARIds.UL_DATA_16B__PROFILE_H8_3_AN__PHASE_A: ProfileKind.ENERGY_A_N_A,
    SmpmUlDeviceEnergy16bProfile8hARIds.UL_DATA_16B__PROFILE_H8_3_AN__PHASE_B: ProfileKind.ENERGY_A_N_B,
    SmpmUlDeviceEnergy16bProfile8hARIds.UL_DATA_16B__PROFILE_H8_3_AN__PHASE_C: ProfileKind.ENERGY_A_N_C,
    SmpmUlDeviceEnergy16bProfile8hARIds.UL_DATA_16B__PROFILE_H8_3_RP: ProfileKind.ENERGY_R_P,
    SmpmUlDeviceEnergy16bProfile8hARIds.UL_DATA_16B__PROFILE_H8_3_RP__PHASE_A: ProfileKind.ENERGY_R_P_A,
    SmpmUlDeviceEnergy16bProfile8hARIds.UL_DATA_16B__PROFILE_H8_3_RP__PHASE_B: ProfileKind.ENERGY_R_P_B,
    SmpmUlDeviceEnergy16bProfile8hARIds.UL_DATA_16B__PROFILE_H8_3_RP__PHASE_C: ProfileKind.ENERGY_R_P_C,
    SmpmUlDeviceEnergy16bProfile8hARIds.UL_DATA_16B__PROFILE_H8_3_RN: ProfileKind.ENERGY_R_N,
    SmpmUlDeviceEnergy16bProfile8hARIds.UL_DATA_16B__PROFILE_H8_3_RN__PHASE_A: ProfileKind.ENERGY_R_N_A,
    SmpmUlDeviceEnergy16bProfile8hARIds.UL_DATA_16B__PROFILE_H8_3_RN__PHASE_B: ProfileKind.ENERGY_R_N_B,
    SmpmUlDeviceEnergy16bProfile8hARIds.UL_DATA_16B__PROFILE_H8_3_RN__PHASE_C: ProfileKind.ENERGY_R_N_C,
}
...
class SmpmUlDeviceEnergy16BProfile8HArData(Packet):
    ...
    def to_integration_data(self, received_at: datetime, device_tz: tzinfo, **kwargs: Any) -> List[IntegrationV0MessageData]:
        ...
        precision = 2
        profiles = (
            true_round(self.profile[0] * self.point_factor, precision),
            true_round(self.profile[1] * self.point_factor, precision),
            true_round(self.profile[2] * self.point_factor, precision),
            true_round(self.profile[3] * self.point_factor, precision),
            true_round(self.profile[4] * self.point_factor, precision),
            true_round(self.profile[5] * self.point_factor, precision),
            true_round(self.profile[6] * self.point_factor, precision),
            true_round(self.profile[7] * self.point_factor, precision),
        )
        ...
        return [
            IntegrationV0MessageData(
                dt=round_dt(
                    ...
                    timedelta(
                        seconds=GRANULATION_TO_SECONDS_DELTA_MAP[ProfileGranulation.MINUTE_60],
                    ),
                ),
                profiles=[
