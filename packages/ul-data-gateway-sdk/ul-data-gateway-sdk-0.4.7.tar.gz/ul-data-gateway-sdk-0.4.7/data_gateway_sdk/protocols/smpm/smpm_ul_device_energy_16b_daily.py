...
from data_aggregator_sdk.constants.enums import IntegrationV0MessageEvent, DeviceHack
            ...
            IntegrationV0MessageData(
                ...
                consumption=[
                    IntegrationV0MessageConsumption(
                        value=Decimal(self.energy_consumed_active),
                        counter_type=CounterType.COMMON,
                        resource_type=ResourceType.ENERGY_ACTIVE,
                        channel=1,
                        overloading_value=Decimal(overloading_value),
                    ),
                    IntegrationV0MessageConsumption(
                        value=Decimal(self.energy_consumed_reactive),
                        counter_type=CounterType.COMMON,
                ...
                generation=[
                    IntegrationV0MessageGeneration(
                        value=Decimal(self.energy_generated_active),
                        counter_type=CounterType.COMMON,
                        resource_type=ResourceType.ENERGY_ACTIVE,
                        overloading_value=Decimal(overloading_value),
                    ),
                    IntegrationV0MessageGeneration(
                        value=Decimal(self.energy_generated_reactive),
                        counter_type=CounterType.COMMON,
                        resource_type=ResourceType.ENERGY_REACTIVE,
                        overloading_value=Decimal(overloading_value),
                    ),
