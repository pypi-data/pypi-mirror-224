...
from data_aggregator_sdk.integration_message import IntegrationV0MessageData, IntegrationV0MessageConsumption, \
    IntegrationV0MessageCurrentBatteryLevel, ResourceType, CounterType

from data_gateway_sdk.utils.buf_ref import BufRef
from data_gateway_sdk.utils.packet import Packet


# PACKET (64 bits)   water5_device_weekly_ch1_impulse
#
...
class Water5DeviceWeeklyCh1ImpulseData(Packet):
    value: int
    battery_int: int
    battery_fract: int
    ...
    @classmethod
    def parse(cls, buf: BufRef) -> 'Water5DeviceWeeklyCh1ImpulseData':
        ...
        result = Water5DeviceWeeklyCh1ImpulseData(**result__el_tmp3)
        return result
            ...
            IntegrationV0MessageData(
                ...
                consumption=[
                    IntegrationV0MessageConsumption(
                        ...
                        overloading_value=Decimal(134217727.0),
                    ),
                ],
            ),
        ]
