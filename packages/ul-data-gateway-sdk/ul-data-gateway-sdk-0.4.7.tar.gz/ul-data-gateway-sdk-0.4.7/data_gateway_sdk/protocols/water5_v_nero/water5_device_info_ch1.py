...
# PACKET (64 bits)   water5_device_info_ch1
#
# RESULT int:        4172897
# RESULT bin:  MSB   0000000000000000000000000000000000000000001111111010110001100001   LSB
# RESULT hex:  LE    61 ac 3f 00 00 00 00 00
#
#
# name      type    size  value(int)                                                        data(bits)
# ----------------------------------------------------------------------------------------------------
# pack_id   u8         8          97                                                          01100001
# value     uf32p3    32       16300                          00000000000000000011111110101100
# RESERVED  u24       24           0  000000000000000000000000


class Water5DeviceInfoCh1Data(Packet):
    value: float
    ...
    @classmethod
    def parse(cls, buf: BufRef) -> 'Water5DeviceInfoCh1Data':
        ...
        buf.shift(24)
        result = Water5DeviceInfoCh1Data(**result__el_tmp1)
        return result
