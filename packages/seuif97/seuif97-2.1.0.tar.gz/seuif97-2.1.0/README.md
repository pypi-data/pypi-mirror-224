...
The repository is the Rust language implementation of SEUIF97 with C and Python binding. It is suitable for computation-intensive calculations，such as heat cycle calculations, simulations of non-stationary processes, real-time process monitoring and optimizations.
...
* `seulibif97.so`: [Linux64](./dynamic_lib/linux_x64/)
