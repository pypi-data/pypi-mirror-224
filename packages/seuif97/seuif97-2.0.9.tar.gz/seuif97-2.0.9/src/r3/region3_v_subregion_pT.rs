...
pub fn pT2v_3b(p: f64, T: f64) -> f64 {
    ...
    #[rustfmt::skip]
    let d:para=para { PS: 100.0,  TS: 860.0,  VS: 0.0041,
                      a: 0.280,   b: 0.779,    c: 1.0,    d: 1.0,    e: 1.0, };
    pT2v_sum(p, T, &IJn, d)
}

pub fn pT2v_3c(p: f64, T: f64) -> f64 {
    const IJn: [(i32, i32, f64); 35] = [
...
pub fn pT2v_3h(p: f64, T: f64) -> f64 {
    ...
    #[rustfmt::skip]
    let d:para= para { PS: 25.0,    TS: 660.0,   VS: 0.0032,
...
pub fn pT2v_3n(p: f64, T: f64) -> f64 {
    // the special function,non c,d,e
    const IJn: [(i32, i32, f64); 39] = [
...
pub fn pT2v_3t(p: f64, T: f64) -> f64 {
    ...
    #[rustfmt::skip]
    let d:para=para { PS: 20.0,  TS: 650.0, VS: 0.0088,
                      a: 0.803,  b: 1.02,   c: 1.0,    d: 1.0,     e: 1.0 };
    pT2v_sum(p, T, &IJn, d)
}
...
pub fn pT2v_3y(p: f64, T: f64) -> f64 {
    ...
    #[rustfmt::skip]
    let d: para =para { PS: 22.0,  TS: 650.0,  VS: 0.0031,
