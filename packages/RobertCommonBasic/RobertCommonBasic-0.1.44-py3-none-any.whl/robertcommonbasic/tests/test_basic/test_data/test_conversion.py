...
from robertcommonbasic.basic.data.conversion import convert_bytes_to_values, convert_values_to_bytes, TypeFormat, DataFormat, reverse_bytes, get_bool, set_bool
