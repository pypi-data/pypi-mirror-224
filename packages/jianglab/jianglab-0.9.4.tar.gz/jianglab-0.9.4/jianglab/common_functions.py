...
def get_frame_timestamp(pkl_data, frame_channel_num = 1, exclued_init_frame_num = 4, normalize_to_percentile = 99.9):
...
def check_timing_of_frames(pkl_data):
    """
    ...
    """
    peaks = get_frame_timestamp(pkl_data)
