...
def add_frame_time_to_pkl_data(pkl_data, add_frame_time = True, check_timing = True):
    """
    ...
    """
    peaks = get_frame_timestamp(pkl_data, add_frame_time = add_frame_time)
    if check_timing:
...
def add_burst_mask(pkl_path, burst_detector = burst_detector, post_fix = "_burst", save = True):
    with open(pkl_path, 'rb') as f:
        data = pickle.load(f)
