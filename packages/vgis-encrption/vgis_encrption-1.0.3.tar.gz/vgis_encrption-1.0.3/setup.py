...
setup(
    ...
    name="vgis_encrption",  # Required 项目名称
    version="1.0.3",  # Required 发布版本号
    description="A libary for encrption operator",  # Optional 项目简单描述
    long_description=long_description,  # Optional 详细描述
    long_description_content_type="text/markdown",  # 内容类型
    url="https://github.com/gisfanmachel/vgisEncrption",  # Optional github项目地址
    ...
    keywords="encrption,setuptools,development",  # Optional 搜索关键字

    packages=find_packages(),  # Required

    python_requires=">=3.7, <4",  # python 版本要求

    install_requires=["cryptography", "vgis-utils"],  # Optional 第三方依赖库
