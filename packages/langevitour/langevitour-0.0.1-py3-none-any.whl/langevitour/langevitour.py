...
class LangeviTour:
    ...
    def __init__(
        ...
        group, group_levels = as_factor(group)
    ...
    def to_html(self):
        ...
        <script>
        {js_content}
        let el_{unique_id} = document.getElementById("{unique_id}");
        let tour_{unique_id} = new langevitour.Langevitour(el_{unique_id}, {self.width}, {self.height});
