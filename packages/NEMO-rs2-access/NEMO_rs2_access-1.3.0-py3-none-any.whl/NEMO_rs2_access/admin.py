...
def admin_export_error_logs(modeladmin, request, queryset: QuerySetType[ErrorLog]):
    ...
    table_result.add_header(("data", "Data"))
...
class ErrorLogAdmin(admin.ModelAdmin):
    list_display = ["created", "get_error_type_display", "data", "get_fixed"]
    list_filter = ["error_type"]
    date_hierarchy = "created"
    actions = [admin_export_error_logs]

    @admin.display(description="Fixed?")
    def get_fixed(self, error_log: ErrorLog) -> str:
