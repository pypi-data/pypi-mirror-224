...
cdef class atomic_list(atomic_object):
    ...
    cdef list decode(self, bytes bits_in_bytes)
    cdef tuple encode(self, list input_list)
    cdef tuple shift_and_add(self, size_t data_prefix, char accumulate_length, char input_length, char kind)
