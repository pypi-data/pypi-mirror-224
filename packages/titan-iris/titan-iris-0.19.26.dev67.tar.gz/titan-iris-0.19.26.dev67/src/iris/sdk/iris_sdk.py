...
from .utils.docker_utils import check_docker, pull_fastapi_image, pull_image, get_takeoff_image_name
...
def takeoff(
    ...
    Args:
        ...
        quant (str, optional): The quantization level. Defaults to "int8".
