...
class Querier:
    ...
    def query(self, sql: str) -> pd.DataFrame:
        ...
        Returns:
            pd.DataFrame: 查询结果
        """
        return pd.read_sql_query(text(sql), self.conn)

    def get_table_daily(
        self,
        table_name: str,
        columns: Iterable[str] | str | None = None,
        code: Iterable[str] | None = None,
        start: str | None = None,
        end: str | None = None,
    ) -> pd.DataFrame:
        ...
        df = pd.read_sql_query(query.statement, self.conn)
        session.close()
    ...
    def get_stocks_daily(
        ...
        Args:
            ...
            code (Iterable[str] | None, optional): 股票代码，可以为列表或字符串，如['000001', '000002']或'000001'，默认为None，表示查询所有股票\n
    ...
    def get_indexs_daily(
        self,
        columns: Iterable[str] | str | None = None,
        code: Iterable[str] | str | None = None,
        start: str | None = None,
        end: str | None = None,
    ) -> pd.DataFrame:
        """获取指数历史日度数据
