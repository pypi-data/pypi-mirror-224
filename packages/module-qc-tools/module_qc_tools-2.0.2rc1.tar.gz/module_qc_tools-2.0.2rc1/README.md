...
5. [Measurements](#measurements)
   ...
   8.
   9. [Sensor IV measurement)](#iv-measure)
...
python -m pip install -U pip module-qc-tools==2.0.2rc1
```
...
- `n_points`: how many points should be measured depending on the required voltage steps
...
usage: measurement-IV-MEASURE [-h] [-c CONFIG] [-o OUTPUT_DIR] [-m MODULE_CONNECTIVITY] [--verbosity LEVEL]
