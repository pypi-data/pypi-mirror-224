...
def create_race_before_information_page_url(
    ...
    return f"{BASE_URL}/owpc/pc/race/beforeinfo?{urllib.parse.urlencode({'rno': race_number, 'jcd': format_stadium_tel_code_for_query_string(stadium_tel_code), 'hd': format_date_for_query_string(race_holding_date)})}"
