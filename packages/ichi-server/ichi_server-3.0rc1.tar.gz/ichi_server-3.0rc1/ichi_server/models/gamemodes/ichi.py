...
class ichi(GameRoom):
    ...
    A faithful clone of the UNO® card game with customizable features
    like stacking draw cards and the ability to play with up to 10
    players.
    """
    ...
    async def _before_turn_rotation(self) -> None:
        ...
        if self.turn_state in (TurnState.SKIPPED, TurnState.TIMED_OUT):
            ...
            if (
                ...
                self.current_turn.state = PlayerState.WON
