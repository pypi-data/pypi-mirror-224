...
def _ver_to_cal_info(vinfo):
    ...
    return version.V2CalendarInfo(vinfo.year_y or defaults.year_y, vinfo.
        year_g or defaults.year_g, vinfo.quarter or defaults.quarter, vinfo
        .month or defaults.month, vinfo.dom or defaults.dom, vinfo.doy or
        defaults.doy, vinfo.week_w or defaults.week_w, vinfo.week_u or
        defaults.week_u, vinfo.week_v or defaults.week_v)
...
def parse_field_values_to_vinfo(field_values):
    ...
    return version.V2VersionInfo(year_y=cinfo.year_y, year_g=cinfo.year_g,
        ...
        pytag, githash=githash, num=num, inc0=inc0, inc1=inc1)
