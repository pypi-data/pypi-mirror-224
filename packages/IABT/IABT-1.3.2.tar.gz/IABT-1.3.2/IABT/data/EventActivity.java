...
public class {{%name%}} extends Activity {
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        if (this.pa.callAttr("onKeyDown", keyCode, event).toBoolean()) {
            return true;
        }
    ...
    public boolean onKeyLongPress(int keyCode, KeyEvent event) {
        if (this.pa.callAttr("onKeyLongPress", keyCode, event).toBoolean()) {
            return true;
        }
    ...
    public boolean onKeyShortcut(int keyCode, KeyEvent event) {
        if (this.pa.callAttr("onKeyShortcut", keyCode, event).toBoolean()) {
            return true;
        }
    ...
    public boolean onKeyUp(int keyCode, KeyEvent event) {
        if (this.pa.callAttr("onKeyUp", keyCode, event).toBoolean()) {
            return true;
        }
    ...
    public boolean onTouchEvent(MotionEvent event) {
        if (this.pa.callAttr("onTouchEvent", event).toBoolean()) {
            return true;
        }
    ...
    public boolean onTrackballEvent(MotionEvent event) {
        if (this.pa.callAttr("onTrackballEvent", event).toBoolean()) {
            return true;
        }
