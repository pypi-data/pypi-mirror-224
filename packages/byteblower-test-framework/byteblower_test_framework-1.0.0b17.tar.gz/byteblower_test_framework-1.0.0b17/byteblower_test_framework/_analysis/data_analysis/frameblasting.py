...
class FrameCountAnalyser(DataAnalyser):
    ...
    def analyse(self) -> None:
        ...
        df_tx = self._data.df_tx
        df_rx = self._data.df_rx
...
class MosAnalyser(DataAnalyser):
    ...
    def analyse(self) -> None:
        df_tx = self._data_framecount.df_tx
        df_rx = self._data_framecount.df_rx
