class persistController:
    ...
    def createMG(self, name, hostname, **kwargs):
        """
        ...
        all_api_parameters = {'name': {'name': 'name', 'required': True, 'in': 'query'}, 'hostname': {'name': 'hostname', 'required': True, 'in': 'query'}, 'dbPortNumber': {'name': 'dbPortNumber', 'required': False, 'in': 'query'}, 'dbUsername': {'name': 'dbUsername', 'required': False, 'in': 'query'}, 'dbPassword': {'name': 'dbPassword', 'required': False, 'in': 'query'}, 'playbookName': {'name': 'playbookName', 'required': False, 'in': 'query'}, 'enabled': {'name': 'enabled', 'required': False, 'in': 'query'}}
        parameters_names_map = {}
