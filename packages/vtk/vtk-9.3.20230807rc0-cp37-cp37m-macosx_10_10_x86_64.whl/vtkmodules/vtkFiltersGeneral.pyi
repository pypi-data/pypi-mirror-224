...
class vtkAnimateModes(vtkmodules.vtkCommonExecutionModel.vtkPassInputTypeAlgorithm):
    ...
    def GetModeShapesRange(self) -> (int, int): ...
    def GetNumberOfGenerationsFromBase(self, type:str) -> int: ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type:str) -> int: ...
    def GetTimeRange(self) -> (float, float): ...
...
class vtkBoxClipDataSet(vtkmodules.vtkCommonExecutionModel.vtkUnstructuredGridAlgorithm):
    def CellGrid(self, typeobj:int, npts:int, cellIds:(int, ...), newCellArray:vtkCellArray) -> None: ...
    ...
    def CreateTetra(self, npts:int, cellIds:(int, ...), newCellArray:vtkCellArray) -> None: ...
    ...
    @staticmethod
    def IsTypeOf(type:str) -> int: ...
    def MinEdgeF(self, id_v:(int, ...), cellIds:(int, ...), edgF:[int, ...]) -> None: ...
    def NewInstance(self) -> vtkBoxClipDataSet: ...
    def PyramidToTetra(self, pyramId:(int, ...), cellIds:(int, ...), newCellArray:vtkCellArray) -> None: ...
    @staticmethod
    ...
    @overload
    def SetBoxClip(self, n0:(float, ...), o0:(float, ...), n1:(float, ...) , o1:(float, ...), n2:(float, ...), o2:(float, ...), n3:(float, ...), o3:(float, ...), n4:(float, ...), o4:(float, ...) , n5:(float, ...), o5:(float, ...)) -> None: ...
    ...
    def WedgeToTetra(self, wedgeId:(int, ...), cellIds:(int, ...), newCellArray:vtkCellArray) -> None: ...
...
class vtkClipClosedSurface(vtkmodules.vtkCommonExecutionModel.vtkPolyDataAlgorithm):
    ...
    def GetActivePlaneColor(self) -> (float, float, float): ...
    def GetActivePlaneId(self) -> int: ...
    def GetBaseColor(self) -> (float, float, float): ...
    def GetClipColor(self) -> (float, float, float): ...
...
class vtkCoincidentPoints(vtkmodules.vtkCommonCore.vtkObject):
    def AddPoint(self, Id:int, point:(float, float, float)) -> None: ...
    def Clear(self) -> None: ...
    def GetCoincidentPointIds(self, point:(float, float, float)) -> vtkIdList: ...
...
class vtkContourTriangulator(vtkmodules.vtkCommonExecutionModel.vtkPolyDataAlgorithm):
    ...
    def SetTriangulationErrorDisplay(self, _arg:int) -> None: ...
    @staticmethod
    def TriangulateContours(data:vtkPolyData, firstLine:int, numLines:int, outputPolys:vtkCellArray, normal:(float, float, float), self_:vtkPolyDataAlgorithm=...) -> int: ...
    @staticmethod
...
class vtkCursor2D(vtkmodules.vtkCommonExecutionModel.vtkPolyDataAlgorithm):
    ...
    def GetModelBounds(self) -> (float, float, float, float, float, float): ...
    def GetNumberOfGenerationsFromBase(self, type:str) -> int: ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type:str) -> int: ...
    ...
    @overload
    def SetFocalPoint(self, x:[float, float, float]) -> None: ...
    @overload
    ...
    @overload
    def SetModelBounds(self, bounds:(float, float, float, float, float, float)) -> None: ...
...
class vtkDeflectNormals(vtkmodules.vtkCommonExecutionModel.vtkDataSetAlgorithm):
    ...
    def GetUserNormal(self) -> (float, float, float): ...
    def IsA(self, type:str) -> int: ...
    @staticmethod
    def IsTypeOf(type:str) -> int: ...
    ...
    @overload
    def SetUserNormal(self, _arg:(float, float, float)) -> None: ...
...
class vtkDiscreteFlyingEdges2D(vtkmodules.vtkCommonExecutionModel.vtkPolyDataAlgorithm):
    ...
    @overload
    def GenerateValues(self, numContours:int, range:[float, float]) -> None: ...
    @overload
    ...
    @overload
    def GetValues(self, contourValues:[float, ...]) -> None: ...
    def IsA(self, type:str) -> int: ...
    @staticmethod
    def IsTypeOf(type:str) -> int: ...
...
class vtkExtractSelectedFrustum(vtkExtractSelectionBase):
    def CreateFrustum(self, vertices:[float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float]) -> None: ...
    ...
    def OverallBoundsTest(self, bounds:[float, ...]) -> int: ...
    @staticmethod
...
class vtkGraphLayoutFilter(vtkmodules.vtkCommonExecutionModel.vtkPolyDataAlgorithm):
    ...
    def GetGraphBounds(self) -> (float, float, float, float, float, float): ...
    ...
    @overload
    def SetGraphBounds(self, _arg:(float, float, float, float, float, float)) -> None: ...
...
class vtkHyperStreamline(vtkmodules.vtkCommonExecutionModel.vtkPolyDataAlgorithm):
    ...
    def GetRadiusMaxValue(self) -> float: ...
    def GetRadiusMinValue(self) -> float: ...
    def GetStartLocation(self, subId:int, pcoords:[float, float, float]) -> int: ...
    def GetStartPosition(self) -> (float, float, float): ...
    ...
    def SetRadius(self, _arg:float) -> None: ...
    @overload
    def SetStartLocation(self, cellId:int, subId:int, pcoords:[float, float, float]) -> None: ...
    @overload
    def SetStartLocation(self, cellId:int, subId:int, r:float, s:float, t:float) -> None: ...
    @overload
    def SetStartPosition(self, x:[float, float, float]) -> None: ...
    @overload
...
class vtkIconGlyphFilter(vtkmodules.vtkCommonExecutionModel.vtkPolyDataAlgorithm):
    ...
    def GetIconSheetSize(self) -> (int, int): ...
    def GetIconSize(self) -> (int, int): ...
    def GetNumberOfGenerationsFromBase(self, type:str) -> int: ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type:str) -> int: ...
    def GetOffset(self) -> (int, int): ...
    ...
    @overload
    def SetDisplaySize(self, _arg:(int, int)) -> None: ...
    ...
    @overload
    def SetIconSheetSize(self, _arg:(int, int)) -> None: ...
    @overload
    def SetIconSize(self, _arg1:int, _arg2:int) -> None: ...
    @overload
    def SetIconSize(self, _arg:(int, int)) -> None: ...
    @overload
    def SetOffset(self, _arg1:int, _arg2:int) -> None: ...
    @overload
    def SetOffset(self, _arg:(int, int)) -> None: ...
...
class vtkIntersectionPolyDataFilter(vtkmodules.vtkCommonExecutionModel.vtkPolyDataAlgorithm):
    ...
    @staticmethod
    def CleanAndCheckSurface(pd:vtkPolyData, stats:[float, float], tolerance:float) -> None: ...
    ...
    @staticmethod
    def TriangleTriangleIntersection(p1:[float, float, float], q1:[float, float, float], r1:[float, float, float], p2:[float, float, float], q2:[float, float, float], r2:[float, float, float], coplanar:int, pt1:[float, float, float], pt2:[float, float, float], surfaceid:[float, float], tolerance:float) -> int: ...
...
class vtkMultiThreshold(vtkmodules.vtkCommonExecutionModel.vtkMultiBlockDataSetAlgorithm):
    ...
    def AddBooleanSet(self, operation:int, numInputs:int, inputs:[int, ...]) -> int: ...
...
class vtkOBBNode(object):
    ...
    def DebugPrintTree(self, level:int, leaf_vol:[float, ...], minCells:[int, ...], maxCells:[int, ...]) -> None: ...

class vtkOBBTree(vtkmodules.vtkCommonDataModel.vtkAbstractCellLocator):
    def BuildLocator(self) -> None: ...
    @overload
    @staticmethod
    def ComputeOBB(pts:vtkPoints, corner:[float, float, float], max:[float, float, float], mid:[float, float, float], min:[float, float, float], size:[float, float, float]) -> None: ...
    @overload
    def ComputeOBB(self, input:vtkDataSet, corner:[float, float, float], max:[float, float, float], mid:[float, float, float], min:[float, float, float], size:[float, float, float]) -> None: ...
    ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type:str) -> int: ...
    def InsideOrOutside(self, point:(float, float, float)) -> int: ...
    @overload
    def IntersectWithLine(self, a0:(float, float, float), a1:(float, float, float), tol:float, t:float, x:[float, float, float], pcoords:[float, float, float], subId:int, cellId:int, cell:vtkGenericCell) -> int: ...
    @overload
    def IntersectWithLine(self, a0:(float, float, float), a1:(float, float, float), points:vtkPoints, cellIds:vtkIdList) -> int: ...
    @overload
    def IntersectWithLine(self, p1:(float, float, float), p2:(float, float, float), tol:float, t:float, x:[float, float, float], pcoords:[float, float, float], subId:int) -> int: ...
    @overload
    def IntersectWithLine(self, p1:(float, float, float), p2:(float, float, float), tol:float, t:float, x:[float, float, float], pcoords:[float, float, float], subId:int, cellId:int) -> int: ...
    @overload
    def IntersectWithLine(self, p1:(float, float, float), p2:(float, float, float), tol:float, points:vtkPoints, cellIds:vtkIdList) -> int: ...
    @overload
    def IntersectWithLine(self, p1:(float, float, float), p2:(float, float, float), tol:float, points:vtkPoints, cellIds:vtkIdList, cell:vtkGenericCell) -> int: ...
    def IsA(self, type:str) -> int: ...
    @staticmethod
    def IsTypeOf(type:str) -> int: ...
...
class vtkQuantizePolyDataPoints(vtkmodules.vtkFiltersCore.vtkCleanPolyData):
    ...
    def OperateOnBounds(self, in_:[float, float, float, float, float, float], out:[float, float, float, float, float, float]) -> None: ...
    def OperateOnPoint(self, in_:[float, float, float], out:[float, float, float]) -> None: ...
    @staticmethod
...
class vtkRectilinearGridClip(vtkmodules.vtkCommonExecutionModel.vtkRectilinearGridAlgorithm):
    ...
    def GetNumberOfGenerationsFromBaseType(type:str) -> int: ...
    @overload
    def GetOutputWholeExtent(self, extent:[int, int, int, int, int, int]) -> None: ...
    @overload
    ...
    @overload
    def SetOutputWholeExtent(self, extent:[int, int, int, int, int, int], outInfo:vtkInformation=...) -> None: ...
    @overload
...
class vtkRectilinearGridToTetrahedra(vtkmodules.vtkCommonExecutionModel.vtkUnstructuredGridAlgorithm):
    ...
    @overload
    def SetInput(self, Extent:(float, float, float), Spacing:(float, float, float), tol:float=0.001) -> None: ...
    @overload
...
class vtkTableToStructuredGrid(vtkmodules.vtkCommonExecutionModel.vtkStructuredGridAlgorithm):
    ...
    @overload
    def SetWholeExtent(self, _arg:(int, int, int, int, int, int)) -> None: ...
    def SetXColumn(self, _arg:str) -> None: ...
    def SetXComponent(self, _arg:int) -> None: ...
    def SetYColumn(self, _arg:str) -> None: ...
    def SetYComponent(self, _arg:int) -> None: ...
...
class vtkTemporalPathLineFilter(vtkmodules.vtkCommonExecutionModel.vtkPolyDataAlgorithm):
    ...
    def GetMaxStepDistance(self) -> (float, float, float): ...
    ...
    @overload
    def SetMaxStepDistance(self, _arg:(float, float, float)) -> None: ...
...
class vtkVoxelContoursToSurfaceFilter(vtkmodules.vtkCommonExecutionModel.vtkPolyDataAlgorithm):
    ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type:str) -> int: ...
    def GetSpacing(self) -> (float, float, float): ...
    def IsA(self, type:str) -> int: ...
    @staticmethod
    def IsTypeOf(type:str) -> int: ...
    ...
    @overload
    def SetSpacing(self, _arg:(float, float, float)) -> None: ...
...
class vtkWarpLens(vtkmodules.vtkCommonExecutionModel.vtkPointSetAlgorithm):
    ...
    def GetPrincipalPoint(self) -> (float, float): ...
    def IsA(self, type:str) -> int: ...
    @staticmethod
    def IsTypeOf(type:str) -> int: ...
    ...
    @overload
    def SetPrincipalPoint(self, _arg:(float, float)) -> None: ...
...
class vtkYoungsMaterialInterface(vtkmodules.vtkCommonExecutionModel.vtkMultiBlockDataSetAlgorithm):
    ...
    def GetVolumeFractionRange(self) -> (float, float): ...
    ...
    @overload
    def SetVolumeFractionRange(self, _arg:(float, float)) -> None: ...
