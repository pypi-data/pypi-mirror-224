...
class vtkWordCloud(vtkmodules.vtkCommonExecutionModel.vtkImageAlgorithm):
    ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type:str) -> int: ...
    def GetOrientations(self) -> (float, ...): ...
    def GetSkippedWords(self) -> (str, ...): ...
    def GetStopListFileName(self) -> str: ...
    def GetStoppedWords(self) -> (str, ...): ...
    ...
    def SetOrientations(self, arg:[float, ...]) -> None: ...
