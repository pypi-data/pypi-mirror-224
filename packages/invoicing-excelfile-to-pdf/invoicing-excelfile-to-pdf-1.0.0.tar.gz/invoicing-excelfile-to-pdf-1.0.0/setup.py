...
setup(
  name = 'invoicing-excelfile-to-pdf',         #* Your package will have this name
  ...
  author = 'Himanshu Vasani',                   # Your name
  author_email = 'himanshuvasani32@gmail.com',  # Your email
  url = 'https://example.com',              # Homepage of your library (e.g. github or your website)
  keywords = ['invoice', 'excel', 'pdf', 'file'],   # Keywords users can search on pypi.org
