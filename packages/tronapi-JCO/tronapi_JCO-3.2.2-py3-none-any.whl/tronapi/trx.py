...
class Trx(Module):
    ...
    def get_delegated_resource(
        ...
        Args:
            ...
            visible (bool): Whether the address is in base58 format

        """

        if from_address is None:
            from_address = self.tron.default_address.hex
        ...
        response =  self.tron.manager.request(
            ...
            {
                "fromAddress": self.tron.address.to_hex(from_address),
                "toAddress": self.tron.address.to_hex(to_address),
                "visible": visible,
            },
        )
    ...
    def get_delegated_resource_account_index(
        self, address=None, visible=True
    ):
        """
        ...
        response =  self.tron.manager.request(
            ...
            {
                "value": self.tron.address.to_hex(address),
                "visible": visible,
            },
        )
