...
class BuyNowOffersApi(object):
    ...
    @validate_arguments
    def get_buy_now_offers(self, delivery_day : date, timescale : AuctionTimescale, direction : BorderDirection, statuses : conlist(BuyNowOfferStatus), sort_by : BuyNowDayAheadOfferSortBy, product_type : Annotated[Optional[AuctionIntraDayProductType], Field(description="Only for ID timescale")] = None, **kwargs) -> List[BuyNowOffer]:  # noqa: E501
        ...
        >>> thread = api.get_buy_now_offers(delivery_day, timescale, direction, statuses, sort_by, product_type, async_req=True)
        >>> result = thread.get()
        ...
        :param product_type: Only for ID timescale
        ...
        return self.get_buy_now_offers_with_http_info(delivery_day, timescale, direction, statuses, sort_by, product_type, **kwargs)  # noqa: E501

    @validate_arguments
    def get_buy_now_offers_with_http_info(self, delivery_day : date, timescale : AuctionTimescale, direction : BorderDirection, statuses : conlist(BuyNowOfferStatus), sort_by : BuyNowDayAheadOfferSortBy, product_type : Annotated[Optional[AuctionIntraDayProductType], Field(description="Only for ID timescale")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """get_buy_now_offers  # noqa: E501
        ...
        >>> thread = api.get_buy_now_offers_with_http_info(delivery_day, timescale, direction, statuses, sort_by, product_type, async_req=True)
        >>> result = thread.get()
    ...
    @validate_arguments
    def purchase_buy_now_offer(self, id : StrictStr, **kwargs) -> None:  # noqa: E501
    ...
    @validate_arguments
    def purchase_buy_now_offer_with_http_info(self, id : StrictStr, **kwargs) -> ApiResponse:  # noqa: E501
        """purchase_buy_now_offer  # noqa: E501
