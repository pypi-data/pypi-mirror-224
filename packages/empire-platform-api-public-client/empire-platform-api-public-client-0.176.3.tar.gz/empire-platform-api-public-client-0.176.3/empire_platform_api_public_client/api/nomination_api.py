...
class NominationApi(object):
    ...
    @validate_arguments
    def get_aggregated_nominations(self, delivery_day : date, type : AggregatedNominationType, timescale_types : Optional[conlist(TimescaleNominationType)] = None, participant_ids : Optional[conlist(StrictStr)] = None, **kwargs) -> AggregatedNominations:  # noqa: E501
        ...
        >>> thread = api.get_aggregated_nominations(delivery_day, type, timescale_types, participant_ids, async_req=True)
        >>> result = thread.get()
        ...
        return self.get_aggregated_nominations_with_http_info(delivery_day, type, timescale_types, participant_ids, **kwargs)  # noqa: E501

    @validate_arguments
    def get_aggregated_nominations_with_http_info(self, delivery_day : date, type : AggregatedNominationType, timescale_types : Optional[conlist(TimescaleNominationType)] = None, participant_ids : Optional[conlist(StrictStr)] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """get_aggregated_nominations  # noqa: E501
        ...
        >>> thread = api.get_aggregated_nominations_with_http_info(delivery_day, type, timescale_types, participant_ids, async_req=True)
        >>> result = thread.get()
    ...
    @validate_arguments
    def get_timescale_nomination_options(self, delivery_day : date, type : TimescaleNominationType, participant_id : StrictStr, **kwargs) -> TimescaleNominationOptions:  # noqa: E501
        ...
        >>> thread = api.get_timescale_nomination_options(delivery_day, type, participant_id, async_req=True)
        >>> result = thread.get()
        ...
        return self.get_timescale_nomination_options_with_http_info(delivery_day, type, participant_id, **kwargs)  # noqa: E501

    @validate_arguments
    def get_timescale_nomination_options_with_http_info(self, delivery_day : date, type : TimescaleNominationType, participant_id : StrictStr, **kwargs) -> ApiResponse:  # noqa: E501
        """get_timescale_nomination_options  # noqa: E501
        ...
        >>> thread = api.get_timescale_nomination_options_with_http_info(delivery_day, type, participant_id, async_req=True)
        >>> result = thread.get()
    ...
    @validate_arguments
    def get_timescale_nominations(self, delivery_day : date, type : TimescaleNominationType, participant_id : StrictStr, border_direction : BorderDirection, **kwargs) -> TimescaleNominations:  # noqa: E501
        ...
        >>> thread = api.get_timescale_nominations(delivery_day, type, participant_id, border_direction, async_req=True)
        >>> result = thread.get()
        ...
        return self.get_timescale_nominations_with_http_info(delivery_day, type, participant_id, border_direction, **kwargs)  # noqa: E501

    @validate_arguments
    def get_timescale_nominations_with_http_info(self, delivery_day : date, type : TimescaleNominationType, participant_id : StrictStr, border_direction : BorderDirection, **kwargs) -> ApiResponse:  # noqa: E501
        """get_timescale_nominations  # noqa: E501
        ...
        >>> thread = api.get_timescale_nominations_with_http_info(delivery_day, type, participant_id, border_direction, async_req=True)
        >>> result = thread.get()
    ...
    @validate_arguments
    def submit_timescale_nominations(self, delivery_day : date, type : TimescaleNominationType, participant_id : StrictStr, border_direction : BorderDirection, submit_timescale_nominations_request : SubmitTimescaleNominationsRequest, **kwargs) -> None:  # noqa: E501
        ...
        >>> thread = api.submit_timescale_nominations(delivery_day, type, participant_id, border_direction, submit_timescale_nominations_request, async_req=True)
        >>> result = thread.get()
        ...
        return self.submit_timescale_nominations_with_http_info(delivery_day, type, participant_id, border_direction, submit_timescale_nominations_request, **kwargs)  # noqa: E501

    @validate_arguments
    def submit_timescale_nominations_with_http_info(self, delivery_day : date, type : TimescaleNominationType, participant_id : StrictStr, border_direction : BorderDirection, submit_timescale_nominations_request : SubmitTimescaleNominationsRequest, **kwargs) -> ApiResponse:  # noqa: E501
        """submit_timescale_nominations  # noqa: E501
        ...
        >>> thread = api.submit_timescale_nominations_with_http_info(delivery_day, type, participant_id, border_direction, submit_timescale_nominations_request, async_req=True)
        >>> result = thread.get()
