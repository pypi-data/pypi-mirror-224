...
class ReportingApi(object):
    ...
    @validate_arguments
    def get_trs_and_nominations_overview_report(self, mtu_size : MtuSize, type : AggregatedNominationType, border_direction : BorderDirectionWithBoth, delivery_period_start : date, delivery_period_end : date, x_participant_ids : Annotated[Optional[conlist(StrictStr)], Field(description="List of internal IDs of Participant-type Organisations (optional)")] = None, **kwargs) -> bytearray:  # noqa: E501
    ...
    @validate_arguments
    def get_trs_and_nominations_overview_report_with_http_info(self, mtu_size : MtuSize, type : AggregatedNominationType, border_direction : BorderDirectionWithBoth, delivery_period_start : date, delivery_period_end : date, x_participant_ids : Annotated[Optional[conlist(StrictStr)], Field(description="List of internal IDs of Participant-type Organisations (optional)")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """get_trs_and_nominations_overview_report  # noqa: E501
