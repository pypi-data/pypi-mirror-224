...
class FinanceApi(object):
    ...
    @validate_arguments
    def get_finance_settlement_per_day(self, period_from : date, period_to : date, auction_product_types : conlist(AuctionProductType), sources : conlist(SettlementSourceType), x_participant_id : Annotated[Optional[StrictStr], Field(description="Internal ID of a Participant-type Organisation (optional)")] = None, direction : Optional[BorderDirection] = None, timescale : Optional[AuctionTimescale] = None, **kwargs) -> List[Settlement]:  # noqa: E501
        ...
        >>> thread = api.get_finance_settlement_per_day(period_from, period_to, auction_product_types, sources, x_participant_id, direction, timescale, async_req=True)
        >>> result = thread.get()
        ...
        return self.get_finance_settlement_per_day_with_http_info(period_from, period_to, auction_product_types, sources, x_participant_id, direction, timescale, **kwargs)  # noqa: E501
    ...
    def get_finance_settlement_per_day_with_http_info(self, period_from : date, period_to : date, auction_product_types : conlist(AuctionProductType), sources : conlist(SettlementSourceType), x_participant_id : Annotated[Optional[StrictStr], Field(description="Internal ID of a Participant-type Organisation (optional)")] = None, direction : Optional[BorderDirection] = None, timescale : Optional[AuctionTimescale] = None, **kwargs) -> ApiResponse:  # noqa: E501
        ...
        >>> thread = api.get_finance_settlement_per_day_with_http_info(period_from, period_to, auction_product_types, sources, x_participant_id, direction, timescale, async_req=True)
        >>> result = thread.get()
    ...
    def get_finance_settlement_per_source(self, period_from : date, period_to : date, auction_product_types : conlist(AuctionProductType), sources : conlist(SettlementSourceType), x_participant_id : Annotated[Optional[StrictStr], Field(description="Internal ID of a Participant-type Organisation (optional)")] = None, direction : Optional[BorderDirection] = None, timescale : Optional[AuctionTimescale] = None, **kwargs) -> List[SettlementPerSource]:  # noqa: E501
        ...
        >>> thread = api.get_finance_settlement_per_source(period_from, period_to, auction_product_types, sources, x_participant_id, direction, timescale, async_req=True)
        >>> result = thread.get()
        ...
        return self.get_finance_settlement_per_source_with_http_info(period_from, period_to, auction_product_types, sources, x_participant_id, direction, timescale, **kwargs)  # noqa: E501
    ...
    def get_finance_settlement_per_source_with_http_info(self, period_from : date, period_to : date, auction_product_types : conlist(AuctionProductType), sources : conlist(SettlementSourceType), x_participant_id : Annotated[Optional[StrictStr], Field(description="Internal ID of a Participant-type Organisation (optional)")] = None, direction : Optional[BorderDirection] = None, timescale : Optional[AuctionTimescale] = None, **kwargs) -> ApiResponse:  # noqa: E501
        ...
        >>> thread = api.get_finance_settlement_per_source_with_http_info(period_from, period_to, auction_product_types, sources, x_participant_id, direction, timescale, async_req=True)
        >>> result = thread.get()
    ...
    @validate_arguments
    def get_finance_uiosi_overview(self, delivery_day : date, direction : BorderDirection, timescale : AuctionTimescale, x_participant_id : Annotated[Optional[StrictStr], Field(description="Internal ID of a Participant-type Organisation (optional)")] = None, **kwargs) -> UiosiOverview:  # noqa: E501
        ...
        >>> thread = api.get_finance_uiosi_overview(delivery_day, direction, timescale, x_participant_id, async_req=True)
        >>> result = thread.get()
        ...
        return self.get_finance_uiosi_overview_with_http_info(delivery_day, direction, timescale, x_participant_id, **kwargs)  # noqa: E501

    @validate_arguments
    def get_finance_uiosi_overview_with_http_info(self, delivery_day : date, direction : BorderDirection, timescale : AuctionTimescale, x_participant_id : Annotated[Optional[StrictStr], Field(description="Internal ID of a Participant-type Organisation (optional)")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """get_finance_uiosi_overview  # noqa: E501
        ...
        >>> thread = api.get_finance_uiosi_overview_with_http_info(delivery_day, direction, timescale, x_participant_id, async_req=True)
        >>> result = thread.get()
