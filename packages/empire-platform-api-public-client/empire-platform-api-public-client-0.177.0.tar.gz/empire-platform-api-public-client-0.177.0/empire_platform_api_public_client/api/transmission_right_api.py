...
class TransmissionRightApi(object):
    ...
    @validate_arguments
    def get_transmission_rights_overview(self, delivery_day : date, x_participant_ids : Annotated[conlist(StrictStr), Field(..., description="List of internal IDs of Participant-type Organisations")], border_direction : BorderDirectionWithBoth, timescales : conlist(AuctionTimescale), mtu_size : MtuSize, **kwargs) -> TransmissionRightsOverview:  # noqa: E501
    ...
    @validate_arguments
    def get_transmission_rights_overview_with_http_info(self, delivery_day : date, x_participant_ids : Annotated[conlist(StrictStr), Field(..., description="List of internal IDs of Participant-type Organisations")], border_direction : BorderDirectionWithBoth, timescales : conlist(AuctionTimescale), mtu_size : MtuSize, **kwargs) -> ApiResponse:  # noqa: E501
        """get_transmission_rights_overview  # noqa: E501
