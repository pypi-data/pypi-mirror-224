...
class DayAheadOrIntraDayAuctionBidGroupBidsInnerValue(BaseModel):
    """
    DayAheadOrIntraDayAuctionBidGroupBidsInnerValue
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DayAheadOrIntraDayAuctionBidGroupBidsInnerValue:
        """Create an instance of DayAheadOrIntraDayAuctionBidGroupBidsInnerValue from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DayAheadOrIntraDayAuctionBidGroupBidsInnerValue:
        """Create an instance of DayAheadOrIntraDayAuctionBidGroupBidsInnerValue from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DayAheadOrIntraDayAuctionBidGroupBidsInnerValue.parse_obj(obj)

        _obj = DayAheadOrIntraDayAuctionBidGroupBidsInnerValue.parse_obj({
