...
"""
    ...
    The version of the OpenAPI document: 0.178.3
...
class AuctionApi(object):
    ...
    @validate_arguments
    def get_day_ahead_or_intra_day_auction_bids(self, id : Annotated[StrictStr, Field(..., description="Internal unique ID of an entity")], limit : Annotated[conint(strict=True, le=100, ge=1), Field(..., description="Number of records to return on a page")], offset : Annotated[conint(strict=True, ge=0), Field(..., description="Offset in the list of records to return")], x_participant_id : Annotated[Optional[StrictStr], Field(description="Internal ID of a Participant-type Organisation (optional)")] = None, **kwargs) -> DayAheadOrIntraDayAuctionBidGroupBatch:  # noqa: E501
    ...
    @validate_arguments
    def get_long_term_auction_bids(self, id : Annotated[StrictStr, Field(..., description="Internal unique ID of an entity")], limit : Annotated[conint(strict=True, le=100, ge=1), Field(..., description="Number of records to return on a page")], offset : Annotated[conint(strict=True, ge=0), Field(..., description="Offset in the list of records to return")], sort_by : Annotated[LongTermAuctionBidSortBy, Field(..., description="Sort list by given attribute and direction")], x_participant_id : Annotated[Optional[StrictStr], Field(description="Internal ID of a Participant-type Organisation (optional)")] = None, **kwargs) -> LongTermAuctionBidBatch:  # noqa: E501
    ...
    @validate_arguments
    def get_long_term_auction_bids_with_http_info(self, id : Annotated[StrictStr, Field(..., description="Internal unique ID of an entity")], limit : Annotated[conint(strict=True, le=100, ge=1), Field(..., description="Number of records to return on a page")], offset : Annotated[conint(strict=True, ge=0), Field(..., description="Offset in the list of records to return")], sort_by : Annotated[LongTermAuctionBidSortBy, Field(..., description="Sort list by given attribute and direction")], x_participant_id : Annotated[Optional[StrictStr], Field(description="Internal ID of a Participant-type Organisation (optional)")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """get_long_term_auction_bids  # noqa: E501
    ...
    @validate_arguments
    def submit_day_ahead_or_intra_day_bids(self, id : Annotated[StrictStr, Field(..., description="Internal unique ID of an entity")], submit_day_ahead_or_intra_day_bids_request : SubmitDayAheadOrIntraDayBidsRequest, **kwargs) -> None:  # noqa: E501
    ...
    @validate_arguments
    def submit_day_ahead_or_intra_day_bids_with_http_info(self, id : Annotated[StrictStr, Field(..., description="Internal unique ID of an entity")], submit_day_ahead_or_intra_day_bids_request : SubmitDayAheadOrIntraDayBidsRequest, **kwargs) -> ApiResponse:  # noqa: E501
        """submit_day_ahead_or_intra_day_bids  # noqa: E501
    ...
    @validate_arguments
    def submit_long_term_bids(self, id : Annotated[StrictStr, Field(..., description="Internal unique ID of an entity")], submit_long_term_bids_request : SubmitLongTermBidsRequest, **kwargs) -> None:  # noqa: E501
    ...
    @validate_arguments
    def submit_long_term_bids_with_http_info(self, id : Annotated[StrictStr, Field(..., description="Internal unique ID of an entity")], submit_long_term_bids_request : SubmitLongTermBidsRequest, **kwargs) -> ApiResponse:  # noqa: E501
        """submit_long_term_bids  # noqa: E501
