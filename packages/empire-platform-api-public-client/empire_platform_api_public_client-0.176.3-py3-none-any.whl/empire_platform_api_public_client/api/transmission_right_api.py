...
class TransmissionRightApi(object):
    ...
    @validate_arguments
    def get_transmission_rights_overview(self, delivery_day : date, participant_ids : conlist(StrictStr), border_direction : BorderDirectionWithBoth, timescales : conlist(AuctionTimescale), mtu_size : MtuSize, **kwargs) -> TransmissionRightsOverview:  # noqa: E501
        ...
        >>> thread = api.get_transmission_rights_overview(delivery_day, participant_ids, border_direction, timescales, mtu_size, async_req=True)
        >>> result = thread.get()
        ...
        return self.get_transmission_rights_overview_with_http_info(delivery_day, participant_ids, border_direction, timescales, mtu_size, **kwargs)  # noqa: E501

    @validate_arguments
    def get_transmission_rights_overview_with_http_info(self, delivery_day : date, participant_ids : conlist(StrictStr), border_direction : BorderDirectionWithBoth, timescales : conlist(AuctionTimescale), mtu_size : MtuSize, **kwargs) -> ApiResponse:  # noqa: E501
        """get_transmission_rights_overview  # noqa: E501
        ...
        >>> thread = api.get_transmission_rights_overview_with_http_info(delivery_day, participant_ids, border_direction, timescales, mtu_size, async_req=True)
        >>> result = thread.get()
