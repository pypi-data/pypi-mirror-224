...
class ParticipantDashboardApi(object):
    ...
    @validate_arguments
    def get_participant_dashboard_netted_nominations(self, delivery_day : date, timescales : conlist(AuctionTimescale), **kwargs) -> ParticipantDashboardNettedNominationsData:  # noqa: E501
    ...
    @validate_arguments
    def get_participant_dashboard_netted_nominations_with_http_info(self, delivery_day : date, timescales : conlist(AuctionTimescale), **kwargs) -> ApiResponse:  # noqa: E501
        """get_participant_dashboard_netted_nominations  # noqa: E501
    ...
    @validate_arguments
    def get_participant_dashboard_transmission_rights_and_nominations(self, delivery_day : date, timescales : conlist(AuctionTimescale), **kwargs) -> ParticipantDashboardTransmissionRightsAndNominationsData:  # noqa: E501
    ...
    @validate_arguments
    def get_participant_dashboard_transmission_rights_and_nominations_with_http_info(self, delivery_day : date, timescales : conlist(AuctionTimescale), **kwargs) -> ApiResponse:  # noqa: E501
        """get_participant_dashboard_transmission_rights_and_nominations  # noqa: E501
    ...
    @validate_arguments
    def get_participant_dashboard_transmission_rights_and_nominations_graph(self, delivery_day_from : date, delivery_day_to : date, timescales : conlist(AuctionTimescale), **kwargs) -> ParticipantDashboardTransmissionRightsAndNominationsGraphData:  # noqa: E501
    ...
    @validate_arguments
    def get_participant_dashboard_transmission_rights_and_nominations_graph_with_http_info(self, delivery_day_from : date, delivery_day_to : date, timescales : conlist(AuctionTimescale), **kwargs) -> ApiResponse:  # noqa: E501
        """get_participant_dashboard_transmission_rights_and_nominations_graph  # noqa: E501
