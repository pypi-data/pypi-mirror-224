...
class AuditLogApi(object):
    ...
    @validate_arguments
    def get_audit_log_payload(self, id : StrictStr, **kwargs) -> AuditLogPayload:  # noqa: E501
    ...
    @validate_arguments
    def get_audit_log_payload_with_http_info(self, id : StrictStr, **kwargs) -> ApiResponse:  # noqa: E501
        """get_audit_log_payload  # noqa: E501
    ...
    def get_audit_logs(self, limit : Annotated[conint(strict=True, le=100, ge=1), Field(..., description="Number of records to return on a page")], offset : Annotated[conint(strict=True, ge=0), Field(..., description="Offset in the list of records to return")], sort_by : AuditLogSortBy, domains : Optional[conlist(AuditLogDomain)] = None, organisation_id : Optional[StrictStr] = None, created_at_from : Optional[datetime] = None, created_at_to : Optional[datetime] = None, query : Optional[StrictStr] = None, **kwargs) -> AuditLogBatch:  # noqa: E501
        ...
        >>> thread = api.get_audit_logs(limit, offset, sort_by, domains, organisation_id, created_at_from, created_at_to, query, async_req=True)
        >>> result = thread.get()
        ...
        return self.get_audit_logs_with_http_info(limit, offset, sort_by, domains, organisation_id, created_at_from, created_at_to, query, **kwargs)  # noqa: E501
    ...
    def get_audit_logs_with_http_info(self, limit : Annotated[conint(strict=True, le=100, ge=1), Field(..., description="Number of records to return on a page")], offset : Annotated[conint(strict=True, ge=0), Field(..., description="Offset in the list of records to return")], sort_by : AuditLogSortBy, domains : Optional[conlist(AuditLogDomain)] = None, organisation_id : Optional[StrictStr] = None, created_at_from : Optional[datetime] = None, created_at_to : Optional[datetime] = None, query : Optional[StrictStr] = None, **kwargs) -> ApiResponse:  # noqa: E501
        ...
        >>> thread = api.get_audit_logs_with_http_info(limit, offset, sort_by, domains, organisation_id, created_at_from, created_at_to, query, async_req=True)
        >>> result = thread.get()
