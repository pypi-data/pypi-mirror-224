...
class FinanceApi(object):
    ...
    @validate_arguments
    def get_finance_invoice(self, id : StrictStr, **kwargs) -> InvoiceDetails:  # noqa: E501
    ...
    @validate_arguments
    def get_finance_invoice_with_http_info(self, id : StrictStr, **kwargs) -> ApiResponse:  # noqa: E501
        """get_finance_invoice  # noqa: E501
    ...
    def get_finance_invoices(self, limit : Annotated[conint(strict=True, le=100, ge=1), Field(..., description="Number of records to return on a page")], offset : Annotated[conint(strict=True, ge=0), Field(..., description="Offset in the list of records to return")], period_from : date, period_to : date, statuses : conlist(InvoiceStatus), participant_id : Optional[StrictStr] = None, **kwargs) -> InvoiceBatch:  # noqa: E501
        ...
        >>> thread = api.get_finance_invoices(limit, offset, period_from, period_to, statuses, participant_id, async_req=True)
        >>> result = thread.get()
        ...
        return self.get_finance_invoices_with_http_info(limit, offset, period_from, period_to, statuses, participant_id, **kwargs)  # noqa: E501
    ...
    def get_finance_invoices_with_http_info(self, limit : Annotated[conint(strict=True, le=100, ge=1), Field(..., description="Number of records to return on a page")], offset : Annotated[conint(strict=True, ge=0), Field(..., description="Offset in the list of records to return")], period_from : date, period_to : date, statuses : conlist(InvoiceStatus), participant_id : Optional[StrictStr] = None, **kwargs) -> ApiResponse:  # noqa: E501
        ...
        >>> thread = api.get_finance_invoices_with_http_info(limit, offset, period_from, period_to, statuses, participant_id, async_req=True)
        >>> result = thread.get()
    ...
    @validate_arguments
    def get_finance_settlement_per_day(self, period_from : date, period_to : date, auction_product_types : conlist(AuctionProductType), sources : conlist(SettlementSourceType), participant_id : Optional[StrictStr] = None, direction : Optional[BorderDirection] = None, timescale : Optional[AuctionTimescale] = None, **kwargs) -> List[Settlement]:  # noqa: E501
        ...
        >>> thread = api.get_finance_settlement_per_day(period_from, period_to, auction_product_types, sources, participant_id, direction, timescale, async_req=True)
        >>> result = thread.get()
        ...
        return self.get_finance_settlement_per_day_with_http_info(period_from, period_to, auction_product_types, sources, participant_id, direction, timescale, **kwargs)  # noqa: E501
    ...
    def get_finance_settlement_per_day_with_http_info(self, period_from : date, period_to : date, auction_product_types : conlist(AuctionProductType), sources : conlist(SettlementSourceType), participant_id : Optional[StrictStr] = None, direction : Optional[BorderDirection] = None, timescale : Optional[AuctionTimescale] = None, **kwargs) -> ApiResponse:  # noqa: E501
        ...
        >>> thread = api.get_finance_settlement_per_day_with_http_info(period_from, period_to, auction_product_types, sources, participant_id, direction, timescale, async_req=True)
        >>> result = thread.get()
    ...
    def get_finance_settlement_per_source(self, period_from : date, period_to : date, auction_product_types : conlist(AuctionProductType), sources : conlist(SettlementSourceType), participant_id : Optional[StrictStr] = None, direction : Optional[BorderDirection] = None, timescale : Optional[AuctionTimescale] = None, **kwargs) -> List[SettlementPerSource]:  # noqa: E501
        ...
        >>> thread = api.get_finance_settlement_per_source(period_from, period_to, auction_product_types, sources, participant_id, direction, timescale, async_req=True)
        >>> result = thread.get()
        ...
        return self.get_finance_settlement_per_source_with_http_info(period_from, period_to, auction_product_types, sources, participant_id, direction, timescale, **kwargs)  # noqa: E501
    ...
    def get_finance_settlement_per_source_with_http_info(self, period_from : date, period_to : date, auction_product_types : conlist(AuctionProductType), sources : conlist(SettlementSourceType), participant_id : Optional[StrictStr] = None, direction : Optional[BorderDirection] = None, timescale : Optional[AuctionTimescale] = None, **kwargs) -> ApiResponse:  # noqa: E501
        ...
        >>> thread = api.get_finance_settlement_per_source_with_http_info(period_from, period_to, auction_product_types, sources, participant_id, direction, timescale, async_req=True)
        >>> result = thread.get()
    ...
    @validate_arguments
    def get_finance_uiosi_overview(self, delivery_day : date, direction : BorderDirection, timescale : AuctionTimescale, participant_id : Optional[StrictStr] = None, **kwargs) -> UiosiOverview:  # noqa: E501
        ...
        >>> thread = api.get_finance_uiosi_overview(delivery_day, direction, timescale, participant_id, async_req=True)
        >>> result = thread.get()
        ...
        return self.get_finance_uiosi_overview_with_http_info(delivery_day, direction, timescale, participant_id, **kwargs)  # noqa: E501

    @validate_arguments
    def get_finance_uiosi_overview_with_http_info(self, delivery_day : date, direction : BorderDirection, timescale : AuctionTimescale, participant_id : Optional[StrictStr] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """get_finance_uiosi_overview  # noqa: E501
        ...
        >>> thread = api.get_finance_uiosi_overview_with_http_info(delivery_day, direction, timescale, participant_id, async_req=True)
        >>> result = thread.get()
