...
class NominationApi(object):
    ...
    @validate_arguments
    def get_timescale_nominations(self, delivery_day : date, type : TimescaleNominationType, x_participant_id : Annotated[StrictStr, Field(..., description="Internal ID of a Participant-type Organisation")], border_direction : BorderDirection, **kwargs) -> TimescaleNominations:  # noqa: E501
    ...
    @validate_arguments
    def get_timescale_nominations_with_http_info(self, delivery_day : date, type : TimescaleNominationType, x_participant_id : Annotated[StrictStr, Field(..., description="Internal ID of a Participant-type Organisation")], border_direction : BorderDirection, **kwargs) -> ApiResponse:  # noqa: E501
        """get_timescale_nominations  # noqa: E501
