...
class AuctionApi(object):
    ...
    @validate_arguments
    def get_day_ahead_or_intra_day_auction_bids(self, id : StrictStr, limit : Annotated[conint(strict=True, le=100, ge=1), Field(..., description="Number of records to return on a page")], offset : Annotated[conint(strict=True, ge=0), Field(..., description="Offset in the list of records to return")], x_participant_id : Annotated[Optional[StrictStr], Field(description="Internal ID of a Participant-type Organisation (optional)")] = None, **kwargs) -> DayAheadOrIntraDayAuctionBidGroupBatch:  # noqa: E501
        ...
        >>> thread = api.get_day_ahead_or_intra_day_auction_bids(id, limit, offset, x_participant_id, async_req=True)
        >>> result = thread.get()
        ...
        return self.get_day_ahead_or_intra_day_auction_bids_with_http_info(id, limit, offset, x_participant_id, **kwargs)  # noqa: E501

    @validate_arguments
    def get_day_ahead_or_intra_day_auction_bids_with_http_info(self, id : StrictStr, limit : Annotated[conint(strict=True, le=100, ge=1), Field(..., description="Number of records to return on a page")], offset : Annotated[conint(strict=True, ge=0), Field(..., description="Offset in the list of records to return")], x_participant_id : Annotated[Optional[StrictStr], Field(description="Internal ID of a Participant-type Organisation (optional)")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """get_day_ahead_or_intra_day_auction_bids  # noqa: E501
        ...
        >>> thread = api.get_day_ahead_or_intra_day_auction_bids_with_http_info(id, limit, offset, x_participant_id, async_req=True)
        >>> result = thread.get()
    ...
    def get_long_term_auction_bids(self, id : StrictStr, limit : Annotated[conint(strict=True, le=100, ge=1), Field(..., description="Number of records to return on a page")], offset : Annotated[conint(strict=True, ge=0), Field(..., description="Offset in the list of records to return")], sort_by : Annotated[LongTermAuctionBidSortBy, Field(..., description="Sort list by given attribute and direction")], x_participant_id : Annotated[Optional[StrictStr], Field(description="Internal ID of a Participant-type Organisation (optional)")] = None, **kwargs) -> LongTermAuctionBidBatch:  # noqa: E501
        ...
        >>> thread = api.get_long_term_auction_bids(id, limit, offset, sort_by, x_participant_id, async_req=True)
        >>> result = thread.get()
        ...
        return self.get_long_term_auction_bids_with_http_info(id, limit, offset, sort_by, x_participant_id, **kwargs)  # noqa: E501
    ...
    def get_long_term_auction_bids_with_http_info(self, id : StrictStr, limit : Annotated[conint(strict=True, le=100, ge=1), Field(..., description="Number of records to return on a page")], offset : Annotated[conint(strict=True, ge=0), Field(..., description="Offset in the list of records to return")], sort_by : Annotated[LongTermAuctionBidSortBy, Field(..., description="Sort list by given attribute and direction")], x_participant_id : Annotated[Optional[StrictStr], Field(description="Internal ID of a Participant-type Organisation (optional)")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        ...
        >>> thread = api.get_long_term_auction_bids_with_http_info(id, limit, offset, sort_by, x_participant_id, async_req=True)
        >>> result = thread.get()
