...
#
	...
	#
	def recording_v2(self,writer= None,v6=None,fn = None):
	...
	def readFile_v2(self,fileName):
		...
		self.v6simo = df[df['type'] == 'v6'].drop(['i9'], axis=1).rename(columns={'i0': 'X', 'i1': 'Y', 'i2': 'Z', 'i3': 'range', 'i4': 'elv', 'i5': 'azi','i6': 'dop', 'i7': 'snr','i8':'fn'})
