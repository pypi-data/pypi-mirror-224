...
setup(
    ...
    packages=["mlpath",
              "mlpath.mlquest",
              "mlpath.mldir_cli",
              "mlpath.mldir_cli.web",
              "mlpath.mldir_cli.web.static",
              "mlpath.mldir_cli.web.static.css",
              "mlpath.mldir_cli.web.static.js",
              "mlpath.mldir_cli.web.templates",
              "mlpath.mldir_cli.simple-project"
              ],
    include_package_data=True,
    package_data={"mlpath.mldir_cli.web.*" :['*.zip', '*.png', '*pdf', '*jpeg','*ipynb', '*html', '*css', '*pkl', '*js']},
