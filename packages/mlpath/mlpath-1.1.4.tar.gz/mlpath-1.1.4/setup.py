...
setup(
    ...
    packages=["mlpath", "mlpath.mlquest", "mlpath.mldir_cli", "mlpath.mldir_cli.web", "mlpath.mldir_cli.web.static" ],
    #include_package_data=True,
    #package_data={"mlpath.mldir_cli.web.static" :['*.zip', '*.png', '*pdf', '*jpeg','*ipynb', '*html', '*css', '*pkl', '*js']},
