...
def multiple_choice(
    korr_antw: list[str], falsche_antw: list[str], frage: str = "", erklaerung: str = "") -> None:
    ...
    :param str erklaerung: Erklärung, die bei falscher Antwort angezeigt wird (default: keine Erklärung)
    """
    ...
    def on_button_clicked(b):
        ...
        if korrekt == anz_antworten:
            ...
            eval.value = "<p style='color: red'>{}/{} Antworten korrekt</p><p>{}</p>".format(
                korrekt, anz_antworten, erklaerung
            )

    btn.on_click(on_button_clicked)


def quizfrage(korr_antw: list[str], frage: str = "", gross_klein_egal: bool = False, erklaerung: str =""):
    ...
    :param str erklaerung: Wird bei falscher Antwort angezeigt (default: keine Erklärung)
    """
    ...
    def on_button_clicked(korr_antw, b):
        ...
        if nutzer_eingabe in korr_antw and rueckmeldung.value != "Eingabe korrekt":
            ...
            rueckmeldung.value = "<p>Eingabe nicht korrekt</p><p>{}</p>".format(erklaerung)
            display(
                HTML(
                    """
                <style>
