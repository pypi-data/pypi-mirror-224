...
def tipp(tipp_text: str, vorschautext: str = "Tipp anzeigen:"):
    """Einbettung eines optionalen Tipps ins Notebook
    :param str tipp_text: Tipp, der beim Klick angezeigt werden soll
    :param str vorschautext: Text, der direkt im Notebook angezeigt wird und angeklickt werden kann, um den Tipp anzuzeigen (default: Tipp anzeigen)
    """
