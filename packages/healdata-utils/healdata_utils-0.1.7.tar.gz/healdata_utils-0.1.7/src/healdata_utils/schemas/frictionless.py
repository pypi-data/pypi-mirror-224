healcsvschema = { 'description': 'Variable level metadata individual fields integrated into '
                 'the variable level\n'
  ...
  'fields': [ { 'name': 'module',
                'description': 'The section, form, survey instrument, set of '
                               ...
                               'to group variables.\n',
                'title': 'Module',
                'examples': [ 'Demographics', 'PROMIS', 'Substance use',
                              'Medical History', 'Sleep questions',
                              'Physical activity'],
                'type': 'string'},
              { 'name': 'name',
              ...
              { 'name': 'type',
                ...
                'title': 'Variable Type',
                'type': 'string',
                'constraints': { 'enum': [ 'integer', 'geopoint', 'string',
                                           'yearmonth', 'number', 'date',
                                           'boolean', 'any', 'year', 'duration',
                                           'time', 'datetime']}},
              { 'name': 'format',
              ...
              { 'name': 'encodings',
                'description': 'Variable value encodings provide a way to '
                               ...
                               '\n'
                               '[Optional,if applicable]\n',
                'title': 'Variable Value Encodings (i.e., mappings; value '
                         'labels)',
                'examples': [ '0=No|1=Yes',
              ...
              { 'name': 'trueValues',
                'description': 'For boolean (true) variable (as defined in '
                               ...
                               '\n'
                               '[Optional, if applicable]\n',
                'examples': [ 'Required|REQUIRED', 'required|Yes|Y|Checked',
                              'Checked', 'Required'],
                'type': 'string',
                'constraints': { 'pattern': '^(?:[^|]+\\||[^|]*)(?:[^|]*\\|)*[^|]*$'}},
              { 'name': 'falseValues',
              ...
              { 'name': 'univarStats.categoricalMarginals.name',
                'type': 'string'},
              { 'name': 'univarStats.categoricalMarginals.count',
                'type': 'integer'}],
  'missingValues': ['']}