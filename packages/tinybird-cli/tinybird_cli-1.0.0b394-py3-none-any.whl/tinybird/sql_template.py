...
def date_diff_in_hours(d0: Union[Placeholder, str], d1: Union[Placeholder, str], date_format: str = '%Y-%m-%d %H:%M:%S', default=None):
    """
...
def date_diff_in_minutes(d0: Union[Placeholder, str], d1: Union[Placeholder, str], date_format: str = '%Y-%m-%d %H:%M:%S', default=None):
    """
...
def date_diff_in_seconds(d0: Union[Placeholder, str], d1: Union[Placeholder, str], date_format: str = '%Y-%m-%d %H:%M:%S', default=None):
    """
...
def render_sql_template(sql: str, variables: Optional[dict] = None, test_mode: bool = False, name: Optional[str] = None) -> Tuple[str, dict]:
    """
