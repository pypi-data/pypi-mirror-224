...
class TechStack():
    ...
    logLevel: DEPRECATED
        Set environment variables 'LOGLEVEL' and 'LOGLEVEL_SERVER' instead.
    usePorts: bool = False
    ...
    def __init__(
        ...
        try:
            ...
            logger.add(sys.stdout, format=logger_format, level=loglevelLocal, catch=True, diagnose=logger_diagnose, backtrace=logger_backtrace, filter=stdout_log_filter)
        ...
        if logToServer:
            ...
            LogUtils._init_logging(logEndpoint, token, loglevelServer, sessionId)
        ...
        self.Authorization = Authorization(self.accessToken, authzEndpoint, self)
    ...
    def items(
        ...
        with logger.contextualize(correlation_id=correlationId):
            ...
            while True:
                ...
                _result = Utils._executeGraphQL(self, graphQLString, correlationId)     
