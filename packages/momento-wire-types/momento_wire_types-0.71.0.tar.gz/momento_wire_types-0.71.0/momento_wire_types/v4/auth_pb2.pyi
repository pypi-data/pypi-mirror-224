...
class _GenerateApiTokenRequest(_message.Message):
    ...
    class PermissionsType(_message.Message):
        ...
        class CachePermissions(_message.Message):
            __slots__ = ["all_caches", "cache_selector", "role"]
            ...
            def __init__(self, role: _Optional[_Union[_GenerateApiTokenRequest.CacheRole, str]] = ..., all_caches: _Optional[_Union[_GenerateApiTokenRequest.PermissionsType.All, _Mapping]] = ..., cache_selector: _Optional[_Union[_GenerateApiTokenRequest.PermissionsType.CacheSelector, _Mapping]] = ...) -> None: ...
