...
class ScsControlStub(object):
    ...
    def __init__(self, channel):
        ...
        self.CreateIndex = channel.unary_unary(
                ...
                response_deserializer=controlclient__pb2._CreateIndexRequest.FromString,
                )
...
def add_ScsControlServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'CreateIndex': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=controlclient__pb2._CreateIndexRequest.SerializeToString,
            ),
...
class ScsControl(object):
    ...
    def CreateIndex(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/control_client.ScsControl/CreateIndex',
            ...
            controlclient__pb2._CreateIndexRequest.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
