...
def get_investment_data(
    ...
    Args:
        ...
        time_series_format (:obj:`TimeSeriesFormat`, `optional`):Default is Wide. Enumeration of TimeSeriesFormat, which can be 'Wide', 'Long', 'LongWithoutName'. E.g., "md.direct.TimeSeriesFormat.Long"
    ...
    Get investment data for the given investments and data points with TimeSeriesFormat.long.
    ::
        ...
        df = md.direct.get_investment_data(
            ...
            time_series_format=TimeSeriesFormat.Long
        )
        df
    ...
    result = _get_investment_data(investments=investments, data_points=data_points, display_name=display_name,
                                  time_series_format=time_series_format, dry_run=dry_run)
    return result


def _get_investment_data(investments: InvestmentType, data_points: DataPointsType, time_series_format: TimeSeriesFormat,
                         display_name: bool = False, dry_run: Optional[bool] = False) -> Union[
