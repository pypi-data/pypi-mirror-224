...
from qualys_etl.etld_policy_compliance import policy_compliance_02_workflow_manager


def main():
    etld_lib_config.set_path_qetl_user_home_dir()
    etld_lib_spawn_etl.log_dir = etld_lib_config.qetl_user_log_dir
    etld_lib_spawn_etl.log_file_path = etld_lib_config.policy_compliance_log_file
    etld_lib_spawn_etl.log_file_rotate_path = etld_lib_config.policy_compliance_log_rotate_file
    etld_lib_spawn_etl.lock_file = etld_lib_config.policy_compliance_lock_file
    ...
    etld_lib_spawn_etl.target_module_to_run = policy_compliance_02_workflow_manager.policy_compliance_etl_workflow
    etld_lib_spawn_etl.target_method_in_module_to_run = "policy_compliance_etl_workflow"
