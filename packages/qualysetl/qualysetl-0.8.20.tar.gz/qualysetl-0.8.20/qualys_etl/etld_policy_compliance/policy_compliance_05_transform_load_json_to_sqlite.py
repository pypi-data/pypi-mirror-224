...
def insert_one_row_into_table_q_policy_compliance(
    ...
    # def prepare_policy_compliance_field(field_data, field_name_tmp):
    ...
    #             sqlite_obj.prepare_database_field_policy_compliance(asset_item_dict[field_name],
    #                                                               field_name,
    ...
    row_in_sqlite_form = sqlite_obj.prepare_database_row_policy_compliance(
    ...
    if result is True:
        ...
        # WRITE CSV ROW
        if etld_lib_config.policy_compliance_distribution_csv_flag and csv_distribution_dict is not None:
            #
            # Write one row to Q_Asset_Inventory CSV File
            #
            qids_csv_obj: etld_lib_csv_distribution.CsvDistribution = \
                csv_distribution_dict['q_policy_compliance_csv_obj']
            qids_csv_obj.write_csv_row_to_file_handle(row_in_sqlite_form)
    else:
        counter_obj_duplicates.display_counter_to_log()


def insert_one_row_into_table_q_policy_compliance_software_assetid(
        asset_item_dict: dict,
        sqlite_obj: etld_lib_sqlite_tables.SqliteObj,
        counter_obj,
        batch_date: str,
    ...
    if asset_item_dict['softwareListData'] is not None:
        for software_item in asset_item_dict['softwareListData']['software']:
            if 'fullName' in software_item:
                ...
                sqlite_row = []
                for field in etld_lib_config.policy_compliance_software_assetid_csv_columns():
                ...
                result = sqlite_obj.insert_unique_row_ignore_duplicates(
                    etld_lib_config.policy_compliance_table_name_software_assetid,
                    sqlite_row)
                if result is True:
                    counter_obj.display_counter_to_log()
                    # WRITE CSV ROW
...
def insert_one_row_into_table_q_policy_compliance_software_os_unique(
        asset_item_dict: dict,
        sqlite_obj: etld_lib_sqlite_tables.SqliteObj,
        counter_obj,
        batch_date: str,
    ...
    if asset_item_dict['softwareListData'] is not None:
        for software_item in asset_item_dict['softwareListData']['software']:
            if 'fullName' in software_item:
                ...
                sqlite_row = []
                for field in etld_lib_config.policy_compliance_software_os_unique_csv_columns():
                    if field in row.keys():
                        sqlite_row.append(row[field])
                    else:
                        sqlite_row.append("")
                ...
                result = sqlite_obj.insert_unique_row_ignore_duplicates(
                    etld_lib_config.policy_compliance_table_name_software_os_unique,
                    sqlite_row)
                if result is True:
                    counter_obj.display_counter_to_log()
                    # WRITE CSV ROW
...
def drop_and_create_all_tables(sqlite_obj):
    sqlite_obj.drop_and_recreate_table(
        table_name=etld_lib_config.policy_compliance_table_name,
        csv_columns=etld_lib_config.policy_compliance_csv_columns(),
        csv_column_types=etld_lib_config.policy_compliance_csv_column_types(),
        key='assetId')

    sqlite_obj.drop_and_recreate_table(
        table_name=etld_lib_config.policy_compliance_status_table_name,
        csv_columns=etld_lib_config.status_table_csv_columns(),
        csv_column_types=etld_lib_config.status_table_csv_column_types(),
        key='STATUS_NAME')

    sqlite_obj.drop_and_recreate_table(
        table_name=etld_lib_config.policy_compliance_table_name_software_os_unique,
        csv_columns=etld_lib_config.policy_compliance_software_os_unique_csv_columns(),
        csv_column_types=etld_lib_config.policy_compliance_software_os_unique_csv_column_types(),
        key=['fullName', 'osName'])

    sqlite_obj.drop_and_recreate_table(
        table_name=etld_lib_config.policy_compliance_table_name_software_assetid,
        csv_columns=etld_lib_config.policy_compliance_software_assetid_csv_columns(),
        csv_column_types=etld_lib_config.policy_compliance_software_assetid_csv_column_types(),
        key=['assetId', 'fullName'])


def create_counter_objects(database_type='sqlite'):
    counter_obj_policy_compliance = etld_lib_functions.DisplayCounterToLog(
        ...
        display_counter_log_message=f"rows added to {database_type} "
                                    f"table {etld_lib_config.policy_compliance_table_name}")
    counter_obj_policy_compliance_duplicates = etld_lib_functions.DisplayCounterToLog(
    ...
    counter_obj_software_os = etld_lib_functions.DisplayCounterToLog(
        ...
        logger_func=etld_lib_functions.logger.info,
        display_counter_log_message=f"rows added to {database_type} "
                                    f"table {etld_lib_config.policy_compliance_table_name_software_os_unique}")
    counter_obj_software_assetid = etld_lib_functions.DisplayCounterToLog(
        display_counter_at=25000,
        logger_func=etld_lib_functions.logger.info,
        display_counter_log_message=f"rows added to {database_type} "
                                    f"table {etld_lib_config.policy_compliance_table_name_software_assetid}")
    counter_objects = {'counter_obj_policy_compliance': counter_obj_policy_compliance,
                       'counter_obj_policy_compliance_duplicates': counter_obj_policy_compliance_duplicates,
...
def insert_one_asset_into_multiple_tables(asset_item, sqlite_obj, counter_objects, csv_distribution_dict=None,
    ...
    insert_one_row_into_table_q_policy_compliance_software_os_unique(
    ...
    insert_one_row_into_table_q_policy_compliance_software_assetid(
        asset_item_dict=item,
        sqlite_obj=sqlite_obj,
    ...
    insert_one_row_into_table_q_policy_compliance(
        sqlite_obj=sqlite_obj,
        table_name=etld_lib_config.policy_compliance_table_name,
        table_fields=etld_lib_config.policy_compliance_csv_columns(),
        table_field_types=etld_lib_config.policy_compliance_csv_column_types(),
        asset_item_dict=item,
        counter_obj=counter_objects['counter_obj_policy_compliance'],
        counter_obj_duplicates=counter_objects['counter_obj_policy_compliance_duplicates'],
...
def transform_and_load_queue_of_json_files_into_sqlite(queue_of_json_files,):
    begin_policy_compliance_05_transform_load(message="queue_of_json_files_through_multiprocesssing")
    file_path = "EXCEPTION"
    try:
        sqlite_policy_compliance = etld_lib_sqlite_tables.SqliteObj(etld_lib_config.policy_compliance_sqlite_file)
        drop_and_create_all_tables(sqlite_policy_compliance)
        ...
        while True:
            ...
            with etld_lib_config.policy_compliance_open_file_compression_method(str(file_path), "rt", encoding='utf-8') \
                    as read_file:
                ...
                sqlite_policy_compliance.update_status_table(
                        batch_date=batch_date, batch_number=batch_number,
                        total_rows_added_to_database=counter_objects['counter_obj_policy_compliance'].get_counter(),
                        status_table_name=etld_lib_config.policy_compliance_status_table_name,
                        ...
                        status_name_column=etld_lib_config.policy_compliance_table_name, status_column='begin')

                all_items = json.load(read_file)
                csv_distribution_dict = {}
                if etld_lib_config.host_list_detection_distribution_csv_flag:
                    q_policy_compliance_csv_info =  etld_lib_csv_distribution.get_csv_info_dict(
                        batch_date=batch_date,
                        batch_number=batch_number,
                        table_name=etld_lib_config.policy_compliance_table_name,
                        csv_file_open_method=etld_lib_config.policy_compliance_open_file_compression_method,
                        distribution_dir=etld_lib_config.policy_compliance_distribution_dir
                    )
                    with q_policy_compliance_csv_info['compression_method'](
                            q_policy_compliance_csv_info['target_tmp_csv_file_path'], 'wt', newline='') as \
                            q_policy_compliance_target_tmp_csv_file_handle:
                        q_policy_compliance_csv_info['csv_obj'].set_csv_writer_with_file_handle(
                            q_policy_compliance_target_tmp_csv_file_handle)
                        csv_distribution_dict['q_policy_compliance_csv_obj'] = q_policy_compliance_csv_info['csv_obj']
                        for item in all_items['assetListData']['asset']:
                            insert_one_asset_into_multiple_tables(
                                item, sqlite_policy_compliance, counter_objects,
                                csv_distribution_dict=csv_distribution_dict,
                                batch_date=batch_date, batch_number=batch_number, batch_name=batch_name
                            )
                    Path(q_policy_compliance_csv_info['target_tmp_csv_file_path']).\
                            rename(q_policy_compliance_csv_info['target_csv_file_path'])
                else:
                    for item in all_items['assetListData']['asset']:
                        insert_one_asset_into_multiple_tables(
                            item, sqlite_policy_compliance, counter_objects, csv_distribution_dict=None,
                            batch_date=batch_date, batch_number=batch_number, batch_name=batch_name
                        )

                sqlite_policy_compliance.commit_changes()
                ...
                sqlite_policy_compliance.update_status_table(
                        ...
                        status_table_columns=etld_lib_config.status_table_csv_columns(),
                        status_table_column_types=etld_lib_config.status_table_csv_column_types(),
                        status_name_column=etld_lib_config.policy_compliance_table_name, status_column='end')
        ...
        sqlite_policy_compliance.update_status_table(
                ...
                status_table_columns=etld_lib_config.status_table_csv_columns(),
                status_table_column_types=etld_lib_config.status_table_csv_column_types(),
                status_name_column=etld_lib_config.policy_compliance_table_name, status_column='final')
        ...
        sqlite_policy_compliance.commit_changes()
        sqlite_policy_compliance.close_connection()
        counter_objects['counter_obj_policy_compliance_duplicates'].display_final_counter_to_log()
        counter_objects['counter_obj_policy_compliance'].display_final_counter_to_log()
        ...
        exit(1)
    end_policy_compliance_05_transform_load(message="queue_of_json_files_through_multiprocesssing")


def begin_policy_compliance_05_transform_load(message=""):
    etld_lib_functions.logger.info(f"start {message}")


def end_policy_compliance_05_transform_load(message=""):
    etld_lib_functions.logger.info(f"end  {message}")


def transform_and_load_all_json_files_into_sqlite():
    begin_policy_compliance_05_transform_load(message="directory_listing_of_json_files")
    json_file = "EXCEPTION"
    try:
        sqlite_policy_compliance = etld_lib_sqlite_tables.SqliteObj(etld_lib_config.policy_compliance_sqlite_file)
        drop_and_create_all_tables(sqlite_policy_compliance)
        counter_objects = create_counter_objects()
        json_file_list = \
            sorted(Path(etld_lib_config.policy_compliance_extract_dir).glob(
                etld_lib_config.policy_compliance_extract_dir_file_search_blob))
        for json_file in json_file_list:
            with etld_lib_config.policy_compliance_open_file_compression_method(str(json_file), "rt", encoding='utf-8') \
                    as read_file:
        ...
        etld_lib_functions.logger.error(f"Exception: {e}")
        exit(1)
    end_policy_compliance_05_transform_load(message="directory_listing_of_json_files")
...
if __name__ == "__main__":
    etld_lib_functions.main(my_logger_prog_name='policy_compliance_05_transform_load_json_to_sqlite')
    etld_lib_config.main()
    etld_lib_config.policy_compliance_json_to_sqlite_via_multiprocessing = False
    main()
