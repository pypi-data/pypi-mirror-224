            ...
            if not ERROR: 
                while True: 
                    ...
                    if response["status"] == "SUCCEEDED": 
                        ...
                        print(f"Failed to refresh RuleSetID: {ruleSetID}")
                        logging.error(f"FAILED to refresh for id: {ruleSetID}\n")
                        self.send_slack_message(f"Failed to refresh RuleSetID: {ruleSetID}")
                        break
                    else:
                        print(f"We have a new response code: {response['status']} \n This is for RuleSetID: {ruleSetID}")
                        self.send_slack_message(f"ERROR: We have a new response code: {response['status']} \n This is for RuleSetID: {ruleSetID}. The script has stopped executing, please investigate.")
                        sys.exit()
