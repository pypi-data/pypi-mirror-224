...
class PlotWidget(QWidget):
    def __init__(self, x, y=None, top=None, xlabel='', ylabel='', title='', bottom=None, line_style=None,
        ...
        if y:
            self.axes.plot(x, y, marker=line_style)
        else:
            self.axes.plot(x, marker=line_style)
