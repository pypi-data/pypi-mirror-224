...
def update(ctx, path):
  ...
  "sId": "e958862bc95403e181c3",
  "specification": "[{\"type\":\"input\",\"name\":\"INPUT\",\"indent\":0,\"spec\":{},\"config\":{\"dataset\":\"ChatDataset\"}},{\"type\":\"output\",\"name\":\"OUTPUT\",\"indent\":0,\"spec\":{},\"config\":{}}]"
})
    print(testpayload)
    print(payload)
    ...
    response = requests.request("POST", url, headers=headers, data=testpayload)
    print(response.text)
