#!/usr/bin/env python
#
# kingdon documentation build configuration file, created by
...
version = kingdon.__version__
# The full version, including alpha/beta/rc tags.
release = kingdon.__version__
...
latex_documents = [
    (master_doc, 'kingdon.tex',
     'Kingdon Documentation',
     'Martin Roelfs', 'manual'),
]
