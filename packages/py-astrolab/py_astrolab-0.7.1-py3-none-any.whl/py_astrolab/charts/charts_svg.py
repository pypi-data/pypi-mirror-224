...
class MakeSvgInstance:
    ...
    def __makeHouses(self, r):
        ...
        for i in range(xr):
            ...
            if self.chart_type == 'Transit' or self.chart_type == 'Composite':
                ...
                text_k = 53
            xtext = self.__sliceToX(0, (r-text_k), text_offset) + text_k - 10
            ...
            path = path + f'<text class="houseLabel" id="{house_by_index[i+1]} House Label" style="fill: #000000; fill-opacity: .8; font-size: 1em; font-family: Cinzel; font-weight: bold"><tspan x="' + \
    ...
    def __makeAxis(self, r, ar, source, cut_by, color):
        out = ''
        axis_stroke_opacity = '.7'
        for axis in source:
    ...
    def makeTemplate(self):
        ...
        if self.chart_type == "Transit" or self.chart_type == "Composite":
            ...
            td['transitRingAxes'] = self.__makeAxis(r, (r-self.c1+18.4), self.t_user.axis_list, 9.7, 'black')
            ...
            td['makePatterns'] = ''
            td['makeAxis'] = self.__makeAxis(r, (r-self.c1-18), self.user.axis_list, 8.4, '#ff0000')
            ...
            td['makeAxis'] = self.__makeAxis(r, (r-self.c1+30), self.user.axis_list, 8.4, '#ff0000')
