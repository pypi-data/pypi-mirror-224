...
class Transits():
    ...
    def __find_aspects(self, times, positions, natal_positions, look_for_planets, waxing_only, waning_only):
        ...
        for planet1 in self.planets:
            ...
            if planet1 == swe.MOON and planet1 in look_for_planets:
                new_moon_position = self.new_moon()['abs_pos']
                points_of_interest.append(("New Moon", new_moon_position))
            
            for planet2_name, natal_position in points_of_interest:
                if planet1 not in look_for_planets:
                    continue
                if planet2_name in {'Ascendant', 'New Moon'}:
    ...
    def new_moon(self):
        ...
        new_moon_obj['abs_pos'] = new_moon_long
        return new_moon_obj
