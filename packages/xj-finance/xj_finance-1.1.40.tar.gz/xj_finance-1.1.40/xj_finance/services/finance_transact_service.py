...
from ..utils.utility_method import get_current_time, get_code, append_microsecond_to_datetime
import os
...
class FinanceTransactService:
    ...
    def add(params):
        ...
        transact_no = param.get('transact_no', FinanceService.make_unicode(get_code()))  # 交易号
