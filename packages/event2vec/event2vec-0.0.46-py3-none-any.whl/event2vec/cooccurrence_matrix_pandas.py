...
def build_cooccurrence_matrix_pd(
    ...
    event_counts = np.zeros(len(vocabulary_))
    ...
    if output_dir is not None:
        ...
        np.save(os.path.join(output_dir, "event_count.npy"), event_counts)
    return full_coocurrence_matrix, event_counts, encoder
