...
class MakeToken:
    ...
    def __init__(self, areaId, cityName, originUrl, page):
        ...
        self.page = page
        self.uuid = "d0de19b6958b4f4c94fe.1610887043.1.0.0"  # Demo
    ...
    def join_sign(self):
        ...
        sign = base64.b64encode(
            zlib.compress(bytes(json.dumps(_str, ensure_ascii=False), encoding="utf8"))
        )
    ...
    def join_token(self):
        ...
        token_decode = zlib.compress(
            bytes(
                json.dumps(str_json, separators=(",", ":"), ensure_ascii=False),
                encoding="utf8",
            )
        )
...
if __name__ == "__main__":
    ...
    areaId = "0"
    cityName = "郑州"
    originUrl = "http://cq.meituan.com/meishi/c54/"
    page = "1"
