...
if __name__ == "__main__":
    ...
    # res = hbase_thrift2_client.get(table_name="tag", key="A2024", cols="info", columns=["tag_class", "tag_class_code"])
    # print(res)
    ...
    # for x,y in  hbase_thrift2_client.scan(table_name='dim_store_shop', cols="cf", filter=None, columns=["id"],limit=None):
    #     print (x,y)
