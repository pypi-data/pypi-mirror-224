...
class RedisClient:
    ...
    def _lpush(self):
        ...
        print(self.client.brpop("test_list"))  # 移出并获取列表的最开始的一个元素，如果没有会阻塞
        print(self.client.llen("test_list"))  # 移出并获取列表的最开始的一个元素，如果没有会阻塞
    ...
    def _zadd(self):
        ...
        print(self.client.zrevrange("sum_zinter", 0, 4, withscores=True))  # 得分最大的5篇
        print(self.client.zrevrange("sum_zunion", 0, 4, withscores=True))  # 得分最大的5篇
