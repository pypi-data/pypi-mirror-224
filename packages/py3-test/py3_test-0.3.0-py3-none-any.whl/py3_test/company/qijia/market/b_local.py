...
# data = 'url=http://m.jia.com&site=JIA&kind=a&a_ly={a_ly}&a_lx={a_lx}'.format(a_ly=a_ly_quote, a_lx=a_lx_quote)
#
# r = session.post("http://{0}/api/ad/".format(host),
#                  json={"url": "http://m.jia.com", "site": "JIA", "kind": "a", "a_ly": "短信", "a_lx": "内部数据"},
#                  headers={
