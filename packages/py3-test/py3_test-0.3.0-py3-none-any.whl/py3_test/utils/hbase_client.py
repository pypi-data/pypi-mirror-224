...
if __name__ == "__main__":
    ...
    # print hbase_client.scan(table_name='user_crm_tag', filter_data=[('user_mobile', "556bf879edadb0118901fac74dbd4627")])
    # for x, y in hbase_client.scan(table_name='attrresult:tag_quality_v9_news', limit=None, columns=[]):
    #     print(x, y)

    # for x,y in  hbase_client.scan(table_name='tag',filter_data=[('tag_class','用户基础标签表')], columns=["tag_class","tag_name","hbasetable","data_class"],limit=None):
    #     print x,y

    # for x,y in  hbase_client.scan_timestamp(table_name='user_crm_tag', columns=["lately_12month_crm_service_num"], batch_size=1000):
    #     print x,y

    # print hbase_client.gets(table_name='user_base_info_new', keys=["100000024", "754"], columns=["phone_city","substation","ip_city"])
