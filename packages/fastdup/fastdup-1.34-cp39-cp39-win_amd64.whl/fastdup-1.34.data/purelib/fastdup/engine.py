...
class Fastdup(FastdupController):
    ...
    def run(self,
        ...
        if (model_path is not None):
            if 'dinov2s' not in model_path and 'dinov2b' not in model_path and 'resnet50' not in model_path and 'efficientnet' not in model_path and 'clip' not in model_path and 'clip336' not in model_path:
