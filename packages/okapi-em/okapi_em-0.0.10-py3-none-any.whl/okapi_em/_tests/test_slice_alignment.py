...
def test_cl_affineTransform():
    ...
    myAf0 = slice_alignment.cAffineTransform(lin_tr, transl_tr)
    ...
    myAf1 = slice_alignment.cAffineTransform(lin_tr, transl_tr)
    ...
    myAf2 = slice_alignment.cAffineTransform(lin_tr, transl_tr)
