...
class Disagreement:
    ...
    def calculate_direction_overlap(self):
        ...
        for i in range(len(self.base_counterfactuals)):
            for j in range(i + 1, len(self.base_counterfactuals)):
                ...
                manhattan_distance = self.calculate_manhattan_distance(base_counterfactual[i], base_counterfactual[j])
        ...
        return average_direction_overlap_scores
