...
class Evaluation:
    ...
    def calculate_combined_fitness(self, candidate_instance, base_cf_scores):
        ...
        if(self.wachter == True):
            ...
            combined_fitness = proximity_score + penalty
        else:
            ...
            print(f'Disagreement: {self.alpha * avg_disagreement}, Penalty: {self.theta * penalty}, Proximity: {self.beta * proximity_score}, Sparsity: {self.gamma * sparsity_score}')
    ...
    def misclassification_penalty_wachter(self, counterfactual):
        ...
        return abs(probability_target - instance_probability_target)
