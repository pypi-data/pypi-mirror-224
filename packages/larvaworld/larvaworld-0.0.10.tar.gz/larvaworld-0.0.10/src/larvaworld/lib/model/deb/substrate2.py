...
class Compound(param.Parameterized):
    # d=aux.PositiveNumber(0,doc=f'density in g/cm**3')
...
class Epoch(param.Parameterized):
    time_range = aux.OptionalPositiveRange(softmax=100.0, hardmax=250.0, doc='The beginning and end of the epoch in hours post-hatch.')
