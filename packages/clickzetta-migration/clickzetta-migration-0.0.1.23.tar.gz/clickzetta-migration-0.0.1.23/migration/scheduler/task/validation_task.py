...
class ValidationTask(Task):
    ...
    def check_count(self):
        ...
        if isinstance(source_count, map):
        ...
        if isinstance(destination_count, map):
    ...
    def check_number_type_statistics(self):
        ...
        for column in table_columns:
            if self.is_number_type(column, type_mapping):
                ...
                if isinstance(source_result, map):
                    source_result = list(source_result['min_value'], source_result['max_value'], source_result['avg_value'])
                ...
                if isinstance(destination_result, map):
                    destination_result = list(destination_result['min_value'], destination_result['max_value'], destination_result['avg_value'])
