...
def data(source: Source, destination: Destination, db_list: list, config_table_list: list, external_table_list: list,
         project_name: str, concurrency: int, quit_if_fail: bool, transform_partitions: dict):
    ...
    DataTransformer(source, destination, project_name, db_list, config_table_list, external_table_list, concurrency,
                    quit_if_fail, transform_partitions).transform()


def validate(source: Source, destination: Destination, db_list: list, config_table_list: list,
             external_table_list: list, project_name: str, concurrency: int, quit_if_fail: bool):
    ...
    Validation(source, destination, project_name, db_list, config_table_list, external_table_list, concurrency,
               quit_if_fail).transform()
...
def main():
    ...
    if args['test']:
        ...
        data(source, destination, db_list, config_table_list, external_table_list, project_name, concurrency,
             quit_if_fail, transform_partitions)
    elif args['validate']:
