...
setup(
    name='invoicing-pdf-exercise',  # * Your package will have this name
    ...
    author='Konstantinos Zygouris',  # Your name
    author_email='zigouris.konstantinos@gmail.com',  # Your email
    url='https://github.com/Konstantinos-Z/Invoice_generator',
