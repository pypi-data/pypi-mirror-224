...
class UnaryOpParams(ArithmeticOperationParams):
    ...
    def _rename_argument(cls, arg: RegisterUserInput) -> RegisterUserInput:
        return arg.revalued(name=UNARY_ARG_NAME)
...
class Sign(UnaryOpParams):
    ...
    def _get_result_register(self) -> RegisterUserInput:
        return RegisterUserInput(size=1, fraction_places=0, is_signed=False)
