...
from .re_unittest import (run_fetch_re_schema, run_fetch_re_schema_no_desc)
...
class TestCodegen(unittest.TestCase):
    ...
    def test_re_schema(self):
      return run_fetch_re_schema()

    def test_re_schema_nodesc(self):
      return run_fetch_re_schema_no_desc()
