...
SchemaFor200ResponseBodyApplicationJson = BrokerageAuthorizationSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: BrokerageAuthorization
...
class BaseApi(api_client.Api):
    ...
    def _detail_brokerage_authorization_mapped_args(
        self,
    ...
    async def _adetail_brokerage_authorization_oapg(
        self,
        query_params: typing.Optional[dict] = {},
        path_params: typing.Optional[dict] = {},
    ...
    def _detail_brokerage_authorization_oapg(
        self,
        query_params: typing.Optional[dict] = {},
        path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class DetailBrokerageAuthorization(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adetail_brokerage_authorization(
        self,
        authorization_id: typing.Optional[str] = None,
        user_id: typing.Optional[str] = None,
        user_secret: typing.Optional[str] = None,
        ...
        return await self._adetail_brokerage_authorization_oapg(
    ...
    def detail_brokerage_authorization(
        ...
        return self._detail_brokerage_authorization_oapg(
            query_params=args.query,
            path_params=args.path,
        )
