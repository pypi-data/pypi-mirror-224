...
class HardwareOut(
    ...
    This model is backwards-compatible with the legacy `HardwareReturnSchema`.
    """
    ...
    machine: MetaOapg.properties.machine
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["machine"]) -> MetaOapg.properties.machine: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "family", "machineModel", "environment", "vendor", "jobLabel", "taint", "label", "group", "inferyVersion", "defaultBatchSizeList", "deprecated", "machine", "updateTime", "creationTime", "id", "deleted", "imageRepository", "imageDistribution", "future", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["machine"]) -> MetaOapg.properties.machine: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "family", "machineModel", "environment", "vendor", "jobLabel", "taint", "label", "group", "inferyVersion", "defaultBatchSizeList", "deprecated", "machine", "updateTime", "creationTime", "id", "deleted", "imageRepository", "imageDistribution", "future", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        machine: typing.Union[MetaOapg.properties.machine, str, ],
        vendor: 'HardwareVendor',
