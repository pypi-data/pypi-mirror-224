...
_ns_module = toasts_winrt.system._import_ns_module("Windows.Data.Xml.Dom")
...
toasts_winrt.system._mixin_sequence(XmlNamedNodeMap)
XmlNodeList = _ns_module.XmlNodeList
toasts_winrt.system._mixin_sequence(XmlNodeList)
