...
class FileUploadApi(object):
    ...
    def file_upload_delete_uploaded_file_url_with_http_info(self, uploaded_url, **kwargs):  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method file_upload_delete_uploaded_file_url" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('uploaded_url' not in params or
            ...
            raise ValueError("Missing the required parameter `uploaded_url` when calling `file_upload_delete_uploaded_file_url`")  # noqa: E501
