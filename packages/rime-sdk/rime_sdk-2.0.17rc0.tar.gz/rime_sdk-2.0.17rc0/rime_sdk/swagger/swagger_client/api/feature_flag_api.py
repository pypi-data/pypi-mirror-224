...
class FeatureFlagApi(object):
    ...
    def feature_flag_upsert_feature_flag(self, body, customer_name, **kwargs):  # noqa: E501
        """UpsertFeatureFlag  # noqa: E501

        Update a feature JWT token with the customer name.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.feature_flag_upsert_feature_flag(body, customer_name, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.feature_flag_upsert_feature_flag_with_http_info(body, customer_name, **kwargs)  # noqa: E501
        else:
            (data) = self.feature_flag_upsert_feature_flag_with_http_info(body, customer_name, **kwargs)  # noqa: E501
            return data

    def feature_flag_upsert_feature_flag_with_http_info(self, body, customer_name, **kwargs):  # noqa: E501
        """UpsertFeatureFlag  # noqa: E501

        Update a feature JWT token with the customer name.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.feature_flag_upsert_feature_flag_with_http_info(body, customer_name, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method feature_flag_upsert_feature_flag" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `feature_flag_upsert_feature_flag`")  # noqa: E501
        # verify the required parameter 'customer_name' is set
        if ('customer_name' not in params or
                params['customer_name'] is None):
            raise ValueError("Missing the required parameter `customer_name` when calling `feature_flag_upsert_feature_flag`")  # noqa: E501
