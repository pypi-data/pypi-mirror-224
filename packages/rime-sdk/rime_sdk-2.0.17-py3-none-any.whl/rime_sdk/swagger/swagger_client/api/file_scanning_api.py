...
class FileScanningApi(object):
    ...
    def file_scanning_list_file_scan_results(self, **kwargs):  # noqa: E501
        ...
        :param str page_token: Specifies a page of the list returned by a ListFileScanResults query. The ListFileScanResults query returns a pageToken when there is more than one page of results.
