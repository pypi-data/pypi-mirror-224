...
class RimeModelTask(object):
    ...
    allowed enum values
    """
    UNSPECIFIED = "MODEL_TASK_UNSPECIFIED"
    REGRESSION = "MODEL_TASK_REGRESSION"
    ...
    def __init__(self):  # noqa: E501
        """RimeModelTask - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(RimeModelTask, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RimeModelTask):
            return False
