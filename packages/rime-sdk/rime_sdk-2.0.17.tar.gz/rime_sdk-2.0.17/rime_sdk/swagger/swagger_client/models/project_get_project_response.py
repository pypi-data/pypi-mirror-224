...
class ProjectGetProjectResponse(object):
    ...
    def __init__(self, project=None):  # noqa: E501
        """ProjectGetProjectResponse - a model defined in Swagger"""  # noqa: E501
        self._project = None
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ProjectGetProjectResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ProjectGetProjectResponse):
            return False
