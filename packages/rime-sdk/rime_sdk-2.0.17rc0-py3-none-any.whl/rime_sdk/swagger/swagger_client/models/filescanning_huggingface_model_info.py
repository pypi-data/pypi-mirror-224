...
class FilescanningHuggingfaceModelInfo(object):
    ...
    def __init__(self, scan_path=None):  # noqa: E501
        """FilescanningHuggingfaceModelInfo - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(FilescanningHuggingfaceModelInfo, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, FilescanningHuggingfaceModelInfo):
            return False
