...
class RimeRegisterDatasetResponse(object):
    ...
    def __init__(self, dataset_id=None):  # noqa: E501
        """RimeRegisterDatasetResponse - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(RimeRegisterDatasetResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RimeRegisterDatasetResponse):
            return False
