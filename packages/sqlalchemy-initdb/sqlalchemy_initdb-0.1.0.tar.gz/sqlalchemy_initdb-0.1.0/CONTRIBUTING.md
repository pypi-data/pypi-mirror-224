...
Report bugs at [https://github.com/dnmellen/sqlalchemy-initdb/issues](https://github.com/dnmellen/sqlalchemy-initdb/issues).
W
Stambling upon a Bug means encountering different behaviour than the expected/advertised one. When you are reporting a bug, please include the following infromation by filling in [the template](https://github.com/dnmellen/sqlalchemy-initdb/.github/blob/master/.github/ISSUE_TEMPLATE/bug_report.md).
...
SQLAlchemy InitDB could always use more documentation, whether as part of the official SQLAlchemy InitDB docs, in docstrings, etc.
...
The best way to send feedback is to file an issue at [https://github.com/dnmellen/sqlalchemy-initdb/issues](https://github.com/dnmellen/sqlalchemy-initdb/issues).
...
Here's how to set up `sqlalchemy-initdb` for local development.

1. Fork the `sqlalchemy-initdb` repo on GitHub.
2. Clone your fork locally:

```bash
git clone git@github.com:dnmellen/sqlalchemy-initdb.git
```

3. Install your local copy into a virtualenv. Assuming you have virtualenv installed, this is how you set up your fork for local development:

```bash
cd sqlalchemy-initdb
...
SQLAlchemy InitDB is designed to do one thing, and do that one thing very well.
...
The roadmap located [here](https://github.com/dnmellen/sqlalchemy-initdb/milestones?direction=desc&sort=due_date&state=open)
