...
class CfnComputeEnvironment(
    ...
    .. epigraph::
       ...
       - Set the `AllocationStrategy <https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-batch-computeenvironment-computeresources.html#cfn-batch-computeenvironment-computeresources-allocationstrategy>`_ property to ``BEST_FIT_PROGRESSIVE`` , ``SPOT_CAPACITY_OPTIMIZED`` or ``SPOT_PRICE_CAPACITY_OPTIMIZED`` .
