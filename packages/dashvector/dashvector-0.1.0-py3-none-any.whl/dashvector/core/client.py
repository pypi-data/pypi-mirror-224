...
class Client(object):
    ...
    def create(self,
               ...
               *,
               dtype: Union[Type[int],
                            Type[float]] = float,
               fields_schema: Optional[Dict[str,
                                            Union[Type[str],
                                                  Type[int],
                                                  Type[float],
                                                  Type[bool]]]] = None,
        ...
        if self._code != DashVectorCode.Success:
            return DashVectorResponse(
                ...
                exception=DashVectorException(
                    code=DashVectorCode.RuntimeError,
        ...
        create_response = DashVectorResponse(
            self._handler.create_collection(create_request))
            ...
            if describe_response.code == DashVectorCode.Success:
                ...
                if status == Status.SERVING:
                    ...
                    return DashVectorResponse(
                        None,
                        exception=DashVectorException(
                            code=DashVectorCode.InvalidCollectionStatus,
    ...
    def delete(self, name: str) -> DashVectorResponse:
        ...
        delete_response = DashVectorResponse(
            self._handler.delete_collection(delete_request))
    ...
    def describe(self, name: str) -> DashVectorResponse:
        ...
        return DashVectorResponse(
            self._handler.describe_collection(describe_request))
    ...
    def get(self, name: str) -> Collection:
        ...
        describe_response = DashVectorResponse(
            self._handler.describe_collection(describe_request))
        if describe_response.code != DashVectorCode.Success:
