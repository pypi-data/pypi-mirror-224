...
class HTTPHandler(RPCHandler):
    ...
    _DOC_URL_FETCH_GET = "/v1/collections/%s/docs?ids=%s"
    ...
    class _HTTPResponse(RPCResponse):
        ...
        def get(self):
            if self._response is None:
                ...
                try:
                    self._response = {} if self._body is None else json.loads(
                        self._body)
        ...
        def _parse_output(self):
            if self._attr_name == "get_version":
                ...
                self._output = CollectionStats(
                    stats=self._response.get('output'))
                ...
                if isinstance(self._request, FetchDocRequest):
                    for doc_id, doc in self._response.get(
                            'output', {}).items():
                        result_docs[doc_id] = DocBuilder.from_dict(
                ...
                if isinstance(self._request, QueryDocRequest):
                    for doc in self._response.get('output', []):
                        result_docs.append(
                            DocBuilder.from_dict(
                                doc, collection_meta=self._request.collection_meta))
                self._output = result_docs
            elif self._attr_name == "stats_partition":
                if isinstance(self._request, StatsPartitionRequest):
                    self._output = PartitionStats(
                        self._request.partition_name, self._response.get(
                            'output', {}).get('total_doc_count'))
    ...
    class _HTTPAsyncClient(object):
        ...
        def __init__(self,
            ...
            if HTTPHandler._HTTPAsyncClient._aio_ev_loop is None:
                ...
                _thread.start_new_thread(
                    HTTPHandler._HTTPAsyncClient._start_aio_ev_thread,
        ...
        def get(self,
                ...
                *,
                ...
                async_req=False,
                attr_name=None):
            a_future = asyncio.run_coroutine_threadsafe(self._get(
                url, headers, timeout), loop=HTTPHandler._HTTPAsyncClient._aio_ev_loop)
    ...
    def __init__(self, *,
        ...
        self._http_async_client = self._HTTPAsyncClient(
            endpoint=self._endpoint, headers=self._http_headers, timeout=self._timeout)
    ...
    def create_collection(self,
        ...
        return self._http_async_client.post(
            self._COLLECTION_URL_CREATE_POST,
    ...
    def delete_collection(self,
        ...
        return self._http_async_client.delete(
            self._COLLECTION_URL_DELETE_DELETE %
            delete_request.name,
            timeout=rebuild_timeout,
            async_req=async_req)
    ...
    def describe_collection(self,
        ...
        return self._http_async_client.get(
            self._COLLECTION_URL_DESCRIBE_GET %
            describe_request.name,
    ...
    def stats_collection(self,
                         ...
                         *,
                         async_req: bool = False) -> RPCResponse:
        return self._http_async_client.get(
            self._COLLECTION_URL_STATS_GET %
            stats_request.name,
            attr_name="stats_collection",
            async_req=async_req)
    ...
    def list_collections(self,
                         *,
                         async_req: bool = False) -> RPCResponse:
        return self._http_async_client.get(
            self._COLLECTION_URL_LIST_GET,
            async_req=async_req,
            attr_name="list_collections")
    ...
    def upsert_doc(self,
                   ...
                   *,
                   async_req: bool = False) -> RPCResponse:
        return self._http_async_client.post(
            self._DOC_URL_UPSERT_POST %
            upsert_request.collection_name,
    ...
    def update_doc(self,
        ...
        return self._http_async_client.put(
            self._DOC_URL_UPDATE_PUT %
            update_request.collection_name,
    ...
    def create_partition(self,
                         ...
                         *,
                         async_req: bool = False) -> RPCResponse:
        return self._http_async_client.post(self._PARTITION_URL_CREATE_POST %
                                            create_request.collection_name,
                                            create_request.to_json(),
                                            req=create_request,
                                            async_req=async_req)
    ...
    def delete_partition(self,
                         ...
                         *,
                         async_req: bool = False) -> RPCResponse:
        return self._http_async_client.delete(
            self._PARTITION_URL_DELETE_DELETE %
            (delete_request.collection_name,
             delete_request.partition_name),
            async_req=async_req)
    ...
    def list_partitions(self,
                        ...
                        *,
                        async_req: bool = False) -> RPCResponse:
        return self._http_async_client.get(
            self._PARTITION_URL_LIST_GET %
            list_request.collection_name,
            async_req=async_req,
    ...
    def describe_partition(self,
        ...
        return self._http_async_client.get(
            self._PARTITION_URL_DESCRIBE_GET %
            (describe_request.collection_name,
             describe_request.partition_name),
    ...
    def stats_partition(self,
        ...
        return self._http_async_client.get(
            self._PARTITION_URL_STATS_GET %
            (stats_request.collection_name,
             stats_request.partition_name),
            req=stats_request,
            async_req=async_req,
