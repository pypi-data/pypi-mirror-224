...
class Variable(IRObj):
    ...
    def markInput(self):
        ...
        self._graph.markInput(self)
    
    def unMarkInput(self):
        assert self._graph is not None
        self._graph.unMarkInput(self.name)
    
    def markOutput(self):
        assert self._graph is not None
        self._graph.markOutput(self)
    
    def unMarkOutput(self):
        assert self._graph is not None
        self._graph.unMarkOutput(self.name)
