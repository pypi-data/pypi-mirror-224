...
class AlphaFour:
  def __init__(self):
    ...
    weights_file_path =current_script_path+'/SelfTrained7PlayerWeight.pt'
...
class SelfTrained7Player(Player):
    def __init__(self, name="SelfTrained7Player",deteministic=False):
