...
class AlphaFour:
  def __init__(self):
    ...
    weights_file_path =current_script_path+'/SelfTrained3PlayerWeight.pt'
...
class SelfTrained3Player(Player):
    def __init__(self, name="SelfTrained3Player",deteministic=False):
