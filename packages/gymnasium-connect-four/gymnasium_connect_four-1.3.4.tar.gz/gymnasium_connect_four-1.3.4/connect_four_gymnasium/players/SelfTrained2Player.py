...
class AlphaFour:
  def __init__(self):
    ...
    weights_file_path =current_script_path+'/SelfTrained2PlayerWeight.pt'
...
class SelfTrained2Player(Player):
    def __init__(self, name="SelfTrained2Player",deteministic=False):
