...
class AlphaFour:
  def __init__(self):
    ...
    weights_file_path =current_script_path+'/SelfTrained1PlayerWeight.pt'
...
class SelfTrained1Player(Player):
    def __init__(self, name="SelfTrained1Player",deteministic=False):
