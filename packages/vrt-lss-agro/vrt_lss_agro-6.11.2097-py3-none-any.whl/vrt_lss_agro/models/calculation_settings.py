...
class CalculationSettings(BaseModel):
    ...
    max_waiting_time: Optional[constr(strict=True, max_length=16, min_length=3)] = Field('PT20M', description="Max calculation time. The countdown starts from the time when data is uploaded to the server. ")
