...
LOG_INTERVAL = env.float("LOG_INTERVAL", default=120)
...
ELASTICSEARCH_TIMEOUT = env.float("ELASTICSEARCH_TIMEOUT", default=120)
...
PG_SCHEMA = env.str("PG_SCHEMA")

# Redis:
REDIS_AUTH = env.str("REDIS_AUTH", default=None)
REDIS_DB = env.int("REDIS_DB", default=0)
REDIS_HOST = env.str("REDIS_HOST", default="localhost")
REDIS_ENDPOINT = env.str("REDIS_ENDPOINT", default="localhost")
...
REDIS_CLUSTER = env.bool("REDIS_CLUSTER", default=True)
