...
setup(
  name = 'pdf-my-invoice',         #* Your package will have this name
  ...
  author = 'Raphael Allen',                   # Your name
  author_email = 'useremail@useremail.com',  # Your email
  url = 'https://github.com/RCALLEN',              # Homepage of your library (e.g. github or your website)
