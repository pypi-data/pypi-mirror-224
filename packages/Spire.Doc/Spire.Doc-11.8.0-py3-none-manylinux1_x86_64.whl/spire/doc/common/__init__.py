...
dlllib = dlllibXls
if dlllibXls != None and GETSPIREPRODUCT(__file__) == "XLS":
    dlllib = dlllibXls
elif dlllibDoc != None and GETSPIREPRODUCT(__file__) == "DOC":
    dlllib = dlllibDoc
elif dlllibPdf != None and GETSPIREPRODUCT(__file__) == "PDF":
    dlllib = dlllibPdf
elif dlllibPpt != None and GETSPIREPRODUCT(__file__) == "PRESENTATION":
    dlllib = dlllibPpt
...
if GETSPIREPRODUCT(__file__) == "PDF" :
    ...
    from spire.xls.common.ImageFormat import ImageFormat
    ...
    from spire.xls.common.Image import Image
    from spire.xls.common.Bitmap import Bitmap
    ...
    from spire.xls.common.Font import Font
    ...
    from spire.doc.common.ImageFormat import ImageFormat
    ...
    from spire.doc.common.Image import Image
    from spire.doc.common.Bitmap import Bitmap
    ...
    from spire.doc.common.Font import Font
