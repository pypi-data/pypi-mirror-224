import unittest
import numpy as np
from timeseries.models import Ising
...
class TestIsing(unittest.TestCase):
    ...
    #     super(TestTFIM, self).__init__(*args, **kwargs)
    @classmethod
    def setUpClass(cls):
        L = 16
        coupling_list = [[0,1], [2,3], [5,6], [7,8], [9, 10], [12, 13], [14, 15],
                        [1,2], [3,4], [8,9], [10,11], [13, 14], [6,15],
                        [0,13], [2,15], [4,5], [6,7], [9,14], [11, 12]]
        Jzz = -1
        hx = 0.2
        which_first = 'zz'
        n_steps = 10
        ...
        model = Ising.from_coupling_list(L, coupling_list, Jzz, hx, which_first)
    ...
    def test_1st_trotter_circuit_without_control(self):
        """Test the 1st-order Trotterized circuit of TFIM without control qbit."""
    ...
    def test_1st_trotter_circuits_with_control(self):
        """Test the 1st-order Trotterized circuit of TFIM with a control qbit."""
    ...
    def test_2nd_trotter_circuit_without_control(self):
        """Test the 2nd-order Trotterized circuit of TFIM without control qbit."""
    ...
    def test_2nd_trotter_circuits_with_control(self):
        """Test the 2nd-order Trotterized circuit of TFIM with a control qbit."""
    ...
    def test_hadamard_circuit_real(self, trotter_order, split, optimized, n_controls):
            """Test the real-part Hadamard test circuit of TFIM."""
    ...
    def test_hadamard_circuit_imaginary(self, trotter_order, split, optimized, n_controls):
            """Test the imaginary-part Hadamard test circuit of TFIM."""
    ...
    def test_amplitude_circuit(self, trotter_order):
        """Test the amplitude circuit for TFIM."""
