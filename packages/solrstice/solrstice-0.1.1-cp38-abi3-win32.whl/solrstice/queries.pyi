...
class SelectQueryBuilder:
    ...
    def execute_blocking(self, context: 'SolrServerContext', collection: str) -> 'SolrResponse':
        """Execute the query
...
class UpdateQueryBuilder:
    ...
    """
    def __init__(self, handler: Optional[str] = 'update', commit_type: Optional[CommitType] = CommitType.Hard) -> None:
        pass

    handler: str
    commit_type: CommitType

    async def execute(self, context: 'SolrServerContext', collection: str, data: List[Dict]) -> 'SolrResponse':
        """Execute the query
    ...
    def execute_blocking(self, context: 'SolrServerContext', collection: str, data: List[Dict]) -> 'SolrResponse':
        """Execute the query
...
class DeleteQueryBuilder:
    ...
    """
    def __init__(self, handler: Optional[str] = 'update', commit_type: Optional[CommitType] = CommitType.Hard, ids: Optional[List[str]] = None, queries: Optional[List[str]] = None) -> None:
        pass
