...
class L1DocTest():
    ...
    Args:
        ...
        Defaults to -1 If no docstring was found.
    """
    def __init__(self, filename:str, name:str, type:str, node_lineno:int, start_lineno=-1, end_lineno=-1) -> None:
    ...
    def count_tests(self):
        ...
        """ 
        return sum([1 for ex in self.__examples if ex.is_a_test()])
    ...
    def count_setups(self):
        ...
        """ 
        return sum([1 for ex in self.__examples if not ex.is_a_test()])
    ...
    def get_verdict_from_lineno(self, lineno:int) -> ExampleVerdict:
        """
        Return the verdict of the example that has the given lineno. 
        Return None if the example is not found.
        """
        found_example = self.__get_example(lineno)
        return found_example.get_verdict() if found_example else None
    
    def get_example_from_lineno(self, lineno:int) -> Example:
        """
        Return the example that has the given lineno. Return None if the example is not found.
        """
        return self.__get_example(lineno)
