...
from src.data_cleaner.configs import (
    conclusion_phrases,
    unwanted_phrases,
    history_tag_definers,
)
from src.data_cleaner.services import TextParser, EmailsProcessor, HTMLParser


def read_file(file_type):
    filename = "email_with_" + file_type
    path_to_file = os.path.join("app", "tests", "emails_bodies", filename + ".txt")
