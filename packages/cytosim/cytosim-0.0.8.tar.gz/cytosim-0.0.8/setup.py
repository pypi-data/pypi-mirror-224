...
# and from deepmind's tree : https://github.com/deepmind/tree/
import os
import sys
import subprocess
import re
...
#        f'-DDIMENSION={__DIMENSION__}'  ##### kept for future use ; broken for now
    ]
...
setup(
    ...
    ext_modules=[CMakeExtension('cytosim', source_dir='pycytoplay')],
    zip_safe=False,
)
