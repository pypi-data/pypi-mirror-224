...
def speed_test(assert_download: tuple[int or None, int or None] or None = None,
               assert_upload: tuple[int or None, int or None] or None = None, unit: str = 'MB'):
    """进行网络测速, 并返回下载|上传速率
