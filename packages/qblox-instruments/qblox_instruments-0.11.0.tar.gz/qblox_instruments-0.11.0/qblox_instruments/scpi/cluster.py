...
class Cluster(Ieee488_2):
    ...
    def __init__(self, transport: Transport, debug: int=0):
        ...
        if self._debug == 0:
            ...
            build_ref = "fwVersion=0.6.0 fwBuild=19/07/2023-13:01:53 fwHash=0x7DE49899 fwDirty=0 kmodVersion=0.6.0 kmodBuild=27/07/2023-12:56:01 kmodHash=0xC4BEED9E kmodDirty=0 swVersion=0.6.0 swBuild=27/07/2023-12:56:01 swHash=0xC4BEED9E swDirty=0 cfgManVersion=0.3.0 cfgManBuild=27/07/2023-12:56:01 cfgManHash=0xC4BEED9E cfgManDirty=0"
            if build != build_ref:
    ...
    def _get_in_offset_0(self, slot: int) -> float:
        ...
        # SCPI call
        var0 = self._read('SLOT{}:AFE:OFFSet:IN0?'.format(slot))
    ...
    def _get_in_offset_1(self, slot: int) -> float:
        ...
        # SCPI call
        var0 = self._read('SLOT{}:AFE:OFFSet:IN1?'.format(slot))
    ...
    def _get_sequencer_acq_channel_map(self, slot: int, sequencer: int) -> Any:
        ...
        # SCPI call
        var0 = self._read_bin('SLOT{}:SEQuencer{}:ACQ:CHANnelmap?'.format(slot, sequencer))
    ...
    def _get_out_filt_width_0(self, slot: int) -> int:
        ...
        # SCPI call
        var0 = self._read('SLOT{}:AFE:FILT:OUT0:WIDTh?'.format(slot))
    ...
    def _get_out_filt_width_1(self, slot: int) -> int:
        ...
        # SCPI call
        var0 = self._read('SLOT{}:AFE:FILT:OUT1:WIDTh?'.format(slot))
    ...
    def _get_out_filt_center_0(self, slot: int) -> int:
        ...
        # SCPI call
        var0 = self._read('SLOT{}:AFE:FILT:OUT0:CENTer?'.format(slot))
    ...
    def _get_out_filt_center_1(self, slot: int) -> int:
        ...
        # SCPI call
        var0 = self._read('SLOT{}:AFE:FILT:OUT1:CENTer?'.format(slot))
    ...
    def _get_out_filt_en_0(self, slot: int) -> bool:
        ...
        # SCPI call
        var0 = self._read('SLOT{}:AFE:FILT:OUT0:ENAble?'.format(slot))
    ...
    def _get_out_filt_en_1(self, slot: int) -> bool:
        ...
        # SCPI call
        var0 = self._read('SLOT{}:AFE:FILT:OUT1:ENAble?'.format(slot))
    ...
    def _get_mrk_inv_en_0(self, slot: int) -> bool:
        ...
        # SCPI call
        var0 = self._read('SLOT{}:MRK0:INVert:ENAble?'.format(slot))
    ...
    def _get_mrk_inv_en_1(self, slot: int) -> bool:
        ...
        # SCPI call
        var0 = self._read('SLOT{}:MRK1:INVert:ENAble?'.format(slot))
    ...
    def _get_mrk_inv_en_2(self, slot: int) -> bool:
        ...
        # SCPI call
        var0 = self._read('SLOT{}:MRK2:INVert:ENAble?'.format(slot))
    ...
    def _get_mrk_inv_en_3(self, slot: int) -> bool:
        ...
        # SCPI call
        var0 = self._read('SLOT{}:MRK3:INVert:ENAble?'.format(slot))
    ...
    def _set_in_offset_0(self, slot: int, in_offset_0: float) -> None:
        ...
        # SCPI call
        self._write('SLOT{}:AFE:OFFSet:IN0 {}'.format(slot, in_offset_0))
    ...
    def _set_in_offset_1(self, slot: int, in_offset_1: float) -> None:
        ...
        # SCPI call
        self._write('SLOT{}:AFE:OFFSet:IN1 {}'.format(slot, in_offset_1))
    ...
    # -------------------------------------------------------------------------
    @scpi_error_check
    def _set_sequencer_channel_map(self, slot: int, sequencer: int, sequencer_channel_map: Any) -> None:
        """
        ...
        # SCPI call
        self._write_bin('SLOT{}:SEQuencer{}:CHANnelmap '.format(slot, sequencer), json.dumps(sequencer_channel_map).encode('utf-8'))

    # -------------------------------------------------------------------------
    @scpi_error_check
    def _set_sequencer_acq_channel_map(self, slot: int, sequencer: int, sequencer_acq_channel_map: Any) -> None:
        """
        ...
        # SCPI call
        self._write_bin('SLOT{}:SEQuencer{}:ACQ:CHANnelmap '.format(slot, sequencer), json.dumps(sequencer_acq_channel_map).encode('utf-8'))
    ...
    def _set_out_filt_width_0(self, slot: int, out_filt_width_0: int) -> None:
        ...
        # SCPI call
        self._write('SLOT{}:AFE:FILT:OUT0:WIDTh {}'.format(slot, out_filt_width_0))
    ...
    def _set_out_filt_width_1(self, slot: int, out_filt_width_1: int) -> None:
        ...
        # SCPI call
        self._write('SLOT{}:AFE:FILT:OUT1:WIDTh {}'.format(slot, out_filt_width_1))
    ...
    def _set_out_filt_center_0(self, slot: int, out_filt_center_0: int) -> None:
        ...
        # SCPI call
        self._write('SLOT{}:AFE:FILT:OUT0:CENTer {}'.format(slot, out_filt_center_0))
    ...
    def _set_out_filt_center_1(self, slot: int, out_filt_center_1: int) -> None:
        ...
        # SCPI call
        self._write('SLOT{}:AFE:FILT:OUT1:CENTer {}'.format(slot, out_filt_center_1))
    ...
    def _set_out_filt_en_0(self, slot: int, out_filt_en_0: bool) -> None:
        ...
        # SCPI call
        self._write('SLOT{}:AFE:FILT:OUT0:ENAble {}'.format(slot, 0 if out_filt_en_0 == False else 1))
    ...
    def _set_out_filt_en_1(self, slot: int, out_filt_en_1: bool) -> None:
        ...
        # SCPI call
        self._write('SLOT{}:AFE:FILT:OUT1:ENAble {}'.format(slot, 0 if out_filt_en_1 == False else 1))
    ...
    def _set_mrk_inv_en_0(self, slot: int, mrk_inv_en_0: bool) -> None:
        ...
        # SCPI call
        self._write('SLOT{}:MRK0:INVert:ENAble {}'.format(slot, 0 if mrk_inv_en_0 == False else 1))
    ...
    def _set_mrk_inv_en_1(self, slot: int, mrk_inv_en_1: bool) -> None:
        ...
        # SCPI call
        self._write('SLOT{}:MRK1:INVert:ENAble {}'.format(slot, 0 if mrk_inv_en_1 == False else 1))
    ...
    def _set_mrk_inv_en_2(self, slot: int, mrk_inv_en_2: bool) -> None:
        ...
        # SCPI call
        self._write('SLOT{}:MRK2:INVert:ENAble {}'.format(slot, 0 if mrk_inv_en_2 == False else 1))
    ...
    def _set_mrk_inv_en_3(self, slot: int, mrk_inv_en_3: bool) -> None:
        ...
        # SCPI call
        self._write('SLOT{}:MRK3:INVert:ENAble {}'.format(slot, 0 if mrk_inv_en_3 == False else 1))
