...
class PulsarQcm(Ieee488_2):
    ...
    def __init__(self, transport: Transport, debug: int=0):
        ...
        if self._debug == 0:
            ...
            build_ref = "fwVersion=0.11.0 fwBuild=19/07/2023-13:01:47 fwHash=0x281A9057 fwDirty=0 kmodVersion=0.11.0 kmodBuild=27/07/2023-12:55:55 kmodHash=0x991109F9 kmodDirty=0 swVersion=0.11.0 swBuild=27/07/2023-12:55:55 swHash=0x991109F9 swDirty=0 cfgManVersion=0.3.0 cfgManBuild=27/07/2023-12:55:55 cfgManHash=0x991109F9 cfgManDirty=0"
            if build != build_ref:
