...
def compute_metrics_classification(kwargs, task_type, y_pred, y_pred_proba, y_test):
...
def compute_metrics_regression(kwargs, task_type, y_pred, y_test):
    metrics_list = kwargs.pop("metrics", None)
...
def compute_metrics_translation(kwargs, task_type, y_pred, y_test):
    metrics_list = kwargs.pop('metrics', None)
...
def compute_metrics_ner(kwargs, task_type, y_pred, y_test):
    metrics_list = kwargs.pop('metrics', None)
    common_args, custom_dimensions, log_activity, log_traceback = extract_common_kwargs(kwargs)
    ner_kwargs = ["metrics"]
...
def compute_metrics_summarization(kwargs, task_type, y_pred, y_test):
    metrics_list = kwargs.pop('metrics', None)
    tokenizer = kwargs.pop('tokenizer', None)
...
def compute_metrics_qa(kwargs, task_type, y_pred, y_test):
    metrics_list = kwargs.pop('metrics', None)
    tokenizer = kwargs.pop('tokenizer', None)
...
def compute_metrics_fill_mask(kwargs, task_type, y_pred, y_test):
    metrics_list = kwargs.pop("metrics", None)
...
def compute_metrics_text_generation(kwargs, task_type, y_pred, y_test):
    metrics_list = kwargs.pop("metrics", None)
...
def compute_metrics_forecasting(kwargs, task_type, y_pred, y_test):
...
def compute_metrics_image_od_is(kwargs, task_type, y_pred, y_test):
    metrics_list = kwargs.pop("metrics", None)
