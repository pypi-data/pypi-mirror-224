...
class ElementScreen(Screen):
    def build(  # pylint: disable=arguments-differ
        ...
        for element in elements:
            self.build_element(element, self.master)

    @classmethod
    def build_element(cls, element: Element, master: tk.Frame | tk.Tk) -> None:
        match element:
            case Button():
