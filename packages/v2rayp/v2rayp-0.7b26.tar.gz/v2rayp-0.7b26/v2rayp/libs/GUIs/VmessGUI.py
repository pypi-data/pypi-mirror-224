...
class VmessGUI:
    ...
    def save_return(self):
        self.page_data["remark"] = self.page_data["pas"] = self.window["alias"].get()
        ...
        self.page_data["sni"] = self.window["sni"].get()
    ...
    def generate_top_parts(self):
        layout = [
            [psg.Text("Vmess", justification="center", font=("Arial Bold", 18))],
            [psg.HorizontalSeparator()],
            [psg.Text("Servers")],
            [
                psg.Text("Alias:\t\t"),
    ...
    def generate_ending_parts(self):
        ...
        layout = [
            ...
            [
                psg.Text("SNI:\t\t"),
                psg.InputText(default_text=self.page_data["uuid"], key="sni"),
            ],
            [
