...
class Tablate(TablateApiSet):
    ...
    Args:
        outer_border: Outer border style for the Tablate container instance. [default: 'thick']
        outer_padding: Outer padding (in Unicode character width) for the Tablate container instance. [default: 1]
        outer_width: Outer width (in Unicode character width) for the Tablate container instance. [default: 120 or terminal width]
        html_default_colors: Apply the default HTML color scheme to the Tablate instance. [default: True]
        frame_divider: Default divider between frames within the Tablate container instance. [default: 'thick']
        background: Default background for frames withing the Tablate container instance. [default: None]
        background_padding: Additional padding applied to cells with a background color set when outputting to ASCII. [default: 1]
        html_px_multiplier: Multiplier for HTML properties inherited from base (ASCII) styling. [default: 6]
        html_outer_styles: Style dictionary for HTML specific styles for Tablate container instance. [default: None]
        column_styles: Style dictionary for default column styles. [default: {"column_divider": 'thin', "padding": 1, "background_padding": 1}]
        text_styles: Style dictionary for default text styles. [default: {"text_style": 'normal', "text_align": 'left', "text_color": None}]
        html_frame_styles: Style dictionary for default HTML frame styles. [default: {"html_frame_divider_style": "thick", "html_frame_divider_weight: 1, "html_frame_divider_color": 'black', "html_multiline": True (False for Table frames), "html_max_lines": None, "html_background": None}]
        html_column_styles: Style dictionary for default HTML column styles. [default: {"html_column_divider_style": 'thin', html_column_divider_weight: 1, "html_column_divider_color": 'black', "html_padding": 6px}]
        html_text_styles: Style dictionary for default HTML text styles. [default: {"html_text_style": 'normal', "html_text_align": 'left', "html_text_color": None, "html_text_size": 16}
    """
    def __init__(self,
