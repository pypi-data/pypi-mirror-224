...
def render_html_head(global_options: Globals) -> str:
    ...
    container_padding = global_options.html.html_outer_styles.html_container_padding
    frame_border_style = global_options.html.html_outer_styles.html_container_border_style
    frame_border_weight = global_options.html.html_outer_styles.html_container_border_weight
    frame_border_color = global_options.html.html_outer_styles.html_container_border_color
    html_px_multiplier = global_options.html.html_outer_styles.html_px_multiplier

    html_width = global_options.html.html_outer_styles.html_container_width
    ...
    if global_options.html.html_outer_styles.html_default_colors:
