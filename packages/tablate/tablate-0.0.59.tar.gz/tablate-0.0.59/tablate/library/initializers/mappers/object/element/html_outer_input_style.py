...
def html_outer_input_to_style(html_outer_styles_input: HtmlOuterStylesInput) -> HtmlOuterStyles:
    ...
    html_container_border_weight = set_key_resolver(instance=html_outer_styles_input, key="html_frame_divider_style", default=None)
    html_container_border_style = set_key_resolver(instance=html_outer_styles_input, key="html_container_border_style", default=None)
    html_container_border_color = set_key_resolver(instance=html_outer_styles_input, key="html_container_border_color", default=None)
    html_container_padding = set_key_resolver(instance=html_outer_styles_input, key="html_container_padding", default=None)
    html_container_width = set_key_resolver(instance=html_outer_styles_input, key="html_container_width", default=None)
