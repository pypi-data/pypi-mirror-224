...
class Tablate(TablateApiSet):
    ...
    Args:
        ...
        html_default_colors: apply the default HTML color scheme to the Tablate instance.
            [default: True]
        frame_divider: default divider between frames within the Tablate container instance.
            [default: 'thick']
        background: default background for frames withing the Tablate container instance.
            [default: None]
        background_padding: additional padding applied to cells with a background color set when outputting to ASCII.
            [default: 1]
        html_px_multiplier: multiplier for HTML properties inherited from base (ASCII) styling.
            [default: 6]
        html_outer_styles: style dictionary for HTML specific styles for Tablate container instance.
            [default: None]
        column_styles: style dictionary for default column styles.
            [default: {"column_divider": 'thin', "padding": 1, "background_padding": 1}]
        text_styles: style dictionary for default text styles.
            [default: {
            "text_style": 'normal',
            "text_align": 'left',
            "text_color": None
            }]
        html_frame_styles: style dictionary for default HTML frame styles.
            [default: {\n
        ...
        html_column_styles: style dictionary for default HTML column styles.
            [default: {
        ...
        html_text_styles: style dictionary for default HTML text styles.
            [default: {
