...
from tablate.type.primitives import FrameDivider, ContainerBorder, TextStyle, TextAlign, \
    ...
    TruncValue, ColumnDivider, HtmlDividerWeight, BackgroundPadding, HtmlDefaultColors, \
    HtmlDividerColor
