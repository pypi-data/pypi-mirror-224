...
class Humanloop(ClientCustom):
    ...
    async def achat(
        ...
        return await self.chats.aresponse(
            messages=messages,
    ...
    async def achat_deployed(
        ...
        return await self.chats.aresponse_deployed(
            messages=messages,
            project=project,
            project_id=project_id,
            session_id=session_id,
    ...
    def chat_deployed(
        ...
        return self.chats.response_deployed(
            messages=messages,
            project=project,
            project_id=project_id,
            session_id=session_id,
    ...
    async def achat_experiment(
        ...
        return await self.chats.aresponse_experiment(
            messages=messages,
    ...
    def chat_experiment(
        ...
        return self.chats.response_experiment(
            messages=messages,
            experiment_id=experiment_id,
            project=project,
            project_id=project_id,
    ...
    async def achat_model_configuration(
        ...
        return await self.chats.aresponse_model_configuration(
            messages=messages,
    ...
    def chat_model_configuration(
        ...
        return self.chats.response_model_configuration(
            messages=messages,
            model_config_id=model_config_id,
            project=project,
            project_id=project_id,
    ...
    async def acomplete_model_configuration(
        ...
        return await self.completions.acreate_model_configuration(
            model_config_id=model_config_id,
            project=project,
            project_id=project_id,
            session_id=session_id,
    ...
    def complete_model_configuration(
        ...
        return self.completions.create_model_configuration(
            model_config_id=model_config_id,
            project=project,
            project_id=project_id,
            session_id=session_id,
