...
class GetTestcase(BaseApi):
    ...
    async def aget_testcase(
        ...
        args = self._get_testcase_mapped_args(
            id=id,
        )
        return await self._aget_testcase_oapg(
    ...
    def get_testcase(
        ...
        return self._get_testcase_oapg(
            path_params=args.path,
        )
