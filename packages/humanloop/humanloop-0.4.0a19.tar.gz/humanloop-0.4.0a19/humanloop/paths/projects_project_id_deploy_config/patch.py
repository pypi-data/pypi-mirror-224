...
class BaseApi(api_client.Api):
    ...
    def _deploy_config_to_environments_mapped_args(
        self,
        project_id: str,
    ...
    async def _adeploy_config_to_environments_oapg(
        self,
    ...
    def _deploy_config_to_environments_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class DeployConfigToEnvironments(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adeploy_config_to_environments(
        self,
        project_id: str,
        config_id: typing.Optional[str] = None,
        experiment_id: typing.Optional[str] = None,
        ...
        args = self._deploy_config_to_environments_mapped_args(
            project_id=project_id,
            config_id=config_id,
            experiment_id=experiment_id,
            environments=environments,
        )
        return await self._adeploy_config_to_environments_oapg(
            body=args.body,
    ...
    def deploy_config_to_environments(
        ...
        return self._deploy_config_to_environments_oapg(
            body=args.body,
            path_params=args.path,
        )
