...
class EvaluationResultResponse(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "evaluation_function_id", "project_data_id", "updated_at", "evaluation_id", "value", "error", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "evaluation_function_id", "project_data_id", "updated_at", "evaluation_id", "value", "error", ], str]):
