...
# Query params
EvaluationFunctionAggregatesSchema = schemas.BoolSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'evaluation_function_aggregates': typing.Union[EvaluationFunctionAggregatesSchema, bool, ],
    },
    total=False
)
...
request_query_evaluation_function_aggregates = api_client.QueryParameter(
    name="evaluation_function_aggregates",
    style=api_client.ParameterStyle.FORM,
    schema=EvaluationFunctionAggregatesSchema,
    explode=True,
)
# Path params
...
class BaseApi(api_client.Api):
    ...
    def _get_mapped_args(
        self,
        id: str,
        evaluation_function_aggregates: typing.Optional[bool] = None,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        _query_params = {}
        _path_params = {}
        if evaluation_function_aggregates is not None:
            _query_params["evaluation_function_aggregates"] = evaluation_function_aggregates
        if id is not None:
            _path_params["id"] = id
    ...
    async def _aget_oapg(
        ...
        for parameter in (
            request_query_evaluation_function_aggregates,
        ):
