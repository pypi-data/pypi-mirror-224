...
class CreateTestcaseRequest(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def criteria() -> typing.Type['CreateTestcaseRequestCriteria']:
                return CreateTestcaseRequestCriteria
            __annotations__ = {
                "inputs": inputs,
                "messages": messages,
                "criteria": criteria,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["criteria"]) -> 'CreateTestcaseRequestCriteria': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["inputs", "messages", "criteria", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["criteria"]) -> typing.Union['CreateTestcaseRequestCriteria', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["inputs", "messages", "criteria", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        criteria: typing.Union['CreateTestcaseRequestCriteria', schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
