...
class ModelConfigEvalFunctionAggregateResponse(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            evaluation_function_id = schemas.StrSchema
            aggregate_value = schemas.AnyTypeSchema
            __annotations__ = {
                "model_config_id": model_config_id,
                "evaluation_function_id": evaluation_function_id,
                "aggregate_value": aggregate_value,
            }
    
    model_config_id: MetaOapg.properties.model_config_id
    evaluation_function_id: MetaOapg.properties.evaluation_function_id
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["model_config_id"]) -> MetaOapg.properties.model_config_id: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["evaluation_function_id"]) -> MetaOapg.properties.evaluation_function_id: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["model_config_id", "evaluation_function_id", "aggregate_value", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["evaluation_function_id"]) -> MetaOapg.properties.evaluation_function_id: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["model_config_id", "evaluation_function_id", "aggregate_value", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        evaluation_function_id: typing.Union[MetaOapg.properties.evaluation_function_id, str, ],
    ...
    ) -> 'ModelConfigEvalFunctionAggregateResponse':
