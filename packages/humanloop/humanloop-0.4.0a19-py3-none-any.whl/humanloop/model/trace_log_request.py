...
class TraceLogRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["project"], typing_extensions.Literal["project_id"], typing_extensions.Literal["session_id"], typing_extensions.Literal["session_reference_id"], typing_extensions.Literal["parent_id"], typing_extensions.Literal["parent_reference_id"], typing_extensions.Literal["inputs"], typing_extensions.Literal["source"], typing_extensions.Literal["metadata"], typing_extensions.Literal["reference_id"], typing_extensions.Literal["trial_id"], typing_extensions.Literal["messages"], typing_extensions.Literal["output"], typing_extensions.Literal["config"], typing_extensions.Literal["feedback"], typing_extensions.Literal["created_at"], typing_extensions.Literal["error"], typing_extensions.Literal["duration"], typing_extensions.Literal["children"], ]):
