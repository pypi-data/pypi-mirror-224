...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--dump_csv", type=Path, default="results.csv", help="Write the ui_out content in csv form.")
...
def run_certora_prover(conf_file: Path, args: argparse.Namespace) -> Tuple[bool, Optional[CertoraRunResult]]:
    ...
    with change_working_directory(og_cwd / conf_file.parent):
        ...
        certora_args = certora_args + [conf_file.name, "--send_only", "--run_source", "MUTATION"]
