...
from langchain.memory import ConversationTokenBufferMemory, ConversationKGMemory
...
if __name__ == "__main__":
    ...
    # vars
    dirpath = os.path.expandvars("$DATA_ROOT/$AGENTNAME/tricog/bulk")
    singlepdf = os.path.expandvars("$DATA_ROOT/$AGENTNAME/tricog/single/spotlight.pdf")
    persist_directory = os.path.expandvars("$DATA_ROOT/$AGENTNAME/tricog/chromadb_index")
    index_name = "tricog_index"
    ...
    agent = LLMDocGenerator(name="agent_tricog",
                            cred=cred)
    ...
    agent2 = LLMDocGenerator(name="agent_tricog2")
