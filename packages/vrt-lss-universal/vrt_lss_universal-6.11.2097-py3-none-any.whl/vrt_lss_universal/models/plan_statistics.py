...
class PlanStatistics(BaseModel):
    ...
    trips_statistics: conlist(TripStatistics, max_items=15001, min_items=0, unique_items=True) = Field(..., description="List of statistics for each scheduled trip separately. ")
