...
function updateVDKMenu(commands, docManager, fileBrowser, notebookTracker) {
    // Add Login command
    commands.addCommand('jp-vdk:menu-login', { label: 'Login', caption: "Execute Login", execute: _components_Login__WEBPACK_IMPORTED_MODULE_1__.startLogin });
    // Add Run job command
    add_command(commands, 'jp-vdk:menu-run', 'Run', 'Execute VDK Run Command', _components_RunJob__WEBPACK_IMPORTED_MODULE_2__.showRunJobDialog, docManager);
    // Add Create job command
    add_command(commands, 'jp-vdk:menu-create', 'Create', 'Execute VDK Create Command', _components_CreateJob__WEBPACK_IMPORTED_MODULE_3__.showCreateJobDialog);
    // Add Download job command
    add_command(commands, 'jp-vdk:menu-download', 'Download', 'Execute VDK Download Command', _components_DownloadJob__WEBPACK_IMPORTED_MODULE_4__.showDownloadJobDialog);
    // Add Convert Job To Notebook command
    add_command(commands, 'jp-vdk:menu-convert-job-to-notebook', 'Convert Job To Notebook', 'Convert Data Job To Jupyter Notebook', _components_ConvertJobToNotebook__WEBPACK_IMPORTED_MODULE_5__.showConvertJobToNotebookDialog, undefined, fileBrowser, notebookTracker);
    // Add Create Deployment command
    add_command(commands, 'jp-vdk:menu-create-deployment', 'Deploy', 'Create deployment of a VDK job', _components_DeployJob__WEBPACK_IMPORTED_MODULE_6__.showCreateDeploymentDialog);
}
/**
 ...
 */
function add_command(commands, schemaNaming, label, caption, getOperationDialog, docManager, fileBrowser, notebookTracker) {
        ...
        execute: async () => {
            try {
                if (!runningVdkOperation) {
                    ...
                    (0,_jupyterlab_apputils__WEBPACK_IMPORTED_MODULE_0__.showErrorMessage)('Another VDK operation is currently running!', 'Please wait until the operation ends!', [_jupyterlab_apputils__WEBPACK_IMPORTED_MODULE_0__.Dialog.okButton()]);
                }
            }
            catch (error) {
...
async function showConvertJobToNotebookDialog(commands, fileBrowser, notebookTracker) {
...
const populateNotebook = async (notebookTracker) => {
    ...
    if (notebookPanel) {
        ...
        if (cells && cells.length <= 1 && cellContent == '') {
            ...
            addMarkdownCell([
                "# " + _jobData__WEBPACK_IMPORTED_MODULE_5__.jobData.get(_vdkOptions_vdk_options__WEBPACK_IMPORTED_MODULE_3__.VdkOption.NAME)
            ]);
            addMarkdownCell([
            ...
            addMarkdownCell([
                ...
                "*  *This is a notebook transformed from a directory style data job located in " + _jobData__WEBPACK_IMPORTED_MODULE_5__.jobData.get(_vdkOptions_vdk_options__WEBPACK_IMPORTED_MODULE_3__.VdkOption.PATH) + ".*\n",
                "*  *If you are not familiar with notebook data jobs make sure to check the **Getting Started**(TODO: add link) page.*\n",
                "*  *You can find the **original job** at " + _jobData__WEBPACK_IMPORTED_MODULE_5__.jobData.get(_vdkOptions_vdk_options__WEBPACK_IMPORTED_MODULE_3__.VdkOption.PATH).split(/[/\\]/).slice(0, -1).join('/') + ".*"
            ]);
            addMarkdownCell([
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "webpack/sharing/consume/default/react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _jobData__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../jobData */ "./lib/jobData.js");
/* harmony import */ var _vdkOptions_vdk_options__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../vdkOptions/vdk_options */ "./lib/vdkOptions/vdk_options.js");
/* harmony import */ var _VdkTextInput__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./VdkTextInput */ "./lib/components/VdkTextInput.js");
/* harmony import */ var _jupyterlab_apputils__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @jupyterlab/apputils */ "webpack/sharing/consume/default/@jupyterlab/apputils");
/* harmony import */ var _jupyterlab_apputils__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_jupyterlab_apputils__WEBPACK_IMPORTED_MODULE_1__);
...
class CreateJobDialog extends react__WEBPACK_IMPORTED_MODULE_0__.Component {
    ...
    render() {
        return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement((react__WEBPACK_IMPORTED_MODULE_0___default().Fragment), null,
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: "jp-vdk-checkbox-wrappers" },
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", null,
                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement("input", { type: "checkbox", name: "Local", id: "Local", className: "jp-vdk-checkbox", onClick: this._onLocalClick() }),
                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement("label", { className: "checkboxLabel", htmlFor: "Local" }, "Local")),
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", null,
                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement("input", { type: "checkbox", name: "Cloud", id: "Cloud", className: "jp-vdk-checkbox", onClick: this._onCloudClick() }),
                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement("label", { className: "checkboxLabel", htmlFor: "Cloud" }, "Cloud"))),
    ...
    setJobFlags(flag) {
        ...
        if (checkbox === null || checkbox === void 0 ? void 0 : checkbox.classList.contains('checked')) {
            checkbox.classList.remove('checked');
            if (flag === 'Cloud') {
                _jobData__WEBPACK_IMPORTED_MODULE_4__.jobData.set(_vdkOptions_vdk_options__WEBPACK_IMPORTED_MODULE_3__.VdkOption.CLOUD, '');
            }
            else {
                _jobData__WEBPACK_IMPORTED_MODULE_4__.jobData.set(_vdkOptions_vdk_options__WEBPACK_IMPORTED_MODULE_3__.VdkOption.LOCAL, '');
            }
        }
        else {
            checkbox === null || checkbox === void 0 ? void 0 : checkbox.classList.add('checked');
            if (flag === 'Cloud') {
                _jobData__WEBPACK_IMPORTED_MODULE_4__.jobData.set(_vdkOptions_vdk_options__WEBPACK_IMPORTED_MODULE_3__.VdkOption.CLOUD, '1');
            }
            else {
                _jobData__WEBPACK_IMPORTED_MODULE_4__.jobData.set(_vdkOptions_vdk_options__WEBPACK_IMPORTED_MODULE_3__.VdkOption.LOCAL, '1');
            }
        }
    }
}
async function showCreateJobDialog() {
    const result = await (0,_jupyterlab_apputils__WEBPACK_IMPORTED_MODULE_1__.showDialog)({
        title: _utils__WEBPACK_IMPORTED_MODULE_5__.CREATE_JOB_BUTTON_LABEL,
        body: (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(CreateJobDialog, { jobPath: _jobData__WEBPACK_IMPORTED_MODULE_4__.jobData.get(_vdkOptions_vdk_options__WEBPACK_IMPORTED_MODULE_3__.VdkOption.PATH), jobName: _jobData__WEBPACK_IMPORTED_MODULE_4__.jobData.get(_vdkOptions_vdk_options__WEBPACK_IMPORTED_MODULE_3__.VdkOption.NAME), jobTeam: _jobData__WEBPACK_IMPORTED_MODULE_4__.jobData.get(_vdkOptions_vdk_options__WEBPACK_IMPORTED_MODULE_3__.VdkOption.TEAM) })),
        buttons: [_jupyterlab_apputils__WEBPACK_IMPORTED_MODULE_1__.Dialog.okButton(), _jupyterlab_apputils__WEBPACK_IMPORTED_MODULE_1__.Dialog.cancelButton()]
    });
    if (result.button.accept) {
        ...
        try {
            ...
            if (runConfirmationResult.button.accept) {
                ...
                if (status) {
                    ...
                    (0,_jupyterlab_apputils__WEBPACK_IMPORTED_MODULE_1__.showErrorMessage)('Encоuntered an error while running the job!', message, [_jupyterlab_apputils__WEBPACK_IMPORTED_MODULE_1__.Dialog.okButton()]);
                }
            }
        }
        catch (error) {
...
async function showDownloadJobDialog() {
    const result = await (0,_jupyterlab_apputils__WEBPACK_IMPORTED_MODULE_1__.showDialog)({
...
/* harmony export */   getCellInputAreaPromp: () => (/* binding */ getCellInputAreaPromp),
...
async function showRunJobDialog(docManager) {
    const result = await (0,_jupyterlab_apputils__WEBPACK_IMPORTED_MODULE_1__.showDialog)({
 ...
 */
const getCellInputAreaPromp = (failinCell) => {
...
const unmarkOldFailingCells = (cell) => {
    ...
    cellPropt === null || cellPropt === void 0 ? void 0 : cellPropt.classList.remove('jp-vdk-failing-cell-prompt');
};
...
/* harmony import */ var _vdkTags__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./vdkTags */ "./lib/vdkTags.js");
...
const plugin = {
    ...
    activate: async (app, settingRegistry, factory, notebookTracker, themeManager, docManager) => {
        ...
        (0,_commandsAndMenu__WEBPACK_IMPORTED_MODULE_5__.updateVDKMenu)(commands, docManager, fileBrowser, notebookTracker);
        fileBrowser.model.pathChanged.connect(onPathChanged);
        (0,_vdkTags__WEBPACK_IMPORTED_MODULE_8__.trackVdkTags)(notebookTracker, themeManager);
...
function getJobDataJsonObject() {
    const jsObj = {
        ...
        cloud: jobData.get(_vdkOptions_vdk_options__WEBPACK_IMPORTED_MODULE_1__.VdkOption.CLOUD),
        local: jobData.get(_vdkOptions_vdk_options__WEBPACK_IMPORTED_MODULE_1__.VdkOption.LOCAL),
...
(function (VdkOption) {
    ...
    VdkOption["CLOUD"] = "cloud";
    VdkOption["LOCAL"] = "local";
...
//# sourceMappingURL=lib_commandsAndMenu_js-lib_index_js.50f79587cd8a63543ad6.js.map