...
class SyncCommand(Command):
    ...
    def _getDeployments(self):
        ...
        if sourceDeployment.isLocal() is False and destinationDeployment.isLocal() is False:
            raise ValueError("Sync between remote deployments not supported".format(destinationDeploymentName, projectName))
