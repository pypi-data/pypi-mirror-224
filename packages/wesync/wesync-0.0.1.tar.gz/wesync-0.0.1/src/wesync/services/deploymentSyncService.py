...
from wesync.projectManagers.factory import getProjectManagerFor
...
class DeploymentSyncService:
    ...
    def sync(self, sourceDeployment: DeploymentConfigData, destinationDeployment: DeploymentConfigData):
        ...
        sourceProjectManager = getProjectManagerFor(sourceDeployment, self.config)
        destinationProjectManager = getProjectManagerFor(destinationDeployment, self.config)
