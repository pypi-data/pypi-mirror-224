...
class CaptchaOCR():
    def __init__(self, gpu_id: int = -1, use_beta_model: bool = False, use_import_onnx: bool = False,
        ...
        if self.use_import_onnx:
            ...
            if use_beta_model:
                from .charsets import charset_beta
                import_onnx_path = osp.join(osp.dirname(__file__), 'onnx', 'common_beta.onnx')
                self.charset = charset_beta
            else:
                from .charsets import charset
                import_onnx_path = osp.join(osp.dirname(__file__), 'onnx', 'common.onnx')
