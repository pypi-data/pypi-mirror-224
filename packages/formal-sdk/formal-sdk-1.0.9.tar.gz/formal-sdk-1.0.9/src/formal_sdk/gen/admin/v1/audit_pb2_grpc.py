...
class AuditLogsService(object):
    ...
    def GetLogs(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/admin.v1.AuditLogsService/GetLogs',
    ...
    def GetEventBySession(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/admin.v1.AuditLogsService/GetEventBySession',
    ...
    def GetDataBySession(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/admin.v1.AuditLogsService/GetDataBySession',
