...
class ColumnStatisticsModel(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["dataType", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["dataType", ], str]):
