...
class TagCount(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["tag", "count", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["tag", "count", ], str]):
