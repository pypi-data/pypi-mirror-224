...
class BulkLoadFileModel(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["sourcePath", "targetPath", "mimeType", "description", "md5", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["sourcePath", "targetPath", "mimeType", "description", "md5", ], str]):
