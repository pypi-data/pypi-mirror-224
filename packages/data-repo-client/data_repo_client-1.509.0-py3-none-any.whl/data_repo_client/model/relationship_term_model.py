...
class RelationshipTermModel(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def column() -> typing.Type['ColumnNameProperty']:
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["column"]) -> 'ColumnNameProperty': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["column"]) -> 'ColumnNameProperty': ...
