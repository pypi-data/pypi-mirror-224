...
SchemaFor200ResponseBodyApplicationJson = TagCountResultModel
...
class GetSnapshotTags(BaseApi):
    ...
    def get_snapshot_tags(
        ...
        return self._get_snapshot_tags_oapg(
